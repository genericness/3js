...
const swBase = self.location.pathname.replace(/arvcxs\.js$/, '')

importScripts(swBase + 'nsj/zjbo.bundle.js')
importScripts(swBase + 'nsj/zjbo.config.js')
importScripts(__uv$config.sw || swBase + 'nsj/zjbo.sw.js')

importScripts(swBase + 'tvku/pbfw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uilp/')) {
