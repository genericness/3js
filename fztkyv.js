...
const swBase = self.location.pathname.replace(/fztkyv\.js$/, '')

importScripts(swBase + 'iib/pdbu.bundle.js')
importScripts(swBase + 'iib/pdbu.config.js')
importScripts(__uv$config.sw || swBase + 'iib/pdbu.sw.js')

importScripts(swBase + 'bimj/ooqs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hqhf/')) {
