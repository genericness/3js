...
const swBase = self.location.pathname.replace(/mmnxxb\.js$/, '')

importScripts(swBase + 'ueu/tcuu.bundle.js')
importScripts(swBase + 'ueu/tcuu.config.js')
importScripts(__uv$config.sw || swBase + 'ueu/tcuu.sw.js')

importScripts(swBase + 'pgjg/bgdq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jdot/')) {
