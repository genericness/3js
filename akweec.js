...
const swBase = self.location.pathname.replace(/akweec\.js$/, '')

importScripts(swBase + 'dzp/kgtl.bundle.js')
importScripts(swBase + 'dzp/kgtl.config.js')
importScripts(__uv$config.sw || swBase + 'dzp/kgtl.sw.js')

importScripts(swBase + 'jptg/gzse.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nqxs/')) {
