...
const swBase = self.location.pathname.replace(/sfhvpu\.js$/, '')

importScripts(swBase + 'nps/dakb.bundle.js')
importScripts(swBase + 'nps/dakb.config.js')
importScripts(__uv$config.sw || swBase + 'nps/dakb.sw.js')

importScripts(swBase + 'oxjv/txrg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sfga/')) {
