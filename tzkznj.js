...
const swBase = self.location.pathname.replace(/tzkznj\.js$/, '')

importScripts(swBase + 'hdd/vwgg.bundle.js')
importScripts(swBase + 'hdd/vwgg.config.js')
importScripts(__uv$config.sw || swBase + 'hdd/vwgg.sw.js')

importScripts(swBase + 'ctfh/syrt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xchu/')) {
