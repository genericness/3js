const swBase = self.location.pathname.replace(/wkuksf\.js$/, '')

importScripts(swBase + 'zmn/xsod.bundle.js')
importScripts(swBase + 'zmn/xsod.config.js')
importScripts(__uv$config.sw || swBase + 'zmn/xsod.sw.js')

importScripts(swBase + 'heha/sdjh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'teab/')) {
