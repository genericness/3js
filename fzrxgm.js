const swBase = self.location.pathname.replace(/fzrxgm\.js$/, '')

importScripts(swBase + 'gza/peqq.bundle.js')
importScripts(swBase + 'gza/peqq.config.js')
importScripts(__uv$config.sw || swBase + 'gza/peqq.sw.js')

importScripts(swBase + 'pzyn/mwgf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eqig/')) {
