...
const swBase = self.location.pathname.replace(/awavye\.js$/, '')

importScripts(swBase + 'xwn/zkau.bundle.js')
importScripts(swBase + 'xwn/zkau.config.js')
importScripts(__uv$config.sw || swBase + 'xwn/zkau.sw.js')

importScripts(swBase + 'wgpr/jmzk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ylzr/')) {
