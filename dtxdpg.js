...
const swBase = self.location.pathname.replace(/dtxdpg\.js$/, '')

importScripts(swBase + 'dfw/jmjs.bundle.js')
importScripts(swBase + 'dfw/jmjs.config.js')
importScripts(__uv$config.sw || swBase + 'dfw/jmjs.sw.js')

importScripts(swBase + 'mqeb/mptu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hfxy/')) {
