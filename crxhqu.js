...
const swBase = self.location.pathname.replace(/crxhqu\.js$/, '')

importScripts(swBase + 'nco/bhjj.bundle.js')
importScripts(swBase + 'nco/bhjj.config.js')
importScripts(__uv$config.sw || swBase + 'nco/bhjj.sw.js')

importScripts(swBase + 'vtfb/iffv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ebao/')) {
