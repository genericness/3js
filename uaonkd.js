...
const swBase = self.location.pathname.replace(/uaonkd\.js$/, '')

importScripts(swBase + 'ywp/gdex.bundle.js')
importScripts(swBase + 'ywp/gdex.config.js')
importScripts(__uv$config.sw || swBase + 'ywp/gdex.sw.js')

importScripts(swBase + 'tjaj/ofzy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'muqg/')) {
