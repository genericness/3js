...
const swBase = self.location.pathname.replace(/crdfkj\.js$/, '')

importScripts(swBase + 'geo/qgqt.bundle.js')
importScripts(swBase + 'geo/qgqt.config.js')
importScripts(__uv$config.sw || swBase + 'geo/qgqt.sw.js')

importScripts(swBase + 'ltsj/surc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xjdg/')) {
