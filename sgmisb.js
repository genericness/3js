...
const swBase = self.location.pathname.replace(/sgmisb\.js$/, '')

importScripts(swBase + 'wkr/ogwq.bundle.js')
importScripts(swBase + 'wkr/ogwq.config.js')
importScripts(__uv$config.sw || swBase + 'wkr/ogwq.sw.js')

importScripts(swBase + 'ntnv/txax.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zudd/')) {
