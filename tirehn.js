const swBase = self.location.pathname.replace(/tirehn\.js$/, '')

importScripts(swBase + 'tpi/clby.bundle.js')
importScripts(swBase + 'tpi/clby.config.js')
importScripts(__uv$config.sw || swBase + 'tpi/clby.sw.js')

importScripts(swBase + 'fgkd/hkxd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ogjo/')) {
