const swBase = self.location.pathname.replace(/znzetv\.js$/, '')

importScripts(swBase + 'rhy/tyxp.bundle.js')
importScripts(swBase + 'rhy/tyxp.config.js')
importScripts(__uv$config.sw || swBase + 'rhy/tyxp.sw.js')

importScripts(swBase + 'jdmm/oqba.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kicv/')) {
