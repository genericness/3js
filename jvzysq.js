...
const swBase = self.location.pathname.replace(/jvzysq\.js$/, '')

importScripts(swBase + 'lfr/rcka.bundle.js')
importScripts(swBase + 'lfr/rcka.config.js')
importScripts(__uv$config.sw || swBase + 'lfr/rcka.sw.js')

importScripts(swBase + 'zcdg/zdfa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pmef/')) {
