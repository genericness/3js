...
const swBase = self.location.pathname.replace(/mldqqv\.js$/, '')

importScripts(swBase + 'kov/gbxf.bundle.js')
importScripts(swBase + 'kov/gbxf.config.js')
importScripts(__uv$config.sw || swBase + 'kov/gbxf.sw.js')

importScripts(swBase + 'xsqr/jnvm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eivj/')) {
