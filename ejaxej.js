const swBase = self.location.pathname.replace(/ejaxej\.js$/, '')

importScripts(swBase + 'nly/tqzc.bundle.js')
importScripts(swBase + 'nly/tqzc.config.js')
importScripts(__uv$config.sw || swBase + 'nly/tqzc.sw.js')

importScripts(swBase + 'btdm/ucyt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vncw/')) {
