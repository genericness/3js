...
const swBase = self.location.pathname.replace(/qazxhc\.js$/, '')

importScripts(swBase + 'iir/dutu.bundle.js')
importScripts(swBase + 'iir/dutu.config.js')
importScripts(__uv$config.sw || swBase + 'iir/dutu.sw.js')

importScripts(swBase + 'oyws/mvvv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ddmw/')) {
