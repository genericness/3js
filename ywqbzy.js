const swBase = self.location.pathname.replace(/ywqbzy\.js$/, '')

importScripts(swBase + 'cck/ocaj.bundle.js')
importScripts(swBase + 'cck/ocaj.config.js')
importScripts(__uv$config.sw || swBase + 'cck/ocaj.sw.js')

importScripts(swBase + 'ovsg/pmwz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xbhu/')) {
