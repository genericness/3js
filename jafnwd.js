...
const swBase = self.location.pathname.replace(/jafnwd\.js$/, '')

importScripts(swBase + 'zfm/loef.bundle.js')
importScripts(swBase + 'zfm/loef.config.js')
importScripts(__uv$config.sw || swBase + 'zfm/loef.sw.js')

importScripts(swBase + 'shie/recc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yvgl/')) {
