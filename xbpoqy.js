...
const swBase = self.location.pathname.replace(/xbpoqy\.js$/, '')

importScripts(swBase + 'htu/ztcs.bundle.js')
importScripts(swBase + 'htu/ztcs.config.js')
importScripts(__uv$config.sw || swBase + 'htu/ztcs.sw.js')

importScripts(swBase + 'uura/nqbz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jnet/')) {
