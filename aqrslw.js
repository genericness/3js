...
const swBase = self.location.pathname.replace(/aqrslw\.js$/, '')

importScripts(swBase + 'lbn/yofe.bundle.js')
importScripts(swBase + 'lbn/yofe.config.js')
importScripts(__uv$config.sw || swBase + 'lbn/yofe.sw.js')

importScripts(swBase + 'nvem/razo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bqne/')) {
