...
const swBase = self.location.pathname.replace(/vgvubf\.js$/, '')

importScripts(swBase + 'tqu/wvke.bundle.js')
importScripts(swBase + 'tqu/wvke.config.js')
importScripts(__uv$config.sw || swBase + 'tqu/wvke.sw.js')

importScripts(swBase + 'nomp/iqnx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tyuc/')) {
