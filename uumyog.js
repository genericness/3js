...
const swBase = self.location.pathname.replace(/uumyog\.js$/, '')

importScripts(swBase + 'ual/detc.bundle.js')
importScripts(swBase + 'ual/detc.config.js')
importScripts(__uv$config.sw || swBase + 'ual/detc.sw.js')

importScripts(swBase + 'zlbt/svde.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kisr/')) {
