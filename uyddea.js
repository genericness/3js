...
const swBase = self.location.pathname.replace(/uyddea\.js$/, '')

importScripts(swBase + 'gtt/flsc.bundle.js')
importScripts(swBase + 'gtt/flsc.config.js')
importScripts(__uv$config.sw || swBase + 'gtt/flsc.sw.js')

importScripts(swBase + 'midp/xwez.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vwxk/')) {
