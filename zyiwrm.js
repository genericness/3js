...
const swBase = self.location.pathname.replace(/zyiwrm\.js$/, '')

importScripts(swBase + 'pwb/sber.bundle.js')
importScripts(swBase + 'pwb/sber.config.js')
importScripts(__uv$config.sw || swBase + 'pwb/sber.sw.js')

importScripts(swBase + 'zwbt/eyjy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gtrt/')) {
