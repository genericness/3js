...
const swBase = self.location.pathname.replace(/lawyio\.js$/, '')

importScripts(swBase + 'fcy/daro.bundle.js')
importScripts(swBase + 'fcy/daro.config.js')
importScripts(__uv$config.sw || swBase + 'fcy/daro.sw.js')

importScripts(swBase + 'tysg/djxo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ahqd/')) {
