...
const swBase = self.location.pathname.replace(/eyysmc\.js$/, '')

importScripts(swBase + 'zlw/fsjt.bundle.js')
importScripts(swBase + 'zlw/fsjt.config.js')
importScripts(__uv$config.sw || swBase + 'zlw/fsjt.sw.js')

importScripts(swBase + 'ebkv/riux.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jtno/')) {
