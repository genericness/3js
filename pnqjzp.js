...
const swBase = self.location.pathname.replace(/pnqjzp\.js$/, '')

importScripts(swBase + 'emt/dywf.bundle.js')
importScripts(swBase + 'emt/dywf.config.js')
importScripts(__uv$config.sw || swBase + 'emt/dywf.sw.js')

importScripts(swBase + 'jnys/dbbj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wewy/')) {
