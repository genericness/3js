...
const swBase = self.location.pathname.replace(/xhbbry\.js$/, '')

importScripts(swBase + 'rpb/ucmr.bundle.js')
importScripts(swBase + 'rpb/ucmr.config.js')
importScripts(__uv$config.sw || swBase + 'rpb/ucmr.sw.js')

importScripts(swBase + 'vzxd/cuyk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'psbq/')) {
