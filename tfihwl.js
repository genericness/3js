...
const swBase = self.location.pathname.replace(/tfihwl\.js$/, '')

importScripts(swBase + 'amv/hmga.bundle.js')
importScripts(swBase + 'amv/hmga.config.js')
importScripts(__uv$config.sw || swBase + 'amv/hmga.sw.js')

importScripts(swBase + 'ythp/dwld.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rmwk/')) {
