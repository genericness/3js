...
const swBase = self.location.pathname.replace(/oloylh\.js$/, '')

importScripts(swBase + 'nri/wwfw.bundle.js')
importScripts(swBase + 'nri/wwfw.config.js')
importScripts(__uv$config.sw || swBase + 'nri/wwfw.sw.js')

importScripts(swBase + 'bwsv/cema.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vcxj/')) {
