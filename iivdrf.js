...
const swBase = self.location.pathname.replace(/iivdrf\.js$/, '')

importScripts(swBase + 'rxj/zgxq.bundle.js')
importScripts(swBase + 'rxj/zgxq.config.js')
importScripts(__uv$config.sw || swBase + 'rxj/zgxq.sw.js')

importScripts(swBase + 'wmgo/gmtq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'irdx/')) {
