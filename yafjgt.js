...
const swBase = self.location.pathname.replace(/yafjgt\.js$/, '')

importScripts(swBase + 'dzu/ypdx.bundle.js')
importScripts(swBase + 'dzu/ypdx.config.js')
importScripts(__uv$config.sw || swBase + 'dzu/ypdx.sw.js')

importScripts(swBase + 'zjvh/wmcp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kzfq/')) {
