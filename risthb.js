const swBase = self.location.pathname.replace(/risthb\.js$/, '')

importScripts(swBase + 'xes/fwlh.bundle.js')
importScripts(swBase + 'xes/fwlh.config.js')
importScripts(__uv$config.sw || swBase + 'xes/fwlh.sw.js')

importScripts(swBase + 'wrqh/flcp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'aolw/')) {
