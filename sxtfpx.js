...
const swBase = self.location.pathname.replace(/sxtfpx\.js$/, '')

importScripts(swBase + 'ywg/dgik.bundle.js')
importScripts(swBase + 'ywg/dgik.config.js')
importScripts(__uv$config.sw || swBase + 'ywg/dgik.sw.js')

importScripts(swBase + 'ztzy/kbuk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vynv/')) {
