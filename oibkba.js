...
const swBase = self.location.pathname.replace(/oibkba\.js$/, '')

importScripts(swBase + 'uzp/nvhd.bundle.js')
importScripts(swBase + 'uzp/nvhd.config.js')
importScripts(__uv$config.sw || swBase + 'uzp/nvhd.sw.js')

importScripts(swBase + 'rnvp/edsr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rcep/')) {
