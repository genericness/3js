...
const swBase = self.location.pathname.replace(/yqioep\.js$/, '')

importScripts(swBase + 'tmb/pikr.bundle.js')
importScripts(swBase + 'tmb/pikr.config.js')
importScripts(__uv$config.sw || swBase + 'tmb/pikr.sw.js')

importScripts(swBase + 'loja/qwlp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yxbv/')) {
