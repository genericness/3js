...
const swBase = self.location.pathname.replace(/cblvgo\.js$/, '')

importScripts(swBase + 'qsa/slnx.bundle.js')
importScripts(swBase + 'qsa/slnx.config.js')
importScripts(__uv$config.sw || swBase + 'qsa/slnx.sw.js')

importScripts(swBase + 'pnhl/mixx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qikn/')) {
