...
const swBase = self.location.pathname.replace(/bevkty\.js$/, '')

importScripts(swBase + 'qmm/nydd.bundle.js')
importScripts(swBase + 'qmm/nydd.config.js')
importScripts(__uv$config.sw || swBase + 'qmm/nydd.sw.js')

importScripts(swBase + 'yyeg/ecwn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tiiy/')) {
