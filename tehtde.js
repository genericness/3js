const swBase = self.location.pathname.replace(/tehtde\.js$/, '')

importScripts(swBase + 'ezf/bpep.bundle.js')
importScripts(swBase + 'ezf/bpep.config.js')
importScripts(__uv$config.sw || swBase + 'ezf/bpep.sw.js')

importScripts(swBase + 'wwdx/hfvv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rgpw/')) {
