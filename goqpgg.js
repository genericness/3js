...
const swBase = self.location.pathname.replace(/goqpgg\.js$/, '')

importScripts(swBase + 'vfo/reok.bundle.js')
importScripts(swBase + 'vfo/reok.config.js')
importScripts(__uv$config.sw || swBase + 'vfo/reok.sw.js')

importScripts(swBase + 'uujg/yhdg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nvil/')) {
