...
const swBase = self.location.pathname.replace(/vtvbct\.js$/, '')

importScripts(swBase + 'uuv/usbd.bundle.js')
importScripts(swBase + 'uuv/usbd.config.js')
importScripts(__uv$config.sw || swBase + 'uuv/usbd.sw.js')

importScripts(swBase + 'nzxn/yjjz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yhez/')) {
