...
const swBase = self.location.pathname.replace(/ddavyw\.js$/, '')

importScripts(swBase + 'elg/kgga.bundle.js')
importScripts(swBase + 'elg/kgga.config.js')
importScripts(__uv$config.sw || swBase + 'elg/kgga.sw.js')

importScripts(swBase + 'cavd/zyqs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mjfx/')) {
