...
const swBase = self.location.pathname.replace(/czheuh\.js$/, '')

importScripts(swBase + 'ase/woqx.bundle.js')
importScripts(swBase + 'ase/woqx.config.js')
importScripts(__uv$config.sw || swBase + 'ase/woqx.sw.js')

importScripts(swBase + 'haey/ehxe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bngp/')) {
