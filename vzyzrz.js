...
const swBase = self.location.pathname.replace(/vzyzrz\.js$/, '')

importScripts(swBase + 'aza/szef.bundle.js')
importScripts(swBase + 'aza/szef.config.js')
importScripts(__uv$config.sw || swBase + 'aza/szef.sw.js')

importScripts(swBase + 'lzzl/ngyi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rhye/')) {
