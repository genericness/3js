...
const swBase = self.location.pathname.replace(/iukims\.js$/, '')

importScripts(swBase + 'ajb/ublr.bundle.js')
importScripts(swBase + 'ajb/ublr.config.js')
importScripts(__uv$config.sw || swBase + 'ajb/ublr.sw.js')

importScripts(swBase + 'fexc/iimz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tusz/')) {
