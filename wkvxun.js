...
const swBase = self.location.pathname.replace(/wkvxun\.js$/, '')

importScripts(swBase + 'qmn/bzjt.bundle.js')
importScripts(swBase + 'qmn/bzjt.config.js')
importScripts(__uv$config.sw || swBase + 'qmn/bzjt.sw.js')

importScripts(swBase + 'lnkg/snjw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pqmq/')) {
