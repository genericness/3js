...
const swBase = self.location.pathname.replace(/awjzdb\.js$/, '')

importScripts(swBase + 'pwj/kasr.bundle.js')
importScripts(swBase + 'pwj/kasr.config.js')
importScripts(__uv$config.sw || swBase + 'pwj/kasr.sw.js')

importScripts(swBase + 'ipzb/cvyu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'csaq/')) {
