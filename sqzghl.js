const swBase = self.location.pathname.replace(/sqzghl\.js$/, '')

importScripts(swBase + 'rhs/mrkh.bundle.js')
importScripts(swBase + 'rhs/mrkh.config.js')
importScripts(__uv$config.sw || swBase + 'rhs/mrkh.sw.js')

importScripts(swBase + 'lbcd/uzpa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ozjr/')) {
