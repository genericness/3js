...
const swBase = self.location.pathname.replace(/mlnzoa\.js$/, '')

importScripts(swBase + 'iyl/yfvd.bundle.js')
importScripts(swBase + 'iyl/yfvd.config.js')
importScripts(__uv$config.sw || swBase + 'iyl/yfvd.sw.js')

importScripts(swBase + 'cjcb/vohl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'adtw/')) {
