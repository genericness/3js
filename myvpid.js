const swBase = self.location.pathname.replace(/myvpid\.js$/, '')

importScripts(swBase + 'lam/rkzz.bundle.js')
importScripts(swBase + 'lam/rkzz.config.js')
importScripts(__uv$config.sw || swBase + 'lam/rkzz.sw.js')

importScripts(swBase + 'qyoj/ufpw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jckv/')) {
