...
const swBase = self.location.pathname.replace(/gxrfld\.js$/, '')

importScripts(swBase + 'hfm/pvxr.bundle.js')
importScripts(swBase + 'hfm/pvxr.config.js')
importScripts(__uv$config.sw || swBase + 'hfm/pvxr.sw.js')

importScripts(swBase + 'qnry/aqft.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'egnt/')) {
