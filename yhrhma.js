...
const swBase = self.location.pathname.replace(/yhrhma\.js$/, '')

importScripts(swBase + 'azz/tuzj.bundle.js')
importScripts(swBase + 'azz/tuzj.config.js')
importScripts(__uv$config.sw || swBase + 'azz/tuzj.sw.js')

importScripts(swBase + 'mbsq/puya.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hecp/')) {
