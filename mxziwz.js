...
const swBase = self.location.pathname.replace(/mxziwz\.js$/, '')

importScripts(swBase + 'aum/olos.bundle.js')
importScripts(swBase + 'aum/olos.config.js')
importScripts(__uv$config.sw || swBase + 'aum/olos.sw.js')

importScripts(swBase + 'dxps/hsal.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ubtg/')) {
