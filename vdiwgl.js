...
const swBase = self.location.pathname.replace(/vdiwgl\.js$/, '')

importScripts(swBase + 'oan/mwvd.bundle.js')
importScripts(swBase + 'oan/mwvd.config.js')
importScripts(__uv$config.sw || swBase + 'oan/mwvd.sw.js')

importScripts(swBase + 'wkuf/swgu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xdje/')) {
