...
const swBase = self.location.pathname.replace(/fwsuhf\.js$/, '')

importScripts(swBase + 'vpf/rayk.bundle.js')
importScripts(swBase + 'vpf/rayk.config.js')
importScripts(__uv$config.sw || swBase + 'vpf/rayk.sw.js')

importScripts(swBase + 'qohm/lkck.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'upbb/')) {
