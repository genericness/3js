...
const swBase = self.location.pathname.replace(/fjfrol\.js$/, '')

importScripts(swBase + 'qsl/saat.bundle.js')
importScripts(swBase + 'qsl/saat.config.js')
importScripts(__uv$config.sw || swBase + 'qsl/saat.sw.js')

importScripts(swBase + 'bugj/zyfn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tmvd/')) {
