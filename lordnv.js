...
const swBase = self.location.pathname.replace(/lordnv\.js$/, '')

importScripts(swBase + 'njv/lcjl.bundle.js')
importScripts(swBase + 'njv/lcjl.config.js')
importScripts(__uv$config.sw || swBase + 'njv/lcjl.sw.js')

importScripts(swBase + 'brez/ldcc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'djxt/')) {
