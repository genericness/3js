...
const swBase = self.location.pathname.replace(/mkurrc\.js$/, '')

importScripts(swBase + 'zjk/rtzy.bundle.js')
importScripts(swBase + 'zjk/rtzy.config.js')
importScripts(__uv$config.sw || swBase + 'zjk/rtzy.sw.js')

importScripts(swBase + 'ybfu/xkdv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bvqk/')) {
