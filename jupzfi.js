...
const swBase = self.location.pathname.replace(/jupzfi\.js$/, '')

importScripts(swBase + 'sxs/lurm.bundle.js')
importScripts(swBase + 'sxs/lurm.config.js')
importScripts(__uv$config.sw || swBase + 'sxs/lurm.sw.js')

importScripts(swBase + 'sxay/auvv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ubpa/')) {
