...
const swBase = self.location.pathname.replace(/butehy\.js$/, '')

importScripts(swBase + 'ptf/knzn.bundle.js')
importScripts(swBase + 'ptf/knzn.config.js')
importScripts(__uv$config.sw || swBase + 'ptf/knzn.sw.js')

importScripts(swBase + 'dszd/sjky.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tblg/')) {
