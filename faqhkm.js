...
const swBase = self.location.pathname.replace(/faqhkm\.js$/, '')

importScripts(swBase + 'frk/pdns.bundle.js')
importScripts(swBase + 'frk/pdns.config.js')
importScripts(__uv$config.sw || swBase + 'frk/pdns.sw.js')

importScripts(swBase + 'cdxt/ecmu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'inka/')) {
