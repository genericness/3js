const swBase = self.location.pathname.replace(/owmbfo\.js$/, '')

importScripts(swBase + 'tvn/eyor.bundle.js')
importScripts(swBase + 'tvn/eyor.config.js')
importScripts(__uv$config.sw || swBase + 'tvn/eyor.sw.js')

importScripts(swBase + 'lcco/fsde.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cxzb/')) {
