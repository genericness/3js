...
const swBase = self.location.pathname.replace(/ubgojs\.js$/, '')

importScripts(swBase + 'def/kptz.bundle.js')
importScripts(swBase + 'def/kptz.config.js')
importScripts(__uv$config.sw || swBase + 'def/kptz.sw.js')

importScripts(swBase + 'drjz/bhih.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iwos/')) {
