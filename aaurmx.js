...
const swBase = self.location.pathname.replace(/aaurmx\.js$/, '')

importScripts(swBase + 'zzb/cjrv.bundle.js')
importScripts(swBase + 'zzb/cjrv.config.js')
importScripts(__uv$config.sw || swBase + 'zzb/cjrv.sw.js')

importScripts(swBase + 'hqwe/bkfm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zxor/')) {
