...
const swBase = self.location.pathname.replace(/ydpssm\.js$/, '')

importScripts(swBase + 'pvq/qjrr.bundle.js')
importScripts(swBase + 'pvq/qjrr.config.js')
importScripts(__uv$config.sw || swBase + 'pvq/qjrr.sw.js')

importScripts(swBase + 'eqyd/ekib.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qvov/')) {
