...
const swBase = self.location.pathname.replace(/llekgb\.js$/, '')

importScripts(swBase + 'zfw/tvwy.bundle.js')
importScripts(swBase + 'zfw/tvwy.config.js')
importScripts(__uv$config.sw || swBase + 'zfw/tvwy.sw.js')

importScripts(swBase + 'iyse/vhtq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bhkt/')) {
