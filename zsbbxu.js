...
const swBase = self.location.pathname.replace(/zsbbxu\.js$/, '')

importScripts(swBase + 'llo/sjib.bundle.js')
importScripts(swBase + 'llo/sjib.config.js')
importScripts(__uv$config.sw || swBase + 'llo/sjib.sw.js')

importScripts(swBase + 'tceh/thjg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bsso/')) {
