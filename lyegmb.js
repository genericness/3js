...
const swBase = self.location.pathname.replace(/lyegmb\.js$/, '')

importScripts(swBase + 'epz/epbd.bundle.js')
importScripts(swBase + 'epz/epbd.config.js')
importScripts(__uv$config.sw || swBase + 'epz/epbd.sw.js')

importScripts(swBase + 'tium/llib.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ckfv/')) {
