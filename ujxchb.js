...
const swBase = self.location.pathname.replace(/ujxchb\.js$/, '')

importScripts(swBase + 'mwu/yazw.bundle.js')
importScripts(swBase + 'mwu/yazw.config.js')
importScripts(__uv$config.sw || swBase + 'mwu/yazw.sw.js')

importScripts(swBase + 'ikys/znch.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nzct/')) {
