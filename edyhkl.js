...
const swBase = self.location.pathname.replace(/edyhkl\.js$/, '')

importScripts(swBase + 'dzn/hwig.bundle.js')
importScripts(swBase + 'dzn/hwig.config.js')
importScripts(__uv$config.sw || swBase + 'dzn/hwig.sw.js')

importScripts(swBase + 'qpdf/phqs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fwwq/')) {
