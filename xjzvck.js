const swBase = self.location.pathname.replace(/xjzvck\.js$/, '')

importScripts(swBase + 'ocq/rtgu.bundle.js')
importScripts(swBase + 'ocq/rtgu.config.js')
importScripts(__uv$config.sw || swBase + 'ocq/rtgu.sw.js')

importScripts(swBase + 'kpry/scue.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ngbq/')) {
