const swBase = self.location.pathname.replace(/jybvqw\.js$/, '')

importScripts(swBase + 'drd/hyth.bundle.js')
importScripts(swBase + 'drd/hyth.config.js')
importScripts(__uv$config.sw || swBase + 'drd/hyth.sw.js')

importScripts(swBase + 'jrkf/lfxg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ugix/')) {
