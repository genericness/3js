...
const swBase = self.location.pathname.replace(/sgakif\.js$/, '')

importScripts(swBase + 'agq/xqss.bundle.js')
importScripts(swBase + 'agq/xqss.config.js')
importScripts(__uv$config.sw || swBase + 'agq/xqss.sw.js')

importScripts(swBase + 'jaxa/fpww.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zloi/')) {
