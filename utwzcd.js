...
const swBase = self.location.pathname.replace(/utwzcd\.js$/, '')

importScripts(swBase + 'cnv/wpyi.bundle.js')
importScripts(swBase + 'cnv/wpyi.config.js')
importScripts(__uv$config.sw || swBase + 'cnv/wpyi.sw.js')

importScripts(swBase + 'qeqk/wxkb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lqho/')) {
