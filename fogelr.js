...
const swBase = self.location.pathname.replace(/fogelr\.js$/, '')

importScripts(swBase + 'jey/apgs.bundle.js')
importScripts(swBase + 'jey/apgs.config.js')
importScripts(__uv$config.sw || swBase + 'jey/apgs.sw.js')

importScripts(swBase + 'lovp/tjdo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hrij/')) {
