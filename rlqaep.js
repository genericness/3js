...
const swBase = self.location.pathname.replace(/rlqaep\.js$/, '')

importScripts(swBase + 'tct/qgcw.bundle.js')
importScripts(swBase + 'tct/qgcw.config.js')
importScripts(__uv$config.sw || swBase + 'tct/qgcw.sw.js')

importScripts(swBase + 'kveb/yrjm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xapv/')) {
