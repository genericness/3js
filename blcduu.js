...
const swBase = self.location.pathname.replace(/blcduu\.js$/, '')

importScripts(swBase + 'xyy/qnqx.bundle.js')
importScripts(swBase + 'xyy/qnqx.config.js')
importScripts(__uv$config.sw || swBase + 'xyy/qnqx.sw.js')

importScripts(swBase + 'xiui/ftho.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rxly/')) {
