...
const swBase = self.location.pathname.replace(/cqsznm\.js$/, '')

importScripts(swBase + 'aho/hoad.bundle.js')
importScripts(swBase + 'aho/hoad.config.js')
importScripts(__uv$config.sw || swBase + 'aho/hoad.sw.js')

importScripts(swBase + 'yvbc/khce.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kdyy/')) {
