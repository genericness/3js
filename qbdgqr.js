...
const swBase = self.location.pathname.replace(/qbdgqr\.js$/, '')

importScripts(swBase + 'aoe/zlxw.bundle.js')
importScripts(swBase + 'aoe/zlxw.config.js')
importScripts(__uv$config.sw || swBase + 'aoe/zlxw.sw.js')

importScripts(swBase + 'vpcw/hoev.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eifp/')) {
