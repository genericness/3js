...
const swBase = self.location.pathname.replace(/kvtzkd\.js$/, '')

importScripts(swBase + 'jvp/hlec.bundle.js')
importScripts(swBase + 'jvp/hlec.config.js')
importScripts(__uv$config.sw || swBase + 'jvp/hlec.sw.js')

importScripts(swBase + 'eirk/xxws.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vrch/')) {
