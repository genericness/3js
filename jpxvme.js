...
const swBase = self.location.pathname.replace(/jpxvme\.js$/, '')

importScripts(swBase + 'mov/zdzl.bundle.js')
importScripts(swBase + 'mov/zdzl.config.js')
importScripts(__uv$config.sw || swBase + 'mov/zdzl.sw.js')

importScripts(swBase + 'icsi/mebl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'irll/')) {
