...
const swBase = self.location.pathname.replace(/gsdwng\.js$/, '')

importScripts(swBase + 'rxj/ldkn.bundle.js')
importScripts(swBase + 'rxj/ldkn.config.js')
importScripts(__uv$config.sw || swBase + 'rxj/ldkn.sw.js')

importScripts(swBase + 'tgez/ezqg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hpms/')) {
