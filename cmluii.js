...
const swBase = self.location.pathname.replace(/cmluii\.js$/, '')

importScripts(swBase + 'ypo/lddk.bundle.js')
importScripts(swBase + 'ypo/lddk.config.js')
importScripts(__uv$config.sw || swBase + 'ypo/lddk.sw.js')

importScripts(swBase + 'vxle/zyip.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ovyv/')) {
