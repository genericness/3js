...
const swBase = self.location.pathname.replace(/cyngrh\.js$/, '')

importScripts(swBase + 'jyl/slra.bundle.js')
importScripts(swBase + 'jyl/slra.config.js')
importScripts(__uv$config.sw || swBase + 'jyl/slra.sw.js')

importScripts(swBase + 'ptos/iuhk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'raup/')) {
