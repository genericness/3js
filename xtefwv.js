...
const swBase = self.location.pathname.replace(/xtefwv\.js$/, '')

importScripts(swBase + 'chm/zfqd.bundle.js')
importScripts(swBase + 'chm/zfqd.config.js')
importScripts(__uv$config.sw || swBase + 'chm/zfqd.sw.js')

importScripts(swBase + 'pyuh/aamd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hruq/')) {
