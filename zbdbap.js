...
const swBase = self.location.pathname.replace(/zbdbap\.js$/, '')

importScripts(swBase + 'oxm/xnba.bundle.js')
importScripts(swBase + 'oxm/xnba.config.js')
importScripts(__uv$config.sw || swBase + 'oxm/xnba.sw.js')

importScripts(swBase + 'uugy/oblg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sowb/')) {
