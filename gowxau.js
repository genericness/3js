...
const swBase = self.location.pathname.replace(/gowxau\.js$/, '')

importScripts(swBase + 'xyp/aajo.bundle.js')
importScripts(swBase + 'xyp/aajo.config.js')
importScripts(__uv$config.sw || swBase + 'xyp/aajo.sw.js')

importScripts(swBase + 'hxxg/gdkx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jimi/')) {
