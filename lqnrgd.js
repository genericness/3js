const swBase = self.location.pathname.replace(/lqnrgd\.js$/, '')

importScripts(swBase + 'bmg/ihov.bundle.js')
importScripts(swBase + 'bmg/ihov.config.js')
importScripts(__uv$config.sw || swBase + 'bmg/ihov.sw.js')

importScripts(swBase + 'cjnz/ahir.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'idlb/')) {
