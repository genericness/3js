...
const swBase = self.location.pathname.replace(/sgwech\.js$/, '')

importScripts(swBase + 'qqq/dmof.bundle.js')
importScripts(swBase + 'qqq/dmof.config.js')
importScripts(__uv$config.sw || swBase + 'qqq/dmof.sw.js')

importScripts(swBase + 'gdbx/rmmp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ogzb/')) {
