...
const swBase = self.location.pathname.replace(/bzrmhw\.js$/, '')

importScripts(swBase + 'tqq/ifsa.bundle.js')
importScripts(swBase + 'tqq/ifsa.config.js')
importScripts(__uv$config.sw || swBase + 'tqq/ifsa.sw.js')

importScripts(swBase + 'mahf/pvnm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bqal/')) {
