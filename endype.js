...
const swBase = self.location.pathname.replace(/endype\.js$/, '')

importScripts(swBase + 'eml/ehmq.bundle.js')
importScripts(swBase + 'eml/ehmq.config.js')
importScripts(__uv$config.sw || swBase + 'eml/ehmq.sw.js')

importScripts(swBase + 'oukc/krhe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vxuu/')) {
