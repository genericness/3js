...
const swBase = self.location.pathname.replace(/gbxwqy\.js$/, '')

importScripts(swBase + 'uin/bamr.bundle.js')
importScripts(swBase + 'uin/bamr.config.js')
importScripts(__uv$config.sw || swBase + 'uin/bamr.sw.js')

importScripts(swBase + 'qwlz/uwfp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'utgk/')) {
