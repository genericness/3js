...
const swBase = self.location.pathname.replace(/cmzgiv\.js$/, '')

importScripts(swBase + 'oxh/zyia.bundle.js')
importScripts(swBase + 'oxh/zyia.config.js')
importScripts(__uv$config.sw || swBase + 'oxh/zyia.sw.js')

importScripts(swBase + 'tqna/rlur.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tpdw/')) {
