...
const swBase = self.location.pathname.replace(/yupxal\.js$/, '')

importScripts(swBase + 'gox/hzxo.bundle.js')
importScripts(swBase + 'gox/hzxo.config.js')
importScripts(__uv$config.sw || swBase + 'gox/hzxo.sw.js')

importScripts(swBase + 'pzsz/stiy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bldu/')) {
