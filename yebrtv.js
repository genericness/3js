...
const swBase = self.location.pathname.replace(/yebrtv\.js$/, '')

importScripts(swBase + 'fdx/vhhi.bundle.js')
importScripts(swBase + 'fdx/vhhi.config.js')
importScripts(__uv$config.sw || swBase + 'fdx/vhhi.sw.js')

importScripts(swBase + 'juuf/cixf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xtos/')) {
