...
const swBase = self.location.pathname.replace(/ffmitf\.js$/, '')

importScripts(swBase + 'koz/djpp.bundle.js')
importScripts(swBase + 'koz/djpp.config.js')
importScripts(__uv$config.sw || swBase + 'koz/djpp.sw.js')

importScripts(swBase + 'abzs/lrvh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wdrf/')) {
