...
const swBase = self.location.pathname.replace(/ajkoxd\.js$/, '')

importScripts(swBase + 'ihh/axkm.bundle.js')
importScripts(swBase + 'ihh/axkm.config.js')
importScripts(__uv$config.sw || swBase + 'ihh/axkm.sw.js')

importScripts(swBase + 'umii/owuf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vhcn/')) {
