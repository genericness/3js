...
const swBase = self.location.pathname.replace(/fiirqn\.js$/, '')

importScripts(swBase + 'iey/bvil.bundle.js')
importScripts(swBase + 'iey/bvil.config.js')
importScripts(__uv$config.sw || swBase + 'iey/bvil.sw.js')

importScripts(swBase + 'vhnv/wgpf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sedc/')) {
