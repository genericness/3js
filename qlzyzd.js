...
const swBase = self.location.pathname.replace(/qlzyzd\.js$/, '')

importScripts(swBase + 'nte/bpmq.bundle.js')
importScripts(swBase + 'nte/bpmq.config.js')
importScripts(__uv$config.sw || swBase + 'nte/bpmq.sw.js')

importScripts(swBase + 'ujvx/jrpc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qmnx/')) {
