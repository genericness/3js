...
const swBase = self.location.pathname.replace(/ngzngy\.js$/, '')

importScripts(swBase + 'agb/aqbq.bundle.js')
importScripts(swBase + 'agb/aqbq.config.js')
importScripts(__uv$config.sw || swBase + 'agb/aqbq.sw.js')

importScripts(swBase + 'ajou/ruuk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'weur/')) {
