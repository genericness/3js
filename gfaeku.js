const swBase = self.location.pathname.replace(/gfaeku\.js$/, '')

importScripts(swBase + 'sdk/rwav.bundle.js')
importScripts(swBase + 'sdk/rwav.config.js')
importScripts(__uv$config.sw || swBase + 'sdk/rwav.sw.js')

importScripts(swBase + 'opur/erlh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vqum/')) {
