...
const swBase = self.location.pathname.replace(/jxfnds\.js$/, '')

importScripts(swBase + 'nkw/pjcb.bundle.js')
importScripts(swBase + 'nkw/pjcb.config.js')
importScripts(__uv$config.sw || swBase + 'nkw/pjcb.sw.js')

importScripts(swBase + 'quln/miuc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uaii/')) {
