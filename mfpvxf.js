...
const swBase = self.location.pathname.replace(/mfpvxf\.js$/, '')

importScripts(swBase + 'wuc/ghfv.bundle.js')
importScripts(swBase + 'wuc/ghfv.config.js')
importScripts(__uv$config.sw || swBase + 'wuc/ghfv.sw.js')

importScripts(swBase + 'fbgj/csds.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'efar/')) {
