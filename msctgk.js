const swBase = self.location.pathname.replace(/msctgk\.js$/, '')

importScripts(swBase + 'fgq/gclz.bundle.js')
importScripts(swBase + 'fgq/gclz.config.js')
importScripts(__uv$config.sw || swBase + 'fgq/gclz.sw.js')

importScripts(swBase + 'tpaw/momt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eczb/')) {
