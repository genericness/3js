...
const swBase = self.location.pathname.replace(/pqfwkv\.js$/, '')

importScripts(swBase + 'ezj/nrhp.bundle.js')
importScripts(swBase + 'ezj/nrhp.config.js')
importScripts(__uv$config.sw || swBase + 'ezj/nrhp.sw.js')

importScripts(swBase + 'rtyl/jyua.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qalm/')) {
