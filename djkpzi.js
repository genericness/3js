...
const swBase = self.location.pathname.replace(/djkpzi\.js$/, '')

importScripts(swBase + 'dms/latj.bundle.js')
importScripts(swBase + 'dms/latj.config.js')
importScripts(__uv$config.sw || swBase + 'dms/latj.sw.js')

importScripts(swBase + 'qyni/xumz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'guzy/')) {
