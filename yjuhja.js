...
const swBase = self.location.pathname.replace(/yjuhja\.js$/, '')

importScripts(swBase + 'jxw/dsvk.bundle.js')
importScripts(swBase + 'jxw/dsvk.config.js')
importScripts(__uv$config.sw || swBase + 'jxw/dsvk.sw.js')

importScripts(swBase + 'pqzg/zlhz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pdnj/')) {
