...
const swBase = self.location.pathname.replace(/rzmdht\.js$/, '')

importScripts(swBase + 'cru/ixce.bundle.js')
importScripts(swBase + 'cru/ixce.config.js')
importScripts(__uv$config.sw || swBase + 'cru/ixce.sw.js')

importScripts(swBase + 'mxty/mubk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kwlw/')) {
