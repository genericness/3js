...
const swBase = self.location.pathname.replace(/ooytym\.js$/, '')

importScripts(swBase + 'fdu/ckoc.bundle.js')
importScripts(swBase + 'fdu/ckoc.config.js')
importScripts(__uv$config.sw || swBase + 'fdu/ckoc.sw.js')

importScripts(swBase + 'hwxk/gjni.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nlzn/')) {
