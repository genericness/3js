...
const swBase = self.location.pathname.replace(/ulpder\.js$/, '')

importScripts(swBase + 'pgx/aije.bundle.js')
importScripts(swBase + 'pgx/aije.config.js')
importScripts(__uv$config.sw || swBase + 'pgx/aije.sw.js')

importScripts(swBase + 'zmwi/efhc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qler/')) {
