const swBase = self.location.pathname.replace(/uneyhp\.js$/, '')

importScripts(swBase + 'fgw/upwb.bundle.js')
importScripts(swBase + 'fgw/upwb.config.js')
importScripts(__uv$config.sw || swBase + 'fgw/upwb.sw.js')

importScripts(swBase + 'gprm/xflq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rprc/')) {
