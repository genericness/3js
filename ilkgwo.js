...
const swBase = self.location.pathname.replace(/ilkgwo\.js$/, '')

importScripts(swBase + 'tdd/jwlr.bundle.js')
importScripts(swBase + 'tdd/jwlr.config.js')
importScripts(__uv$config.sw || swBase + 'tdd/jwlr.sw.js')

importScripts(swBase + 'mosk/mhdy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'itfs/')) {
