...
const swBase = self.location.pathname.replace(/jhurzw\.js$/, '')

importScripts(swBase + 'csp/glho.bundle.js')
importScripts(swBase + 'csp/glho.config.js')
importScripts(__uv$config.sw || swBase + 'csp/glho.sw.js')

importScripts(swBase + 'klwv/zsbd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iwfm/')) {
