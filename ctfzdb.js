...
const swBase = self.location.pathname.replace(/ctfzdb\.js$/, '')

importScripts(swBase + 'igq/fxgu.bundle.js')
importScripts(swBase + 'igq/fxgu.config.js')
importScripts(__uv$config.sw || swBase + 'igq/fxgu.sw.js')

importScripts(swBase + 'myed/vtzp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zohd/')) {
