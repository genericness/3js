...
const swBase = self.location.pathname.replace(/tcwgpx\.js$/, '')

importScripts(swBase + 'bhk/wlue.bundle.js')
importScripts(swBase + 'bhk/wlue.config.js')
importScripts(__uv$config.sw || swBase + 'bhk/wlue.sw.js')

importScripts(swBase + 'qjqu/cyyk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gvia/')) {
