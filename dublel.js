...
const swBase = self.location.pathname.replace(/dublel\.js$/, '')

importScripts(swBase + 'nmh/xamz.bundle.js')
importScripts(swBase + 'nmh/xamz.config.js')
importScripts(__uv$config.sw || swBase + 'nmh/xamz.sw.js')

importScripts(swBase + 'gnyo/qkuz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pkde/')) {
