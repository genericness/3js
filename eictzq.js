...
const swBase = self.location.pathname.replace(/eictzq\.js$/, '')

importScripts(swBase + 'gyp/rxqx.bundle.js')
importScripts(swBase + 'gyp/rxqx.config.js')
importScripts(__uv$config.sw || swBase + 'gyp/rxqx.sw.js')

importScripts(swBase + 'uzjr/agqv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qtdu/')) {
