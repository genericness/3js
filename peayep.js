...
const swBase = self.location.pathname.replace(/peayep\.js$/, '')

importScripts(swBase + 'evx/oudf.bundle.js')
importScripts(swBase + 'evx/oudf.config.js')
importScripts(__uv$config.sw || swBase + 'evx/oudf.sw.js')

importScripts(swBase + 'mvlx/ffrw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oxwf/')) {
