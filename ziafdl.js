...
const swBase = self.location.pathname.replace(/ziafdl\.js$/, '')

importScripts(swBase + 'ied/emrr.bundle.js')
importScripts(swBase + 'ied/emrr.config.js')
importScripts(__uv$config.sw || swBase + 'ied/emrr.sw.js')

importScripts(swBase + 'qkoc/dlzh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rixr/')) {
