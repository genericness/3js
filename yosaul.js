...
const swBase = self.location.pathname.replace(/yosaul\.js$/, '')

importScripts(swBase + 'adl/xuck.bundle.js')
importScripts(swBase + 'adl/xuck.config.js')
importScripts(__uv$config.sw || swBase + 'adl/xuck.sw.js')

importScripts(swBase + 'yhpx/tbid.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ixcr/')) {
