...
const swBase = self.location.pathname.replace(/plxlie\.js$/, '')

importScripts(swBase + 'vbb/pdxc.bundle.js')
importScripts(swBase + 'vbb/pdxc.config.js')
importScripts(__uv$config.sw || swBase + 'vbb/pdxc.sw.js')

importScripts(swBase + 'zmhq/izih.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jgmu/')) {
