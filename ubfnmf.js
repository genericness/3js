...
const swBase = self.location.pathname.replace(/ubfnmf\.js$/, '')

importScripts(swBase + 'wca/tgzz.bundle.js')
importScripts(swBase + 'wca/tgzz.config.js')
importScripts(__uv$config.sw || swBase + 'wca/tgzz.sw.js')

importScripts(swBase + 'vglz/jghh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bsxg/')) {
