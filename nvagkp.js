...
const swBase = self.location.pathname.replace(/nvagkp\.js$/, '')

importScripts(swBase + 'byv/pnht.bundle.js')
importScripts(swBase + 'byv/pnht.config.js')
importScripts(__uv$config.sw || swBase + 'byv/pnht.sw.js')

importScripts(swBase + 'mdpc/mvvc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zmwm/')) {
