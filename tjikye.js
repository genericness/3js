const swBase = self.location.pathname.replace(/tjikye\.js$/, '')

importScripts(swBase + 'lch/vwxz.bundle.js')
importScripts(swBase + 'lch/vwxz.config.js')
importScripts(__uv$config.sw || swBase + 'lch/vwxz.sw.js')

importScripts(swBase + 'wvqw/swtt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sdil/')) {
