...
const swBase = self.location.pathname.replace(/rqxdxu\.js$/, '')

importScripts(swBase + 'cyf/yvsb.bundle.js')
importScripts(swBase + 'cyf/yvsb.config.js')
importScripts(__uv$config.sw || swBase + 'cyf/yvsb.sw.js')

importScripts(swBase + 'huht/lymd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'euia/')) {
