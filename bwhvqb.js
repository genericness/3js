...
const swBase = self.location.pathname.replace(/bwhvqb\.js$/, '')

importScripts(swBase + 'fbl/qgde.bundle.js')
importScripts(swBase + 'fbl/qgde.config.js')
importScripts(__uv$config.sw || swBase + 'fbl/qgde.sw.js')

importScripts(swBase + 'cvss/yodb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vwfc/')) {
