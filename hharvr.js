...
const swBase = self.location.pathname.replace(/hharvr\.js$/, '')

importScripts(swBase + 'tkk/hvpr.bundle.js')
importScripts(swBase + 'tkk/hvpr.config.js')
importScripts(__uv$config.sw || swBase + 'tkk/hvpr.sw.js')

importScripts(swBase + 'dryz/koak.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iuix/')) {
