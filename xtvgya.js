...
const swBase = self.location.pathname.replace(/xtvgya\.js$/, '')

importScripts(swBase + 'jki/hfrb.bundle.js')
importScripts(swBase + 'jki/hfrb.config.js')
importScripts(__uv$config.sw || swBase + 'jki/hfrb.sw.js')

importScripts(swBase + 'nshx/ufok.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jfjc/')) {
