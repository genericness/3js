...
const swBase = self.location.pathname.replace(/czgdun\.js$/, '')

importScripts(swBase + 'dfy/cyue.bundle.js')
importScripts(swBase + 'dfy/cyue.config.js')
importScripts(__uv$config.sw || swBase + 'dfy/cyue.sw.js')

importScripts(swBase + 'loyv/ritl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kqvz/')) {
