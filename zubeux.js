const swBase = self.location.pathname.replace(/zubeux\.js$/, '')

importScripts(swBase + 'uac/xmnz.bundle.js')
importScripts(swBase + 'uac/xmnz.config.js')
importScripts(__uv$config.sw || swBase + 'uac/xmnz.sw.js')

importScripts(swBase + 'hgkf/pvgf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fgsz/')) {
