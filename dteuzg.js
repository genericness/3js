...
const swBase = self.location.pathname.replace(/dteuzg\.js$/, '')

importScripts(swBase + 'pkg/cica.bundle.js')
importScripts(swBase + 'pkg/cica.config.js')
importScripts(__uv$config.sw || swBase + 'pkg/cica.sw.js')

importScripts(swBase + 'xkjr/xoag.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nali/')) {
