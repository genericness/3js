...
const swBase = self.location.pathname.replace(/lkonoa\.js$/, '')

importScripts(swBase + 'kua/pxaw.bundle.js')
importScripts(swBase + 'kua/pxaw.config.js')
importScripts(__uv$config.sw || swBase + 'kua/pxaw.sw.js')

importScripts(swBase + 'wixl/ptth.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uzhu/')) {
