...
const swBase = self.location.pathname.replace(/hcfzph\.js$/, '')

importScripts(swBase + 'uor/gnls.bundle.js')
importScripts(swBase + 'uor/gnls.config.js')
importScripts(__uv$config.sw || swBase + 'uor/gnls.sw.js')

importScripts(swBase + 'zsvp/kbus.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zrwx/')) {
