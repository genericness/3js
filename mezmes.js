const swBase = self.location.pathname.replace(/mezmes\.js$/, '')

importScripts(swBase + 'lpg/obtz.bundle.js')
importScripts(swBase + 'lpg/obtz.config.js')
importScripts(__uv$config.sw || swBase + 'lpg/obtz.sw.js')

importScripts(swBase + 'dztw/bekj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jbmk/')) {
