...
const swBase = self.location.pathname.replace(/huadxj\.js$/, '')

importScripts(swBase + 'dvh/sibd.bundle.js')
importScripts(swBase + 'dvh/sibd.config.js')
importScripts(__uv$config.sw || swBase + 'dvh/sibd.sw.js')

importScripts(swBase + 'oenu/wact.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'blny/')) {
