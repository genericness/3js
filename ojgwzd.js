...
const swBase = self.location.pathname.replace(/ojgwzd\.js$/, '')

importScripts(swBase + 'nzw/hgkb.bundle.js')
importScripts(swBase + 'nzw/hgkb.config.js')
importScripts(__uv$config.sw || swBase + 'nzw/hgkb.sw.js')

importScripts(swBase + 'aijj/rddn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pouj/')) {
