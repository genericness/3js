const swBase = self.location.pathname.replace(/tfbiek\.js$/, '')

importScripts(swBase + 'ric/uqge.bundle.js')
importScripts(swBase + 'ric/uqge.config.js')
importScripts(__uv$config.sw || swBase + 'ric/uqge.sw.js')

importScripts(swBase + 'iryd/kihh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tbwu/')) {
