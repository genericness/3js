...
const swBase = self.location.pathname.replace(/upxygz\.js$/, '')

importScripts(swBase + 'mgc/pyvk.bundle.js')
importScripts(swBase + 'mgc/pyvk.config.js')
importScripts(__uv$config.sw || swBase + 'mgc/pyvk.sw.js')

importScripts(swBase + 'tcnb/hzbi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tpzh/')) {
