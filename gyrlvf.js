const swBase = self.location.pathname.replace(/gyrlvf\.js$/, '')

importScripts(swBase + 'ghv/sbsp.bundle.js')
importScripts(swBase + 'ghv/sbsp.config.js')
importScripts(__uv$config.sw || swBase + 'ghv/sbsp.sw.js')

importScripts(swBase + 'mcrk/azat.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hjkj/')) {
