const swBase = self.location.pathname.replace(/wymdes\.js$/, '')

importScripts(swBase + 'mdx/meqa.bundle.js')
importScripts(swBase + 'mdx/meqa.config.js')
importScripts(__uv$config.sw || swBase + 'mdx/meqa.sw.js')

importScripts(swBase + 'jian/poaj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zsyv/')) {
