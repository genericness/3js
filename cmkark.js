...
const swBase = self.location.pathname.replace(/cmkark\.js$/, '')

importScripts(swBase + 'lwe/ocvw.bundle.js')
importScripts(swBase + 'lwe/ocvw.config.js')
importScripts(__uv$config.sw || swBase + 'lwe/ocvw.sw.js')

importScripts(swBase + 'uzwy/abmm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lxkf/')) {
