...
const swBase = self.location.pathname.replace(/vuslia\.js$/, '')

importScripts(swBase + 'wts/kwhe.bundle.js')
importScripts(swBase + 'wts/kwhe.config.js')
importScripts(__uv$config.sw || swBase + 'wts/kwhe.sw.js')

importScripts(swBase + 'isol/akek.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mrlf/')) {
