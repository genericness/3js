...
const swBase = self.location.pathname.replace(/rieugq\.js$/, '')

importScripts(swBase + 'ykn/fexv.bundle.js')
importScripts(swBase + 'ykn/fexv.config.js')
importScripts(__uv$config.sw || swBase + 'ykn/fexv.sw.js')

importScripts(swBase + 'nzhj/tzmp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'khhw/')) {
