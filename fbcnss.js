...
const swBase = self.location.pathname.replace(/fbcnss\.js$/, '')

importScripts(swBase + 'kxo/esin.bundle.js')
importScripts(swBase + 'kxo/esin.config.js')
importScripts(__uv$config.sw || swBase + 'kxo/esin.sw.js')

importScripts(swBase + 'csbn/yspk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ugvp/')) {
