...
const swBase = self.location.pathname.replace(/yqeeki\.js$/, '')

importScripts(swBase + 'qig/pdno.bundle.js')
importScripts(swBase + 'qig/pdno.config.js')
importScripts(__uv$config.sw || swBase + 'qig/pdno.sw.js')

importScripts(swBase + 'ilyq/osya.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yhzi/')) {
