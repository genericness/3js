...
const swBase = self.location.pathname.replace(/cgsfuq\.js$/, '')

importScripts(swBase + 'rfp/ecnu.bundle.js')
importScripts(swBase + 'rfp/ecnu.config.js')
importScripts(__uv$config.sw || swBase + 'rfp/ecnu.sw.js')

importScripts(swBase + 'qbvf/sowd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gcyn/')) {
