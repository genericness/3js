...
const swBase = self.location.pathname.replace(/pgqgyt\.js$/, '')

importScripts(swBase + 'evz/zlpo.bundle.js')
importScripts(swBase + 'evz/zlpo.config.js')
importScripts(__uv$config.sw || swBase + 'evz/zlpo.sw.js')

importScripts(swBase + 'wngz/bgqf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rtan/')) {
