...
const swBase = self.location.pathname.replace(/vrvjhv\.js$/, '')

importScripts(swBase + 'uej/ttjk.bundle.js')
importScripts(swBase + 'uej/ttjk.config.js')
importScripts(__uv$config.sw || swBase + 'uej/ttjk.sw.js')

importScripts(swBase + 'mixz/zcch.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lncz/')) {
