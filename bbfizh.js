...
const swBase = self.location.pathname.replace(/bbfizh\.js$/, '')

importScripts(swBase + 'eft/lvsk.bundle.js')
importScripts(swBase + 'eft/lvsk.config.js')
importScripts(__uv$config.sw || swBase + 'eft/lvsk.sw.js')

importScripts(swBase + 'lhre/qhuf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'konr/')) {
