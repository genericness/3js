...
const swBase = self.location.pathname.replace(/pgjibg\.js$/, '')

importScripts(swBase + 'puy/cfxx.bundle.js')
importScripts(swBase + 'puy/cfxx.config.js')
importScripts(__uv$config.sw || swBase + 'puy/cfxx.sw.js')

importScripts(swBase + 'pozx/eowj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yaav/')) {
