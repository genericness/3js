...
const swBase = self.location.pathname.replace(/cpdolb\.js$/, '')

importScripts(swBase + 'rml/gnou.bundle.js')
importScripts(swBase + 'rml/gnou.config.js')
importScripts(__uv$config.sw || swBase + 'rml/gnou.sw.js')

importScripts(swBase + 'haua/wrbp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'flxy/')) {
