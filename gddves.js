...
const swBase = self.location.pathname.replace(/gddves\.js$/, '')

importScripts(swBase + 'ywy/fzre.bundle.js')
importScripts(swBase + 'ywy/fzre.config.js')
importScripts(__uv$config.sw || swBase + 'ywy/fzre.sw.js')

importScripts(swBase + 'lpvy/vnfp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rdtg/')) {
