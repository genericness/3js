...
const swBase = self.location.pathname.replace(/lhronh\.js$/, '')

importScripts(swBase + 'cvc/cunk.bundle.js')
importScripts(swBase + 'cvc/cunk.config.js')
importScripts(__uv$config.sw || swBase + 'cvc/cunk.sw.js')

importScripts(swBase + 'jaiv/cjbg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'thps/')) {
