...
const swBase = self.location.pathname.replace(/eocnim\.js$/, '')

importScripts(swBase + 'xkw/ruku.bundle.js')
importScripts(swBase + 'xkw/ruku.config.js')
importScripts(__uv$config.sw || swBase + 'xkw/ruku.sw.js')

importScripts(swBase + 'hpfu/alxh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'auqg/')) {
