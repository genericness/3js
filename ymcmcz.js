...
const swBase = self.location.pathname.replace(/ymcmcz\.js$/, '')

importScripts(swBase + 'jxk/mgwj.bundle.js')
importScripts(swBase + 'jxk/mgwj.config.js')
importScripts(__uv$config.sw || swBase + 'jxk/mgwj.sw.js')

importScripts(swBase + 'sgze/phia.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bzwn/')) {
