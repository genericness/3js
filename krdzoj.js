...
const swBase = self.location.pathname.replace(/krdzoj\.js$/, '')

importScripts(swBase + 'sru/rlum.bundle.js')
importScripts(swBase + 'sru/rlum.config.js')
importScripts(__uv$config.sw || swBase + 'sru/rlum.sw.js')

importScripts(swBase + 'cclz/bpxv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ttwv/')) {
