...
const swBase = self.location.pathname.replace(/idzxpn\.js$/, '')

importScripts(swBase + 'iax/ntcy.bundle.js')
importScripts(swBase + 'iax/ntcy.config.js')
importScripts(__uv$config.sw || swBase + 'iax/ntcy.sw.js')

importScripts(swBase + 'atwq/ostm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zoyo/')) {
