...
const swBase = self.location.pathname.replace(/obktei\.js$/, '')

importScripts(swBase + 'opc/kntw.bundle.js')
importScripts(swBase + 'opc/kntw.config.js')
importScripts(__uv$config.sw || swBase + 'opc/kntw.sw.js')

importScripts(swBase + 'qpql/hkhs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kdbf/')) {
