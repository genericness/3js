...
const swBase = self.location.pathname.replace(/jnixsh\.js$/, '')

importScripts(swBase + 'lpg/wxkd.bundle.js')
importScripts(swBase + 'lpg/wxkd.config.js')
importScripts(__uv$config.sw || swBase + 'lpg/wxkd.sw.js')

importScripts(swBase + 'muna/zvsm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'chcf/')) {
