const swBase = self.location.pathname.replace(/rqmrzj\.js$/, '')

importScripts(swBase + 'zqv/jhtn.bundle.js')
importScripts(swBase + 'zqv/jhtn.config.js')
importScripts(__uv$config.sw || swBase + 'zqv/jhtn.sw.js')

importScripts(swBase + 'eofx/tvei.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vdov/')) {
