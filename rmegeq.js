...
const swBase = self.location.pathname.replace(/rmegeq\.js$/, '')

importScripts(swBase + 'tgs/utxt.bundle.js')
importScripts(swBase + 'tgs/utxt.config.js')
importScripts(__uv$config.sw || swBase + 'tgs/utxt.sw.js')

importScripts(swBase + 'zffp/hclv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xegy/')) {
