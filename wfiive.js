const swBase = self.location.pathname.replace(/wfiive\.js$/, '')

importScripts(swBase + 'ofu/gfjz.bundle.js')
importScripts(swBase + 'ofu/gfjz.config.js')
importScripts(__uv$config.sw || swBase + 'ofu/gfjz.sw.js')

importScripts(swBase + 'hdfr/ptsa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gikn/')) {
