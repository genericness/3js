...
const swBase = self.location.pathname.replace(/niiadf\.js$/, '')

importScripts(swBase + 'oak/mbak.bundle.js')
importScripts(swBase + 'oak/mbak.config.js')
importScripts(__uv$config.sw || swBase + 'oak/mbak.sw.js')

importScripts(swBase + 'mcze/fvem.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yibj/')) {
