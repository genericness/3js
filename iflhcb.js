const swBase = self.location.pathname.replace(/iflhcb\.js$/, '')

importScripts(swBase + 'ytm/vehh.bundle.js')
importScripts(swBase + 'ytm/vehh.config.js')
importScripts(__uv$config.sw || swBase + 'ytm/vehh.sw.js')

importScripts(swBase + 'ilfg/oxfe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mvor/')) {
