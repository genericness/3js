const swBase = self.location.pathname.replace(/nvyjdr\.js$/, '')

importScripts(swBase + 'dla/owkk.bundle.js')
importScripts(swBase + 'dla/owkk.config.js')
importScripts(__uv$config.sw || swBase + 'dla/owkk.sw.js')

importScripts(swBase + 'cvdf/xhym.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mhpe/')) {
