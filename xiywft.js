...
const swBase = self.location.pathname.replace(/xiywft\.js$/, '')

importScripts(swBase + 'tyn/fjny.bundle.js')
importScripts(swBase + 'tyn/fjny.config.js')
importScripts(__uv$config.sw || swBase + 'tyn/fjny.sw.js')

importScripts(swBase + 'tssm/vmds.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pkoy/')) {
