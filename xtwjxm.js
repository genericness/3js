const swBase = self.location.pathname.replace(/xtwjxm\.js$/, '')

importScripts(swBase + 'wmf/rpgq.bundle.js')
importScripts(swBase + 'wmf/rpgq.config.js')
importScripts(__uv$config.sw || swBase + 'wmf/rpgq.sw.js')

importScripts(swBase + 'szoy/zejl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dyko/')) {
