...
const swBase = self.location.pathname.replace(/lgjjjs\.js$/, '')

importScripts(swBase + 'tgl/nkxj.bundle.js')
importScripts(swBase + 'tgl/nkxj.config.js')
importScripts(__uv$config.sw || swBase + 'tgl/nkxj.sw.js')

importScripts(swBase + 'mtfr/gxix.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'odos/')) {
