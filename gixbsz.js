...
const swBase = self.location.pathname.replace(/gixbsz\.js$/, '')

importScripts(swBase + 'mhg/buhu.bundle.js')
importScripts(swBase + 'mhg/buhu.config.js')
importScripts(__uv$config.sw || swBase + 'mhg/buhu.sw.js')

importScripts(swBase + 'raet/blkl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xvrb/')) {
