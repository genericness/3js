...
const swBase = self.location.pathname.replace(/ykzuoy\.js$/, '')

importScripts(swBase + 'jey/hhfn.bundle.js')
importScripts(swBase + 'jey/hhfn.config.js')
importScripts(__uv$config.sw || swBase + 'jey/hhfn.sw.js')

importScripts(swBase + 'zpvv/ajzf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'erol/')) {
