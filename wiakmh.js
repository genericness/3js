...
const swBase = self.location.pathname.replace(/wiakmh\.js$/, '')

importScripts(swBase + 'qju/ksqz.bundle.js')
importScripts(swBase + 'qju/ksqz.config.js')
importScripts(__uv$config.sw || swBase + 'qju/ksqz.sw.js')

importScripts(swBase + 'adyj/qrsd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dmvr/')) {
