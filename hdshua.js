...
const swBase = self.location.pathname.replace(/hdshua\.js$/, '')

importScripts(swBase + 'tjf/afms.bundle.js')
importScripts(swBase + 'tjf/afms.config.js')
importScripts(__uv$config.sw || swBase + 'tjf/afms.sw.js')

importScripts(swBase + 'wvnh/fnyi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xkdq/')) {
