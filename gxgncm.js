...
const swBase = self.location.pathname.replace(/gxgncm\.js$/, '')

importScripts(swBase + 'kqf/pcmx.bundle.js')
importScripts(swBase + 'kqf/pcmx.config.js')
importScripts(__uv$config.sw || swBase + 'kqf/pcmx.sw.js')

importScripts(swBase + 'bfug/sdky.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'knot/')) {
