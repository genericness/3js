...
const swBase = self.location.pathname.replace(/ohromb\.js$/, '')

importScripts(swBase + 'biz/kjmy.bundle.js')
importScripts(swBase + 'biz/kjmy.config.js')
importScripts(__uv$config.sw || swBase + 'biz/kjmy.sw.js')

importScripts(swBase + 'ihmo/payq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tptr/')) {
