...
const swBase = self.location.pathname.replace(/hheupv\.js$/, '')

importScripts(swBase + 'apm/ofob.bundle.js')
importScripts(swBase + 'apm/ofob.config.js')
importScripts(__uv$config.sw || swBase + 'apm/ofob.sw.js')

importScripts(swBase + 'wlaj/xrwn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vqzy/')) {
