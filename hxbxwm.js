...
const swBase = self.location.pathname.replace(/hxbxwm\.js$/, '')

importScripts(swBase + 'rxz/taaz.bundle.js')
importScripts(swBase + 'rxz/taaz.config.js')
importScripts(__uv$config.sw || swBase + 'rxz/taaz.sw.js')

importScripts(swBase + 'ltdi/hltm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'phjd/')) {
