const swBase = self.location.pathname.replace(/bollpd\.js$/, '')

importScripts(swBase + 'jpk/nhfk.bundle.js')
importScripts(swBase + 'jpk/nhfk.config.js')
importScripts(__uv$config.sw || swBase + 'jpk/nhfk.sw.js')

importScripts(swBase + 'lcuy/oshv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mbpm/')) {
