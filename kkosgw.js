...
const swBase = self.location.pathname.replace(/kkosgw\.js$/, '')

importScripts(swBase + 'wnf/cmdt.bundle.js')
importScripts(swBase + 'wnf/cmdt.config.js')
importScripts(__uv$config.sw || swBase + 'wnf/cmdt.sw.js')

importScripts(swBase + 'ifex/auxm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nawn/')) {
