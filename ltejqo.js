...
const swBase = self.location.pathname.replace(/ltejqo\.js$/, '')

importScripts(swBase + 'yph/zfsl.bundle.js')
importScripts(swBase + 'yph/zfsl.config.js')
importScripts(__uv$config.sw || swBase + 'yph/zfsl.sw.js')

importScripts(swBase + 'idup/ohza.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'siaq/')) {
