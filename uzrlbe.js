...
const swBase = self.location.pathname.replace(/uzrlbe\.js$/, '')

importScripts(swBase + 'mjm/mrcp.bundle.js')
importScripts(swBase + 'mjm/mrcp.config.js')
importScripts(__uv$config.sw || swBase + 'mjm/mrcp.sw.js')

importScripts(swBase + 'cfdj/htyq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mgqn/')) {
