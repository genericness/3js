...
const swBase = self.location.pathname.replace(/laybop\.js$/, '')

importScripts(swBase + 'axl/ufyy.bundle.js')
importScripts(swBase + 'axl/ufyy.config.js')
importScripts(__uv$config.sw || swBase + 'axl/ufyy.sw.js')

importScripts(swBase + 'ydlf/bmfs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ilgf/')) {
