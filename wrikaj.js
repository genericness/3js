...
const swBase = self.location.pathname.replace(/wrikaj\.js$/, '')

importScripts(swBase + 'fpw/umzs.bundle.js')
importScripts(swBase + 'fpw/umzs.config.js')
importScripts(__uv$config.sw || swBase + 'fpw/umzs.sw.js')

importScripts(swBase + 'mdga/grjl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qzyj/')) {
