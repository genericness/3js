...
const swBase = self.location.pathname.replace(/etvxyw\.js$/, '')

importScripts(swBase + 'syn/umbn.bundle.js')
importScripts(swBase + 'syn/umbn.config.js')
importScripts(__uv$config.sw || swBase + 'syn/umbn.sw.js')

importScripts(swBase + 'ykxe/tywu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'veil/')) {
