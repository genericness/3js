...
const swBase = self.location.pathname.replace(/svbpym\.js$/, '')

importScripts(swBase + 'omq/gwgl.bundle.js')
importScripts(swBase + 'omq/gwgl.config.js')
importScripts(__uv$config.sw || swBase + 'omq/gwgl.sw.js')

importScripts(swBase + 'iuqs/vbhs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'akhl/')) {
