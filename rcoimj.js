...
const swBase = self.location.pathname.replace(/rcoimj\.js$/, '')

importScripts(swBase + 'lvh/oecm.bundle.js')
importScripts(swBase + 'lvh/oecm.config.js')
importScripts(__uv$config.sw || swBase + 'lvh/oecm.sw.js')

importScripts(swBase + 'irgb/otdm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oglj/')) {
