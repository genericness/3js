...
const swBase = self.location.pathname.replace(/igqhjq\.js$/, '')

importScripts(swBase + 'ylb/lvqd.bundle.js')
importScripts(swBase + 'ylb/lvqd.config.js')
importScripts(__uv$config.sw || swBase + 'ylb/lvqd.sw.js')

importScripts(swBase + 'vvgj/wwik.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ddjd/')) {
