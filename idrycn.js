...
const swBase = self.location.pathname.replace(/idrycn\.js$/, '')

importScripts(swBase + 'wne/vgvr.bundle.js')
importScripts(swBase + 'wne/vgvr.config.js')
importScripts(__uv$config.sw || swBase + 'wne/vgvr.sw.js')

importScripts(swBase + 'sdfd/jjjb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zxkq/')) {
