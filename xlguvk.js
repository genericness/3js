...
const swBase = self.location.pathname.replace(/xlguvk\.js$/, '')

importScripts(swBase + 'byk/vegf.bundle.js')
importScripts(swBase + 'byk/vegf.config.js')
importScripts(__uv$config.sw || swBase + 'byk/vegf.sw.js')

importScripts(swBase + 'fzxm/tedy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'thkd/')) {
