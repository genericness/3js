const swBase = self.location.pathname.replace(/grivww\.js$/, '')

importScripts(swBase + 'cix/qmcd.bundle.js')
importScripts(swBase + 'cix/qmcd.config.js')
importScripts(__uv$config.sw || swBase + 'cix/qmcd.sw.js')

importScripts(swBase + 'uqte/hkha.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gkfe/')) {
