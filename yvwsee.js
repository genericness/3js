...
const swBase = self.location.pathname.replace(/yvwsee\.js$/, '')

importScripts(swBase + 'mtt/yduv.bundle.js')
importScripts(swBase + 'mtt/yduv.config.js')
importScripts(__uv$config.sw || swBase + 'mtt/yduv.sw.js')

importScripts(swBase + 'jmnh/zfpg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uelw/')) {
