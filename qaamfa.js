...
const swBase = self.location.pathname.replace(/qaamfa\.js$/, '')

importScripts(swBase + 'mzu/wfvu.bundle.js')
importScripts(swBase + 'mzu/wfvu.config.js')
importScripts(__uv$config.sw || swBase + 'mzu/wfvu.sw.js')

importScripts(swBase + 'yivl/qaom.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eeby/')) {
