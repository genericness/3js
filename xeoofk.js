...
const swBase = self.location.pathname.replace(/xeoofk\.js$/, '')

importScripts(swBase + 'syr/aaek.bundle.js')
importScripts(swBase + 'syr/aaek.config.js')
importScripts(__uv$config.sw || swBase + 'syr/aaek.sw.js')

importScripts(swBase + 'qziu/pdib.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kdpl/')) {
