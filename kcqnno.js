const swBase = self.location.pathname.replace(/kcqnno\.js$/, '')

importScripts(swBase + 'krq/ywue.bundle.js')
importScripts(swBase + 'krq/ywue.config.js')
importScripts(__uv$config.sw || swBase + 'krq/ywue.sw.js')

importScripts(swBase + 'mjwg/koto.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oawe/')) {
