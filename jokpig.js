...
const swBase = self.location.pathname.replace(/jokpig\.js$/, '')

importScripts(swBase + 'etc/dccx.bundle.js')
importScripts(swBase + 'etc/dccx.config.js')
importScripts(__uv$config.sw || swBase + 'etc/dccx.sw.js')

importScripts(swBase + 'euet/zqgu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rlrn/')) {
