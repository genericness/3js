...
const swBase = self.location.pathname.replace(/amnkxw\.js$/, '')

importScripts(swBase + 'eko/mpjh.bundle.js')
importScripts(swBase + 'eko/mpjh.config.js')
importScripts(__uv$config.sw || swBase + 'eko/mpjh.sw.js')

importScripts(swBase + 'npka/htbs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pclv/')) {
