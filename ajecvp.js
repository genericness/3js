...
const swBase = self.location.pathname.replace(/ajecvp\.js$/, '')

importScripts(swBase + 'xjh/aadt.bundle.js')
importScripts(swBase + 'xjh/aadt.config.js')
importScripts(__uv$config.sw || swBase + 'xjh/aadt.sw.js')

importScripts(swBase + 'iskl/ckkh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gwoo/')) {
