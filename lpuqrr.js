...
const swBase = self.location.pathname.replace(/lpuqrr\.js$/, '')

importScripts(swBase + 'dob/hyzf.bundle.js')
importScripts(swBase + 'dob/hyzf.config.js')
importScripts(__uv$config.sw || swBase + 'dob/hyzf.sw.js')

importScripts(swBase + 'serp/hrxn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dgwf/')) {
