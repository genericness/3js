...
const swBase = self.location.pathname.replace(/byrijl\.js$/, '')

importScripts(swBase + 'tbs/bwlv.bundle.js')
importScripts(swBase + 'tbs/bwlv.config.js')
importScripts(__uv$config.sw || swBase + 'tbs/bwlv.sw.js')

importScripts(swBase + 'iuif/zhdr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'umyr/')) {
