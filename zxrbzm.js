...
const swBase = self.location.pathname.replace(/zxrbzm\.js$/, '')

importScripts(swBase + 'pse/ojyl.bundle.js')
importScripts(swBase + 'pse/ojyl.config.js')
importScripts(__uv$config.sw || swBase + 'pse/ojyl.sw.js')

importScripts(swBase + 'nquf/qxys.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wogp/')) {
