...
const swBase = self.location.pathname.replace(/ycknez\.js$/, '')

importScripts(swBase + 'dpx/ldws.bundle.js')
importScripts(swBase + 'dpx/ldws.config.js')
importScripts(__uv$config.sw || swBase + 'dpx/ldws.sw.js')

importScripts(swBase + 'jbvs/ziop.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dhpy/')) {
