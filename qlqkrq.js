const swBase = self.location.pathname.replace(/qlqkrq\.js$/, '')

importScripts(swBase + 'axn/odod.bundle.js')
importScripts(swBase + 'axn/odod.config.js')
importScripts(__uv$config.sw || swBase + 'axn/odod.sw.js')

importScripts(swBase + 'sjrn/vgbv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vgtu/')) {
