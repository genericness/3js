const swBase = self.location.pathname.replace(/ukppsf\.js$/, '')

importScripts(swBase + 'exq/lnkx.bundle.js')
importScripts(swBase + 'exq/lnkx.config.js')
importScripts(__uv$config.sw || swBase + 'exq/lnkx.sw.js')

importScripts(swBase + 'pmbp/edje.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dqxs/')) {
