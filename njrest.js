...
const swBase = self.location.pathname.replace(/njrest\.js$/, '')

importScripts(swBase + 'zgz/wsfl.bundle.js')
importScripts(swBase + 'zgz/wsfl.config.js')
importScripts(__uv$config.sw || swBase + 'zgz/wsfl.sw.js')

importScripts(swBase + 'adck/ixgt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'emzo/')) {
