...
const swBase = self.location.pathname.replace(/jepixp\.js$/, '')

importScripts(swBase + 'yfa/hjyk.bundle.js')
importScripts(swBase + 'yfa/hjyk.config.js')
importScripts(__uv$config.sw || swBase + 'yfa/hjyk.sw.js')

importScripts(swBase + 'fjsr/jzsl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ftal/')) {
