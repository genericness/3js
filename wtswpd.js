...
const swBase = self.location.pathname.replace(/wtswpd\.js$/, '')

importScripts(swBase + 'sal/vglx.bundle.js')
importScripts(swBase + 'sal/vglx.config.js')
importScripts(__uv$config.sw || swBase + 'sal/vglx.sw.js')

importScripts(swBase + 'jyla/qeht.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jlpk/')) {
