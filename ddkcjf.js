...
const swBase = self.location.pathname.replace(/ddkcjf\.js$/, '')

importScripts(swBase + 'nci/bukx.bundle.js')
importScripts(swBase + 'nci/bukx.config.js')
importScripts(__uv$config.sw || swBase + 'nci/bukx.sw.js')

importScripts(swBase + 'iazh/rihx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tdyi/')) {
