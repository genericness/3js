...
const swBase = self.location.pathname.replace(/xjulbx\.js$/, '')

importScripts(swBase + 'anj/hqox.bundle.js')
importScripts(swBase + 'anj/hqox.config.js')
importScripts(__uv$config.sw || swBase + 'anj/hqox.sw.js')

importScripts(swBase + 'okvw/cpar.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dkdc/')) {
