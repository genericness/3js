...
const swBase = self.location.pathname.replace(/ufozwm\.js$/, '')

importScripts(swBase + 'spb/vlyj.bundle.js')
importScripts(swBase + 'spb/vlyj.config.js')
importScripts(__uv$config.sw || swBase + 'spb/vlyj.sw.js')

importScripts(swBase + 'rano/oejn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bxii/')) {
