...
const swBase = self.location.pathname.replace(/utigdv\.js$/, '')

importScripts(swBase + 'pcv/gfkf.bundle.js')
importScripts(swBase + 'pcv/gfkf.config.js')
importScripts(__uv$config.sw || swBase + 'pcv/gfkf.sw.js')

importScripts(swBase + 'glbd/jxkr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jywd/')) {
