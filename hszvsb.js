...
const swBase = self.location.pathname.replace(/hszvsb\.js$/, '')

importScripts(swBase + 'okn/absh.bundle.js')
importScripts(swBase + 'okn/absh.config.js')
importScripts(__uv$config.sw || swBase + 'okn/absh.sw.js')

importScripts(swBase + 'wquq/wmlp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tuxr/')) {
