...
const swBase = self.location.pathname.replace(/hlgmwc\.js$/, '')

importScripts(swBase + 'ufw/dcjd.bundle.js')
importScripts(swBase + 'ufw/dcjd.config.js')
importScripts(__uv$config.sw || swBase + 'ufw/dcjd.sw.js')

importScripts(swBase + 'gfkk/puih.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uwiy/')) {
