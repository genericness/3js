...
const swBase = self.location.pathname.replace(/xnlogz\.js$/, '')

importScripts(swBase + 'jhm/cocs.bundle.js')
importScripts(swBase + 'jhm/cocs.config.js')
importScripts(__uv$config.sw || swBase + 'jhm/cocs.sw.js')

importScripts(swBase + 'ewvr/nfjh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ecqa/')) {
