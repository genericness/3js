...
const swBase = self.location.pathname.replace(/etusnz\.js$/, '')

importScripts(swBase + 'fbu/iuei.bundle.js')
importScripts(swBase + 'fbu/iuei.config.js')
importScripts(__uv$config.sw || swBase + 'fbu/iuei.sw.js')

importScripts(swBase + 'dngt/rgjt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sdao/')) {
