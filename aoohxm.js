...
const swBase = self.location.pathname.replace(/aoohxm\.js$/, '')

importScripts(swBase + 'fzk/ebuc.bundle.js')
importScripts(swBase + 'fzk/ebuc.config.js')
importScripts(__uv$config.sw || swBase + 'fzk/ebuc.sw.js')

importScripts(swBase + 'wvip/zcjx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cqif/')) {
