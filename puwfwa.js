...
const swBase = self.location.pathname.replace(/puwfwa\.js$/, '')

importScripts(swBase + 'wwo/zosb.bundle.js')
importScripts(swBase + 'wwo/zosb.config.js')
importScripts(__uv$config.sw || swBase + 'wwo/zosb.sw.js')

importScripts(swBase + 'keyp/meck.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ecsf/')) {
