...
const swBase = self.location.pathname.replace(/ctehgk\.js$/, '')

importScripts(swBase + 'bnl/ifni.bundle.js')
importScripts(swBase + 'bnl/ifni.config.js')
importScripts(__uv$config.sw || swBase + 'bnl/ifni.sw.js')

importScripts(swBase + 'kqcw/zofd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'belp/')) {
