...
const swBase = self.location.pathname.replace(/jrcgxm\.js$/, '')

importScripts(swBase + 'eiq/tghn.bundle.js')
importScripts(swBase + 'eiq/tghn.config.js')
importScripts(__uv$config.sw || swBase + 'eiq/tghn.sw.js')

importScripts(swBase + 'owjc/kxzo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'alis/')) {
