...
const swBase = self.location.pathname.replace(/robijt\.js$/, '')

importScripts(swBase + 'wgr/dwke.bundle.js')
importScripts(swBase + 'wgr/dwke.config.js')
importScripts(__uv$config.sw || swBase + 'wgr/dwke.sw.js')

importScripts(swBase + 'pnzv/kbrz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oeoq/')) {
