const swBase = self.location.pathname.replace(/vanpza\.js$/, '')

importScripts(swBase + 'hdx/rtbo.bundle.js')
importScripts(swBase + 'hdx/rtbo.config.js')
importScripts(__uv$config.sw || swBase + 'hdx/rtbo.sw.js')

importScripts(swBase + 'nbcg/rrgc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jtdr/')) {
