...
const swBase = self.location.pathname.replace(/njkyzf\.js$/, '')

importScripts(swBase + 'sws/tzcx.bundle.js')
importScripts(swBase + 'sws/tzcx.config.js')
importScripts(__uv$config.sw || swBase + 'sws/tzcx.sw.js')

importScripts(swBase + 'phjt/bkcn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ajpu/')) {
