...
const swBase = self.location.pathname.replace(/qcqzjv\.js$/, '')

importScripts(swBase + 'fpv/xojo.bundle.js')
importScripts(swBase + 'fpv/xojo.config.js')
importScripts(__uv$config.sw || swBase + 'fpv/xojo.sw.js')

importScripts(swBase + 'qnyt/uwrt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vbxy/')) {
