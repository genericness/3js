...
const swBase = self.location.pathname.replace(/fwdqoz\.js$/, '')

importScripts(swBase + 'iaf/nlzv.bundle.js')
importScripts(swBase + 'iaf/nlzv.config.js')
importScripts(__uv$config.sw || swBase + 'iaf/nlzv.sw.js')

importScripts(swBase + 'hisr/cmly.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kmtn/')) {
