...
const swBase = self.location.pathname.replace(/ikmssp\.js$/, '')

importScripts(swBase + 'yib/kqup.bundle.js')
importScripts(swBase + 'yib/kqup.config.js')
importScripts(__uv$config.sw || swBase + 'yib/kqup.sw.js')

importScripts(swBase + 'nwrq/usjz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ixht/')) {
