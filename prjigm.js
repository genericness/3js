...
const swBase = self.location.pathname.replace(/prjigm\.js$/, '')

importScripts(swBase + 'agx/jcxb.bundle.js')
importScripts(swBase + 'agx/jcxb.config.js')
importScripts(__uv$config.sw || swBase + 'agx/jcxb.sw.js')

importScripts(swBase + 'bwma/jeya.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'snhr/')) {
