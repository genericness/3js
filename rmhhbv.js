...
const swBase = self.location.pathname.replace(/rmhhbv\.js$/, '')

importScripts(swBase + 'uqq/lzxv.bundle.js')
importScripts(swBase + 'uqq/lzxv.config.js')
importScripts(__uv$config.sw || swBase + 'uqq/lzxv.sw.js')

importScripts(swBase + 'wnii/wtkz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xfkh/')) {
