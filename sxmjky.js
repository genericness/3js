...
const swBase = self.location.pathname.replace(/sxmjky\.js$/, '')

importScripts(swBase + 'vdo/hoot.bundle.js')
importScripts(swBase + 'vdo/hoot.config.js')
importScripts(__uv$config.sw || swBase + 'vdo/hoot.sw.js')

importScripts(swBase + 'cysw/wark.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tbgx/')) {
