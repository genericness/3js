...
const swBase = self.location.pathname.replace(/larybo\.js$/, '')

importScripts(swBase + 'yvm/vpqg.bundle.js')
importScripts(swBase + 'yvm/vpqg.config.js')
importScripts(__uv$config.sw || swBase + 'yvm/vpqg.sw.js')

importScripts(swBase + 'kkwc/fcjn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xjms/')) {
