const swBase = self.location.pathname.replace(/mhlxzu\.js$/, '')

importScripts(swBase + 'qgs/wrim.bundle.js')
importScripts(swBase + 'qgs/wrim.config.js')
importScripts(__uv$config.sw || swBase + 'qgs/wrim.sw.js')

importScripts(swBase + 'qduz/zmuk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fcdb/')) {
