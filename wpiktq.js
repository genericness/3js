...
const swBase = self.location.pathname.replace(/wpiktq\.js$/, '')

importScripts(swBase + 'akd/vopb.bundle.js')
importScripts(swBase + 'akd/vopb.config.js')
importScripts(__uv$config.sw || swBase + 'akd/vopb.sw.js')

importScripts(swBase + 'bfgw/zxlk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iebk/')) {
