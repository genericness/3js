...
const swBase = self.location.pathname.replace(/snyish\.js$/, '')

importScripts(swBase + 'aef/pujw.bundle.js')
importScripts(swBase + 'aef/pujw.config.js')
importScripts(__uv$config.sw || swBase + 'aef/pujw.sw.js')

importScripts(swBase + 'gpkh/wxjk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'john/')) {
