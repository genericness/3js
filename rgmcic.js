...
const swBase = self.location.pathname.replace(/rgmcic\.js$/, '')

importScripts(swBase + 'aze/zlax.bundle.js')
importScripts(swBase + 'aze/zlax.config.js')
importScripts(__uv$config.sw || swBase + 'aze/zlax.sw.js')

importScripts(swBase + 'vzgm/yjee.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tryu/')) {
