...
const swBase = self.location.pathname.replace(/gbavlu\.js$/, '')

importScripts(swBase + 'oir/phom.bundle.js')
importScripts(swBase + 'oir/phom.config.js')
importScripts(__uv$config.sw || swBase + 'oir/phom.sw.js')

importScripts(swBase + 'xmuc/mtmo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kdng/')) {
