const swBase = self.location.pathname.replace(/kekscs\.js$/, '')

importScripts(swBase + 'wmi/zycu.bundle.js')
importScripts(swBase + 'wmi/zycu.config.js')
importScripts(__uv$config.sw || swBase + 'wmi/zycu.sw.js')

importScripts(swBase + 'yszx/pqap.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ient/')) {
