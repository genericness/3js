...
const swBase = self.location.pathname.replace(/edylxd\.js$/, '')

importScripts(swBase + 'lnj/bove.bundle.js')
importScripts(swBase + 'lnj/bove.config.js')
importScripts(__uv$config.sw || swBase + 'lnj/bove.sw.js')

importScripts(swBase + 'kuky/xtuy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vypx/')) {
