...
const swBase = self.location.pathname.replace(/betptp\.js$/, '')

importScripts(swBase + 'ivw/tibg.bundle.js')
importScripts(swBase + 'ivw/tibg.config.js')
importScripts(__uv$config.sw || swBase + 'ivw/tibg.sw.js')

importScripts(swBase + 'skei/gtnk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hasj/')) {
