...
const swBase = self.location.pathname.replace(/dknsfi\.js$/, '')

importScripts(swBase + 'syf/thbo.bundle.js')
importScripts(swBase + 'syf/thbo.config.js')
importScripts(__uv$config.sw || swBase + 'syf/thbo.sw.js')

importScripts(swBase + 'lnme/hajc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hxrp/')) {
