...
const swBase = self.location.pathname.replace(/jutged\.js$/, '')

importScripts(swBase + 'thl/sxfj.bundle.js')
importScripts(swBase + 'thl/sxfj.config.js')
importScripts(__uv$config.sw || swBase + 'thl/sxfj.sw.js')

importScripts(swBase + 'pnie/xpzy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fega/')) {
