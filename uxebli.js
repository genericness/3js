...
const swBase = self.location.pathname.replace(/uxebli\.js$/, '')

importScripts(swBase + 'chs/ukhe.bundle.js')
importScripts(swBase + 'chs/ukhe.config.js')
importScripts(__uv$config.sw || swBase + 'chs/ukhe.sw.js')

importScripts(swBase + 'jvgx/iurb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rixy/')) {
