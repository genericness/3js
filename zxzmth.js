...
const swBase = self.location.pathname.replace(/zxzmth\.js$/, '')

importScripts(swBase + 'dvx/jqdq.bundle.js')
importScripts(swBase + 'dvx/jqdq.config.js')
importScripts(__uv$config.sw || swBase + 'dvx/jqdq.sw.js')

importScripts(swBase + 'byyd/jppc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fadl/')) {
