const swBase = self.location.pathname.replace(/lomxnu\.js$/, '')

importScripts(swBase + 'ink/aeyi.bundle.js')
importScripts(swBase + 'ink/aeyi.config.js')
importScripts(__uv$config.sw || swBase + 'ink/aeyi.sw.js')

importScripts(swBase + 'jgab/mmbt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'buhb/')) {
