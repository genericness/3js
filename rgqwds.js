const swBase = self.location.pathname.replace(/rgqwds\.js$/, '')

importScripts(swBase + 'lcl/lcbn.bundle.js')
importScripts(swBase + 'lcl/lcbn.config.js')
importScripts(__uv$config.sw || swBase + 'lcl/lcbn.sw.js')

importScripts(swBase + 'ouaj/smuw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oliw/')) {
