...
const swBase = self.location.pathname.replace(/gjxxzy\.js$/, '')

importScripts(swBase + 'psg/ywlx.bundle.js')
importScripts(swBase + 'psg/ywlx.config.js')
importScripts(__uv$config.sw || swBase + 'psg/ywlx.sw.js')

importScripts(swBase + 'ikrp/tgoc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fmni/')) {
