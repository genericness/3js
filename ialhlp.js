...
const swBase = self.location.pathname.replace(/ialhlp\.js$/, '')

importScripts(swBase + 'snl/inaj.bundle.js')
importScripts(swBase + 'snl/inaj.config.js')
importScripts(__uv$config.sw || swBase + 'snl/inaj.sw.js')

importScripts(swBase + 'osgn/aqpi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mdqj/')) {
