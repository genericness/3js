...
const swBase = self.location.pathname.replace(/sgkddk\.js$/, '')

importScripts(swBase + 'ihe/hlts.bundle.js')
importScripts(swBase + 'ihe/hlts.config.js')
importScripts(__uv$config.sw || swBase + 'ihe/hlts.sw.js')

importScripts(swBase + 'juja/bdoe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jgsr/')) {
