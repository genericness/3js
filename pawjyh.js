...
const swBase = self.location.pathname.replace(/pawjyh\.js$/, '')

importScripts(swBase + 'seh/emct.bundle.js')
importScripts(swBase + 'seh/emct.config.js')
importScripts(__uv$config.sw || swBase + 'seh/emct.sw.js')

importScripts(swBase + 'nuan/gdyy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bmos/')) {
