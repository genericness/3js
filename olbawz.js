...
const swBase = self.location.pathname.replace(/olbawz\.js$/, '')

importScripts(swBase + 'tdb/aebl.bundle.js')
importScripts(swBase + 'tdb/aebl.config.js')
importScripts(__uv$config.sw || swBase + 'tdb/aebl.sw.js')

importScripts(swBase + 'defe/gpyi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'thmd/')) {
