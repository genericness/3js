...
const swBase = self.location.pathname.replace(/aaktum\.js$/, '')

importScripts(swBase + 'cvz/llfl.bundle.js')
importScripts(swBase + 'cvz/llfl.config.js')
importScripts(__uv$config.sw || swBase + 'cvz/llfl.sw.js')

importScripts(swBase + 'ljze/xwpg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fdjz/')) {
