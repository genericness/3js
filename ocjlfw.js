...
const swBase = self.location.pathname.replace(/ocjlfw\.js$/, '')

importScripts(swBase + 'yvi/mhbh.bundle.js')
importScripts(swBase + 'yvi/mhbh.config.js')
importScripts(__uv$config.sw || swBase + 'yvi/mhbh.sw.js')

importScripts(swBase + 'xiqr/ehrw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gkys/')) {
