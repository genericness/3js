...
const swBase = self.location.pathname.replace(/usgqiy\.js$/, '')

importScripts(swBase + 'sgb/cxbq.bundle.js')
importScripts(swBase + 'sgb/cxbq.config.js')
importScripts(__uv$config.sw || swBase + 'sgb/cxbq.sw.js')

importScripts(swBase + 'hibb/shwn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vxoj/')) {
