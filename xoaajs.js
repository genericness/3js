...
const swBase = self.location.pathname.replace(/xoaajs\.js$/, '')

importScripts(swBase + 'nvl/tiuf.bundle.js')
importScripts(swBase + 'nvl/tiuf.config.js')
importScripts(__uv$config.sw || swBase + 'nvl/tiuf.sw.js')

importScripts(swBase + 'wbge/fwhh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'aoaj/')) {
