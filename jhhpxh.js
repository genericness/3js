...
const swBase = self.location.pathname.replace(/jhhpxh\.js$/, '')

importScripts(swBase + 'jqe/saum.bundle.js')
importScripts(swBase + 'jqe/saum.config.js')
importScripts(__uv$config.sw || swBase + 'jqe/saum.sw.js')

importScripts(swBase + 'odbe/mfns.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nhsp/')) {
