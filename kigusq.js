...
const swBase = self.location.pathname.replace(/kigusq\.js$/, '')

importScripts(swBase + 'rzb/dbvh.bundle.js')
importScripts(swBase + 'rzb/dbvh.config.js')
importScripts(__uv$config.sw || swBase + 'rzb/dbvh.sw.js')

importScripts(swBase + 'iqtm/ymuk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jypp/')) {
