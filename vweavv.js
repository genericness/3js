...
const swBase = self.location.pathname.replace(/vweavv\.js$/, '')

importScripts(swBase + 'lya/wcjb.bundle.js')
importScripts(swBase + 'lya/wcjb.config.js')
importScripts(__uv$config.sw || swBase + 'lya/wcjb.sw.js')

importScripts(swBase + 'oljj/brvs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ijej/')) {
