const swBase = self.location.pathname.replace(/oulvob\.js$/, '')

importScripts(swBase + 'qfj/cgjk.bundle.js')
importScripts(swBase + 'qfj/cgjk.config.js')
importScripts(__uv$config.sw || swBase + 'qfj/cgjk.sw.js')

importScripts(swBase + 'fisn/xxgm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ebfq/')) {
