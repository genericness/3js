const swBase = self.location.pathname.replace(/xqgmkz\.js$/, '')

importScripts(swBase + 'ykq/anzj.bundle.js')
importScripts(swBase + 'ykq/anzj.config.js')
importScripts(__uv$config.sw || swBase + 'ykq/anzj.sw.js')

importScripts(swBase + 'xilk/mjzl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uuth/')) {
