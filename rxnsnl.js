...
const swBase = self.location.pathname.replace(/rxnsnl\.js$/, '')

importScripts(swBase + 'wul/hidt.bundle.js')
importScripts(swBase + 'wul/hidt.config.js')
importScripts(__uv$config.sw || swBase + 'wul/hidt.sw.js')

importScripts(swBase + 'qcor/zkbn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ppde/')) {
