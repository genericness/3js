...
const swBase = self.location.pathname.replace(/vglqdd\.js$/, '')

importScripts(swBase + 'tie/mjid.bundle.js')
importScripts(swBase + 'tie/mjid.config.js')
importScripts(__uv$config.sw || swBase + 'tie/mjid.sw.js')

importScripts(swBase + 'wnnj/xxet.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zleu/')) {
