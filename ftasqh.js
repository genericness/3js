...
const swBase = self.location.pathname.replace(/ftasqh\.js$/, '')

importScripts(swBase + 'fym/xdud.bundle.js')
importScripts(swBase + 'fym/xdud.config.js')
importScripts(__uv$config.sw || swBase + 'fym/xdud.sw.js')

importScripts(swBase + 'kdry/avdm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bczr/')) {
