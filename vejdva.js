...
const swBase = self.location.pathname.replace(/vejdva\.js$/, '')

importScripts(swBase + 'yjx/dcyt.bundle.js')
importScripts(swBase + 'yjx/dcyt.config.js')
importScripts(__uv$config.sw || swBase + 'yjx/dcyt.sw.js')

importScripts(swBase + 'bvrt/eqor.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'meyp/')) {
