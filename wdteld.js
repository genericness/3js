...
const swBase = self.location.pathname.replace(/wdteld\.js$/, '')

importScripts(swBase + 'tdn/mhcw.bundle.js')
importScripts(swBase + 'tdn/mhcw.config.js')
importScripts(__uv$config.sw || swBase + 'tdn/mhcw.sw.js')

importScripts(swBase + 'qzaz/hqiu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fpjl/')) {
