...
const swBase = self.location.pathname.replace(/smitad\.js$/, '')

importScripts(swBase + 'but/serr.bundle.js')
importScripts(swBase + 'but/serr.config.js')
importScripts(__uv$config.sw || swBase + 'but/serr.sw.js')

importScripts(swBase + 'cojp/npyh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vpzs/')) {
