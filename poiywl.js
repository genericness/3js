...
const swBase = self.location.pathname.replace(/poiywl\.js$/, '')

importScripts(swBase + 'olv/stqt.bundle.js')
importScripts(swBase + 'olv/stqt.config.js')
importScripts(__uv$config.sw || swBase + 'olv/stqt.sw.js')

importScripts(swBase + 'bpnf/xzof.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ttba/')) {
