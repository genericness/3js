...
const swBase = self.location.pathname.replace(/dfbdkb\.js$/, '')

importScripts(swBase + 'jih/dcln.bundle.js')
importScripts(swBase + 'jih/dcln.config.js')
importScripts(__uv$config.sw || swBase + 'jih/dcln.sw.js')

importScripts(swBase + 'nlde/zupw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'spwo/')) {
