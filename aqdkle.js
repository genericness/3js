...
const swBase = self.location.pathname.replace(/aqdkle\.js$/, '')

importScripts(swBase + 'hrk/bvxp.bundle.js')
importScripts(swBase + 'hrk/bvxp.config.js')
importScripts(__uv$config.sw || swBase + 'hrk/bvxp.sw.js')

importScripts(swBase + 'ndos/zqnj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yhbw/')) {
