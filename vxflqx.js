const swBase = self.location.pathname.replace(/vxflqx\.js$/, '')

importScripts(swBase + 'kwk/dalh.bundle.js')
importScripts(swBase + 'kwk/dalh.config.js')
importScripts(__uv$config.sw || swBase + 'kwk/dalh.sw.js')

importScripts(swBase + 'jojs/gxch.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sneu/')) {
