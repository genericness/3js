...
const swBase = self.location.pathname.replace(/eeeilw\.js$/, '')

importScripts(swBase + 'pwv/rlkw.bundle.js')
importScripts(swBase + 'pwv/rlkw.config.js')
importScripts(__uv$config.sw || swBase + 'pwv/rlkw.sw.js')

importScripts(swBase + 'jlti/eetb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'acwx/')) {
