const swBase = self.location.pathname.replace(/enifsb\.js$/, '')

importScripts(swBase + 'uyk/gpzo.bundle.js')
importScripts(swBase + 'uyk/gpzo.config.js')
importScripts(__uv$config.sw || swBase + 'uyk/gpzo.sw.js')

importScripts(swBase + 'cszi/krzq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'aahi/')) {
