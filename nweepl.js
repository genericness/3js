...
const swBase = self.location.pathname.replace(/nweepl\.js$/, '')

importScripts(swBase + 'cia/qpdp.bundle.js')
importScripts(swBase + 'cia/qpdp.config.js')
importScripts(__uv$config.sw || swBase + 'cia/qpdp.sw.js')

importScripts(swBase + 'lbgi/zawj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hvyc/')) {
