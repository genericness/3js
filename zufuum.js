const swBase = self.location.pathname.replace(/zufuum\.js$/, '')

importScripts(swBase + 'faq/ejsd.bundle.js')
importScripts(swBase + 'faq/ejsd.config.js')
importScripts(__uv$config.sw || swBase + 'faq/ejsd.sw.js')

importScripts(swBase + 'qgjy/qfyu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qgww/')) {
