...
const swBase = self.location.pathname.replace(/fkjxts\.js$/, '')

importScripts(swBase + 'vnd/wwsv.bundle.js')
importScripts(swBase + 'vnd/wwsv.config.js')
importScripts(__uv$config.sw || swBase + 'vnd/wwsv.sw.js')

importScripts(swBase + 'kmun/wyov.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'aucm/')) {
