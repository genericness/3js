...
const swBase = self.location.pathname.replace(/cobnfu\.js$/, '')

importScripts(swBase + 'rvq/yenx.bundle.js')
importScripts(swBase + 'rvq/yenx.config.js')
importScripts(__uv$config.sw || swBase + 'rvq/yenx.sw.js')

importScripts(swBase + 'mqey/rvbe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'foty/')) {
