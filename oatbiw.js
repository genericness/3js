...
const swBase = self.location.pathname.replace(/oatbiw\.js$/, '')

importScripts(swBase + 'bif/twml.bundle.js')
importScripts(swBase + 'bif/twml.config.js')
importScripts(__uv$config.sw || swBase + 'bif/twml.sw.js')

importScripts(swBase + 'eipj/ygzv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ohof/')) {
