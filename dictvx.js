const swBase = self.location.pathname.replace(/dictvx\.js$/, '')

importScripts(swBase + 'wen/eztv.bundle.js')
importScripts(swBase + 'wen/eztv.config.js')
importScripts(__uv$config.sw || swBase + 'wen/eztv.sw.js')

importScripts(swBase + 'oluy/ucvk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zzhy/')) {
