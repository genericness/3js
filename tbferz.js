...
const swBase = self.location.pathname.replace(/tbferz\.js$/, '')

importScripts(swBase + 'xcp/bxvx.bundle.js')
importScripts(swBase + 'xcp/bxvx.config.js')
importScripts(__uv$config.sw || swBase + 'xcp/bxvx.sw.js')

importScripts(swBase + 'zxtn/ghvk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fecd/')) {
