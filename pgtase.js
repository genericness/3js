...
const swBase = self.location.pathname.replace(/pgtase\.js$/, '')

importScripts(swBase + 'hzc/vude.bundle.js')
importScripts(swBase + 'hzc/vude.config.js')
importScripts(__uv$config.sw || swBase + 'hzc/vude.sw.js')

importScripts(swBase + 'ujeh/nlej.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gxcv/')) {
