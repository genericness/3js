...
const swBase = self.location.pathname.replace(/pumvaz\.js$/, '')

importScripts(swBase + 'dzw/phmg.bundle.js')
importScripts(swBase + 'dzw/phmg.config.js')
importScripts(__uv$config.sw || swBase + 'dzw/phmg.sw.js')

importScripts(swBase + 'gjnj/rsky.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fwxa/')) {
