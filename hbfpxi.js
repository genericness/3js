...
const swBase = self.location.pathname.replace(/hbfpxi\.js$/, '')

importScripts(swBase + 'ipe/vimh.bundle.js')
importScripts(swBase + 'ipe/vimh.config.js')
importScripts(__uv$config.sw || swBase + 'ipe/vimh.sw.js')

importScripts(swBase + 'rguc/zbzb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'blfk/')) {
