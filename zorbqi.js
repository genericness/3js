...
const swBase = self.location.pathname.replace(/zorbqi\.js$/, '')

importScripts(swBase + 'kni/axwb.bundle.js')
importScripts(swBase + 'kni/axwb.config.js')
importScripts(__uv$config.sw || swBase + 'kni/axwb.sw.js')

importScripts(swBase + 'vosa/qakz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wgmw/')) {
