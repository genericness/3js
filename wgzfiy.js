const swBase = self.location.pathname.replace(/wgzfiy\.js$/, '')

importScripts(swBase + 'inf/bivj.bundle.js')
importScripts(swBase + 'inf/bivj.config.js')
importScripts(__uv$config.sw || swBase + 'inf/bivj.sw.js')

importScripts(swBase + 'oztf/cjue.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nhxy/')) {
