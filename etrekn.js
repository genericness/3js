...
const swBase = self.location.pathname.replace(/etrekn\.js$/, '')

importScripts(swBase + 'xhv/trnr.bundle.js')
importScripts(swBase + 'xhv/trnr.config.js')
importScripts(__uv$config.sw || swBase + 'xhv/trnr.sw.js')

importScripts(swBase + 'lals/kley.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rgmv/')) {
