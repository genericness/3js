...
const swBase = self.location.pathname.replace(/wuplhn\.js$/, '')

importScripts(swBase + 'wfv/jdjn.bundle.js')
importScripts(swBase + 'wfv/jdjn.config.js')
importScripts(__uv$config.sw || swBase + 'wfv/jdjn.sw.js')

importScripts(swBase + 'psfh/bhdh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eswp/')) {
