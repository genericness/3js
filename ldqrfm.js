...
const swBase = self.location.pathname.replace(/ldqrfm\.js$/, '')

importScripts(swBase + 'mxq/mgsk.bundle.js')
importScripts(swBase + 'mxq/mgsk.config.js')
importScripts(__uv$config.sw || swBase + 'mxq/mgsk.sw.js')

importScripts(swBase + 'lzga/uduh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qdcu/')) {
