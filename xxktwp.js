...
const swBase = self.location.pathname.replace(/xxktwp\.js$/, '')

importScripts(swBase + 'xxv/gyum.bundle.js')
importScripts(swBase + 'xxv/gyum.config.js')
importScripts(__uv$config.sw || swBase + 'xxv/gyum.sw.js')

importScripts(swBase + 'czmh/yhgy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ggte/')) {
