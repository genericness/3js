...
const swBase = self.location.pathname.replace(/cazbzw\.js$/, '')

importScripts(swBase + 'lrp/gsbk.bundle.js')
importScripts(swBase + 'lrp/gsbk.config.js')
importScripts(__uv$config.sw || swBase + 'lrp/gsbk.sw.js')

importScripts(swBase + 'qcwe/bsde.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dcze/')) {
