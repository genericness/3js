...
const swBase = self.location.pathname.replace(/ecljmk\.js$/, '')

importScripts(swBase + 'ihl/inge.bundle.js')
importScripts(swBase + 'ihl/inge.config.js')
importScripts(__uv$config.sw || swBase + 'ihl/inge.sw.js')

importScripts(swBase + 'tkkp/wdzj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'plkp/')) {
