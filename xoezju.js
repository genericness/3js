...
const swBase = self.location.pathname.replace(/xoezju\.js$/, '')

importScripts(swBase + 'cts/nomi.bundle.js')
importScripts(swBase + 'cts/nomi.config.js')
importScripts(__uv$config.sw || swBase + 'cts/nomi.sw.js')

importScripts(swBase + 'eooz/dild.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'napi/')) {
