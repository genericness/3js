...
const swBase = self.location.pathname.replace(/xtrxek\.js$/, '')

importScripts(swBase + 'mqa/rqas.bundle.js')
importScripts(swBase + 'mqa/rqas.config.js')
importScripts(__uv$config.sw || swBase + 'mqa/rqas.sw.js')

importScripts(swBase + 'zirc/zwde.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vqdg/')) {
