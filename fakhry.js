const swBase = self.location.pathname.replace(/fakhry\.js$/, '')

importScripts(swBase + 'kfi/fqkv.bundle.js')
importScripts(swBase + 'kfi/fqkv.config.js')
importScripts(__uv$config.sw || swBase + 'kfi/fqkv.sw.js')

importScripts(swBase + 'ogzx/pnvv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mkao/')) {
