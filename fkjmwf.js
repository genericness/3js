...
const swBase = self.location.pathname.replace(/fkjmwf\.js$/, '')

importScripts(swBase + 'byj/aviv.bundle.js')
importScripts(swBase + 'byj/aviv.config.js')
importScripts(__uv$config.sw || swBase + 'byj/aviv.sw.js')

importScripts(swBase + 'majc/ickg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'esze/')) {
