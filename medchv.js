const swBase = self.location.pathname.replace(/medchv\.js$/, '')

importScripts(swBase + 'boz/jdai.bundle.js')
importScripts(swBase + 'boz/jdai.config.js')
importScripts(__uv$config.sw || swBase + 'boz/jdai.sw.js')

importScripts(swBase + 'myvd/oqyt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'texq/')) {
