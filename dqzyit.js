...
const swBase = self.location.pathname.replace(/dqzyit\.js$/, '')

importScripts(swBase + 'dhn/dftr.bundle.js')
importScripts(swBase + 'dhn/dftr.config.js')
importScripts(__uv$config.sw || swBase + 'dhn/dftr.sw.js')

importScripts(swBase + 'fkws/dvyb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gdsr/')) {
