...
const swBase = self.location.pathname.replace(/izkbre\.js$/, '')

importScripts(swBase + 'fkz/qjpn.bundle.js')
importScripts(swBase + 'fkz/qjpn.config.js')
importScripts(__uv$config.sw || swBase + 'fkz/qjpn.sw.js')

importScripts(swBase + 'tpcu/crom.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fjdz/')) {
