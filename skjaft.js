const swBase = self.location.pathname.replace(/skjaft\.js$/, '')

importScripts(swBase + 'gck/rsam.bundle.js')
importScripts(swBase + 'gck/rsam.config.js')
importScripts(__uv$config.sw || swBase + 'gck/rsam.sw.js')

importScripts(swBase + 'qsvw/pmzm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'owsv/')) {
