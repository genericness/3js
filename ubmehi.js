...
const swBase = self.location.pathname.replace(/ubmehi\.js$/, '')

importScripts(swBase + 'wvj/ukge.bundle.js')
importScripts(swBase + 'wvj/ukge.config.js')
importScripts(__uv$config.sw || swBase + 'wvj/ukge.sw.js')

importScripts(swBase + 'djkm/futj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ynio/')) {
