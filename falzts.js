...
const swBase = self.location.pathname.replace(/falzts\.js$/, '')

importScripts(swBase + 'itc/uets.bundle.js')
importScripts(swBase + 'itc/uets.config.js')
importScripts(__uv$config.sw || swBase + 'itc/uets.sw.js')

importScripts(swBase + 'xbbx/neqo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iloa/')) {
