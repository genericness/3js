...
const swBase = self.location.pathname.replace(/qinytw\.js$/, '')

importScripts(swBase + 'iqm/kzth.bundle.js')
importScripts(swBase + 'iqm/kzth.config.js')
importScripts(__uv$config.sw || swBase + 'iqm/kzth.sw.js')

importScripts(swBase + 'hnzo/qmig.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bltg/')) {
