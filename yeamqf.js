...
const swBase = self.location.pathname.replace(/yeamqf\.js$/, '')

importScripts(swBase + 'wli/ayfc.bundle.js')
importScripts(swBase + 'wli/ayfc.config.js')
importScripts(__uv$config.sw || swBase + 'wli/ayfc.sw.js')

importScripts(swBase + 'agjz/ntvg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bcok/')) {
