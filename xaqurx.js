...
const swBase = self.location.pathname.replace(/xaqurx\.js$/, '')

importScripts(swBase + 'fqc/lmmu.bundle.js')
importScripts(swBase + 'fqc/lmmu.config.js')
importScripts(__uv$config.sw || swBase + 'fqc/lmmu.sw.js')

importScripts(swBase + 'bbqe/jhai.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'glbm/')) {
