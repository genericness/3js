const swBase = self.location.pathname.replace(/sqiitf\.js$/, '')

importScripts(swBase + 'etz/imcl.bundle.js')
importScripts(swBase + 'etz/imcl.config.js')
importScripts(__uv$config.sw || swBase + 'etz/imcl.sw.js')

importScripts(swBase + 'dmif/unng.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'txxi/')) {
