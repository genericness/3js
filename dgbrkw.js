...
const swBase = self.location.pathname.replace(/dgbrkw\.js$/, '')

importScripts(swBase + 'prk/qkij.bundle.js')
importScripts(swBase + 'prk/qkij.config.js')
importScripts(__uv$config.sw || swBase + 'prk/qkij.sw.js')

importScripts(swBase + 'ilut/gjbj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'punb/')) {
