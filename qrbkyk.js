...
const swBase = self.location.pathname.replace(/qrbkyk\.js$/, '')

importScripts(swBase + 'uya/csmj.bundle.js')
importScripts(swBase + 'uya/csmj.config.js')
importScripts(__uv$config.sw || swBase + 'uya/csmj.sw.js')

importScripts(swBase + 'gtmf/oeoq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uuwt/')) {
