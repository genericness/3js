...
const swBase = self.location.pathname.replace(/kkdyar\.js$/, '')

importScripts(swBase + 'jpl/qfji.bundle.js')
importScripts(swBase + 'jpl/qfji.config.js')
importScripts(__uv$config.sw || swBase + 'jpl/qfji.sw.js')

importScripts(swBase + 'cjfk/qcok.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qxqz/')) {
