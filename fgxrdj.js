...
const swBase = self.location.pathname.replace(/fgxrdj\.js$/, '')

importScripts(swBase + 'qer/cfhp.bundle.js')
importScripts(swBase + 'qer/cfhp.config.js')
importScripts(__uv$config.sw || swBase + 'qer/cfhp.sw.js')

importScripts(swBase + 'myfi/tbfh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'irtv/')) {
