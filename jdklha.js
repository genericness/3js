...
const swBase = self.location.pathname.replace(/jdklha\.js$/, '')

importScripts(swBase + 'ejj/edrg.bundle.js')
importScripts(swBase + 'ejj/edrg.config.js')
importScripts(__uv$config.sw || swBase + 'ejj/edrg.sw.js')

importScripts(swBase + 'afvs/udom.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'frnd/')) {
