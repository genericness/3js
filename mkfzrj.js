...
const swBase = self.location.pathname.replace(/mkfzrj\.js$/, '')

importScripts(swBase + 'ino/ence.bundle.js')
importScripts(swBase + 'ino/ence.config.js')
importScripts(__uv$config.sw || swBase + 'ino/ence.sw.js')

importScripts(swBase + 'uysn/glpj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qxuq/')) {
