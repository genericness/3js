const swBase = self.location.pathname.replace(/rfypoe\.js$/, '')

importScripts(swBase + 'juu/xqok.bundle.js')
importScripts(swBase + 'juu/xqok.config.js')
importScripts(__uv$config.sw || swBase + 'juu/xqok.sw.js')

importScripts(swBase + 'wgdo/mrvj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nchf/')) {
