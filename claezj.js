...
const swBase = self.location.pathname.replace(/claezj\.js$/, '')

importScripts(swBase + 'aia/gtlx.bundle.js')
importScripts(swBase + 'aia/gtlx.config.js')
importScripts(__uv$config.sw || swBase + 'aia/gtlx.sw.js')

importScripts(swBase + 'ncbx/pguf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kzpj/')) {
