const swBase = self.location.pathname.replace(/mcdiht\.js$/, '')

importScripts(swBase + 'jii/htnx.bundle.js')
importScripts(swBase + 'jii/htnx.config.js')
importScripts(__uv$config.sw || swBase + 'jii/htnx.sw.js')

importScripts(swBase + 'aikd/yoxj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wgrk/')) {
