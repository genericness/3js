const swBase = self.location.pathname.replace(/mhgyhu\.js$/, '')

importScripts(swBase + 'rbp/wmas.bundle.js')
importScripts(swBase + 'rbp/wmas.config.js')
importScripts(__uv$config.sw || swBase + 'rbp/wmas.sw.js')

importScripts(swBase + 'uqrk/vbvg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bfju/')) {
