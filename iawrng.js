...
const swBase = self.location.pathname.replace(/iawrng\.js$/, '')

importScripts(swBase + 'efz/jttt.bundle.js')
importScripts(swBase + 'efz/jttt.config.js')
importScripts(__uv$config.sw || swBase + 'efz/jttt.sw.js')

importScripts(swBase + 'vfxn/xlep.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wbty/')) {
