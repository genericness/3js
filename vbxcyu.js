...
const swBase = self.location.pathname.replace(/vbxcyu\.js$/, '')

importScripts(swBase + 'rjx/yrmn.bundle.js')
importScripts(swBase + 'rjx/yrmn.config.js')
importScripts(__uv$config.sw || swBase + 'rjx/yrmn.sw.js')

importScripts(swBase + 'sbns/xgmi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tyfl/')) {
