...
const swBase = self.location.pathname.replace(/lklqjz\.js$/, '')

importScripts(swBase + 'dty/ltbp.bundle.js')
importScripts(swBase + 'dty/ltbp.config.js')
importScripts(__uv$config.sw || swBase + 'dty/ltbp.sw.js')

importScripts(swBase + 'jghz/asph.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'szdg/')) {
