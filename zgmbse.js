...
const swBase = self.location.pathname.replace(/zgmbse\.js$/, '')

importScripts(swBase + 'kxp/piuj.bundle.js')
importScripts(swBase + 'kxp/piuj.config.js')
importScripts(__uv$config.sw || swBase + 'kxp/piuj.sw.js')

importScripts(swBase + 'qylu/fiya.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vxat/')) {
