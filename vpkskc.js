const swBase = self.location.pathname.replace(/vpkskc\.js$/, '')

importScripts(swBase + 'mes/pjxo.bundle.js')
importScripts(swBase + 'mes/pjxo.config.js')
importScripts(__uv$config.sw || swBase + 'mes/pjxo.sw.js')

importScripts(swBase + 'kbcr/uxwq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nmgr/')) {
