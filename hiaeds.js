...
const swBase = self.location.pathname.replace(/hiaeds\.js$/, '')

importScripts(swBase + 'ukt/qtik.bundle.js')
importScripts(swBase + 'ukt/qtik.config.js')
importScripts(__uv$config.sw || swBase + 'ukt/qtik.sw.js')

importScripts(swBase + 'xhbu/bnnm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lhgx/')) {
