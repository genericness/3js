...
const swBase = self.location.pathname.replace(/qthivh\.js$/, '')

importScripts(swBase + 'raa/eqqe.bundle.js')
importScripts(swBase + 'raa/eqqe.config.js')
importScripts(__uv$config.sw || swBase + 'raa/eqqe.sw.js')

importScripts(swBase + 'tsyu/tfiw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yynm/')) {
