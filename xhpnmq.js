...
const swBase = self.location.pathname.replace(/xhpnmq\.js$/, '')

importScripts(swBase + 'pkq/yylm.bundle.js')
importScripts(swBase + 'pkq/yylm.config.js')
importScripts(__uv$config.sw || swBase + 'pkq/yylm.sw.js')

importScripts(swBase + 'noqm/fqdi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wezw/')) {
