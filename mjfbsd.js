...
const swBase = self.location.pathname.replace(/mjfbsd\.js$/, '')

importScripts(swBase + 'jgj/ycbc.bundle.js')
importScripts(swBase + 'jgj/ycbc.config.js')
importScripts(__uv$config.sw || swBase + 'jgj/ycbc.sw.js')

importScripts(swBase + 'pcng/tzaw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hrhu/')) {
