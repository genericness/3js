...
const swBase = self.location.pathname.replace(/kxyrrd\.js$/, '')

importScripts(swBase + 'zii/aifo.bundle.js')
importScripts(swBase + 'zii/aifo.config.js')
importScripts(__uv$config.sw || swBase + 'zii/aifo.sw.js')

importScripts(swBase + 'ntpk/yizo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lbwq/')) {
