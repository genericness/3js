...
const swBase = self.location.pathname.replace(/tyzfee\.js$/, '')

importScripts(swBase + 'jlh/lyvw.bundle.js')
importScripts(swBase + 'jlh/lyvw.config.js')
importScripts(__uv$config.sw || swBase + 'jlh/lyvw.sw.js')

importScripts(swBase + 'dxdm/plng.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sapk/')) {
