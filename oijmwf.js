...
const swBase = self.location.pathname.replace(/oijmwf\.js$/, '')

importScripts(swBase + 'bqw/tdcs.bundle.js')
importScripts(swBase + 'bqw/tdcs.config.js')
importScripts(__uv$config.sw || swBase + 'bqw/tdcs.sw.js')

importScripts(swBase + 'ffas/rgaq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ymjv/')) {
