...
const swBase = self.location.pathname.replace(/dmilxm\.js$/, '')

importScripts(swBase + 'vrj/kepi.bundle.js')
importScripts(swBase + 'vrj/kepi.config.js')
importScripts(__uv$config.sw || swBase + 'vrj/kepi.sw.js')

importScripts(swBase + 'jkvw/dvcn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rufu/')) {
