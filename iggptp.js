...
const swBase = self.location.pathname.replace(/iggptp\.js$/, '')

importScripts(swBase + 'hov/ertv.bundle.js')
importScripts(swBase + 'hov/ertv.config.js')
importScripts(__uv$config.sw || swBase + 'hov/ertv.sw.js')

importScripts(swBase + 'pbwi/xnft.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gwvn/')) {
