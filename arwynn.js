...
const swBase = self.location.pathname.replace(/arwynn\.js$/, '')

importScripts(swBase + 'rqt/vblx.bundle.js')
importScripts(swBase + 'rqt/vblx.config.js')
importScripts(__uv$config.sw || swBase + 'rqt/vblx.sw.js')

importScripts(swBase + 'mrll/orpg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zqcg/')) {
