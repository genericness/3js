...
const swBase = self.location.pathname.replace(/bnosdn\.js$/, '')

importScripts(swBase + 'mdi/idbz.bundle.js')
importScripts(swBase + 'mdi/idbz.config.js')
importScripts(__uv$config.sw || swBase + 'mdi/idbz.sw.js')

importScripts(swBase + 'izgy/pjjr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xdjf/')) {
