...
const swBase = self.location.pathname.replace(/lgcmnu\.js$/, '')

importScripts(swBase + 'pmu/lkgc.bundle.js')
importScripts(swBase + 'pmu/lkgc.config.js')
importScripts(__uv$config.sw || swBase + 'pmu/lkgc.sw.js')

importScripts(swBase + 'nkkh/sopw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'byyc/')) {
