...
const swBase = self.location.pathname.replace(/perwzn\.js$/, '')

importScripts(swBase + 'len/xbpy.bundle.js')
importScripts(swBase + 'len/xbpy.config.js')
importScripts(__uv$config.sw || swBase + 'len/xbpy.sw.js')

importScripts(swBase + 'kitq/utzu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ppoz/')) {
