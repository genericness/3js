...
const swBase = self.location.pathname.replace(/geqfsy\.js$/, '')

importScripts(swBase + 'gyw/ucav.bundle.js')
importScripts(swBase + 'gyw/ucav.config.js')
importScripts(__uv$config.sw || swBase + 'gyw/ucav.sw.js')

importScripts(swBase + 'opgt/fsrz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oujk/')) {
