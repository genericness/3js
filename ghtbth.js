...
const swBase = self.location.pathname.replace(/ghtbth\.js$/, '')

importScripts(swBase + 'nuj/zdpr.bundle.js')
importScripts(swBase + 'nuj/zdpr.config.js')
importScripts(__uv$config.sw || swBase + 'nuj/zdpr.sw.js')

importScripts(swBase + 'mmaa/eyrd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'njft/')) {
