...
const swBase = self.location.pathname.replace(/rmlohq\.js$/, '')

importScripts(swBase + 'ouj/jmid.bundle.js')
importScripts(swBase + 'ouj/jmid.config.js')
importScripts(__uv$config.sw || swBase + 'ouj/jmid.sw.js')

importScripts(swBase + 'boaw/wuun.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'auoi/')) {
