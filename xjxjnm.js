...
const swBase = self.location.pathname.replace(/xjxjnm\.js$/, '')

importScripts(swBase + 'gve/vtfw.bundle.js')
importScripts(swBase + 'gve/vtfw.config.js')
importScripts(__uv$config.sw || swBase + 'gve/vtfw.sw.js')

importScripts(swBase + 'zore/zxgy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pvmy/')) {
