...
const swBase = self.location.pathname.replace(/ladxes\.js$/, '')

importScripts(swBase + 'fub/hzxn.bundle.js')
importScripts(swBase + 'fub/hzxn.config.js')
importScripts(__uv$config.sw || swBase + 'fub/hzxn.sw.js')

importScripts(swBase + 'owml/ennv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fiby/')) {
