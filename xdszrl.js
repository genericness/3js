...
const swBase = self.location.pathname.replace(/xdszrl\.js$/, '')

importScripts(swBase + 'puo/nsrz.bundle.js')
importScripts(swBase + 'puo/nsrz.config.js')
importScripts(__uv$config.sw || swBase + 'puo/nsrz.sw.js')

importScripts(swBase + 'ksyo/ebqj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ayaw/')) {
