...
const swBase = self.location.pathname.replace(/vcaeiv\.js$/, '')

importScripts(swBase + 'rex/xwfh.bundle.js')
importScripts(swBase + 'rex/xwfh.config.js')
importScripts(__uv$config.sw || swBase + 'rex/xwfh.sw.js')

importScripts(swBase + 'qfcp/ateq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ogvl/')) {
