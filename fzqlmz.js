...
const swBase = self.location.pathname.replace(/fzqlmz\.js$/, '')

importScripts(swBase + 'cue/abxx.bundle.js')
importScripts(swBase + 'cue/abxx.config.js')
importScripts(__uv$config.sw || swBase + 'cue/abxx.sw.js')

importScripts(swBase + 'edku/srdg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kwgf/')) {
