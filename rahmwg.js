...
const swBase = self.location.pathname.replace(/rahmwg\.js$/, '')

importScripts(swBase + 'wex/drdh.bundle.js')
importScripts(swBase + 'wex/drdh.config.js')
importScripts(__uv$config.sw || swBase + 'wex/drdh.sw.js')

importScripts(swBase + 'scnl/yfre.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rlzz/')) {
