...
const swBase = self.location.pathname.replace(/lnrlce\.js$/, '')

importScripts(swBase + 'apa/pnue.bundle.js')
importScripts(swBase + 'apa/pnue.config.js')
importScripts(__uv$config.sw || swBase + 'apa/pnue.sw.js')

importScripts(swBase + 'vxmj/ujbv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'drjd/')) {
