...
const swBase = self.location.pathname.replace(/djeplj\.js$/, '')

importScripts(swBase + 'wtj/hkdn.bundle.js')
importScripts(swBase + 'wtj/hkdn.config.js')
importScripts(__uv$config.sw || swBase + 'wtj/hkdn.sw.js')

importScripts(swBase + 'fqao/uveg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hbfn/')) {
