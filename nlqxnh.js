...
const swBase = self.location.pathname.replace(/nlqxnh\.js$/, '')

importScripts(swBase + 'bea/zlwh.bundle.js')
importScripts(swBase + 'bea/zlwh.config.js')
importScripts(__uv$config.sw || swBase + 'bea/zlwh.sw.js')

importScripts(swBase + 'tzas/lelw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'akbg/')) {
