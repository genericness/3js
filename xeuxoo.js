...
const swBase = self.location.pathname.replace(/xeuxoo\.js$/, '')

importScripts(swBase + 'oxc/vcwp.bundle.js')
importScripts(swBase + 'oxc/vcwp.config.js')
importScripts(__uv$config.sw || swBase + 'oxc/vcwp.sw.js')

importScripts(swBase + 'ejti/sdha.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eluk/')) {
