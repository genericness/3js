...
const swBase = self.location.pathname.replace(/bdybuj\.js$/, '')

importScripts(swBase + 'odi/pnve.bundle.js')
importScripts(swBase + 'odi/pnve.config.js')
importScripts(__uv$config.sw || swBase + 'odi/pnve.sw.js')

importScripts(swBase + 'usxn/tjxz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pnuu/')) {
