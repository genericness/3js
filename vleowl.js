...
const swBase = self.location.pathname.replace(/vleowl\.js$/, '')

importScripts(swBase + 'hag/prib.bundle.js')
importScripts(swBase + 'hag/prib.config.js')
importScripts(__uv$config.sw || swBase + 'hag/prib.sw.js')

importScripts(swBase + 'yohr/nmse.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wnfr/')) {
