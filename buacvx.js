...
const swBase = self.location.pathname.replace(/buacvx\.js$/, '')

importScripts(swBase + 'tsq/lros.bundle.js')
importScripts(swBase + 'tsq/lros.config.js')
importScripts(__uv$config.sw || swBase + 'tsq/lros.sw.js')

importScripts(swBase + 'vuob/twgw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tkop/')) {
