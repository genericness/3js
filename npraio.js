...
const swBase = self.location.pathname.replace(/npraio\.js$/, '')

importScripts(swBase + 'jgt/mpec.bundle.js')
importScripts(swBase + 'jgt/mpec.config.js')
importScripts(__uv$config.sw || swBase + 'jgt/mpec.sw.js')

importScripts(swBase + 'dbwk/wiec.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qvzn/')) {
