...
const swBase = self.location.pathname.replace(/sxwpvj\.js$/, '')

importScripts(swBase + 'jxy/ajfx.bundle.js')
importScripts(swBase + 'jxy/ajfx.config.js')
importScripts(__uv$config.sw || swBase + 'jxy/ajfx.sw.js')

importScripts(swBase + 'cnvj/rowm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'axad/')) {
