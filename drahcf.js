...
const swBase = self.location.pathname.replace(/drahcf\.js$/, '')

importScripts(swBase + 'zih/plwo.bundle.js')
importScripts(swBase + 'zih/plwo.config.js')
importScripts(__uv$config.sw || swBase + 'zih/plwo.sw.js')

importScripts(swBase + 'zedj/huyw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'itbk/')) {
