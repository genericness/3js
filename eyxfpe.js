...
const swBase = self.location.pathname.replace(/eyxfpe\.js$/, '')

importScripts(swBase + 'uky/xlzv.bundle.js')
importScripts(swBase + 'uky/xlzv.config.js')
importScripts(__uv$config.sw || swBase + 'uky/xlzv.sw.js')

importScripts(swBase + 'tbjo/acdm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wwuy/')) {
