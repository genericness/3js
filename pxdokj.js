...
const swBase = self.location.pathname.replace(/pxdokj\.js$/, '')

importScripts(swBase + 'crb/pnau.bundle.js')
importScripts(swBase + 'crb/pnau.config.js')
importScripts(__uv$config.sw || swBase + 'crb/pnau.sw.js')

importScripts(swBase + 'aemp/ifbe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'naic/')) {
