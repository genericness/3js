...
const swBase = self.location.pathname.replace(/cqjcqb\.js$/, '')

importScripts(swBase + 'ivf/ovxg.bundle.js')
importScripts(swBase + 'ivf/ovxg.config.js')
importScripts(__uv$config.sw || swBase + 'ivf/ovxg.sw.js')

importScripts(swBase + 'odcx/xaiu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'exod/')) {
