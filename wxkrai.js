...
const swBase = self.location.pathname.replace(/wxkrai\.js$/, '')

importScripts(swBase + 'mzy/zeoh.bundle.js')
importScripts(swBase + 'mzy/zeoh.config.js')
importScripts(__uv$config.sw || swBase + 'mzy/zeoh.sw.js')

importScripts(swBase + 'rutc/pyrg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dlgw/')) {
