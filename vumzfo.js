...
const swBase = self.location.pathname.replace(/vumzfo\.js$/, '')

importScripts(swBase + 'gan/cxys.bundle.js')
importScripts(swBase + 'gan/cxys.config.js')
importScripts(__uv$config.sw || swBase + 'gan/cxys.sw.js')

importScripts(swBase + 'rhms/isex.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fpaj/')) {
