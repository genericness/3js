...
const swBase = self.location.pathname.replace(/wbqdzc\.js$/, '')

importScripts(swBase + 'oyt/bodm.bundle.js')
importScripts(swBase + 'oyt/bodm.config.js')
importScripts(__uv$config.sw || swBase + 'oyt/bodm.sw.js')

importScripts(swBase + 'zqti/tuhp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qxzf/')) {
