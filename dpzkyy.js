...
const swBase = self.location.pathname.replace(/dpzkyy\.js$/, '')

importScripts(swBase + 'yba/tfmc.bundle.js')
importScripts(swBase + 'yba/tfmc.config.js')
importScripts(__uv$config.sw || swBase + 'yba/tfmc.sw.js')

importScripts(swBase + 'yvxy/gufn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vivt/')) {
