...
const swBase = self.location.pathname.replace(/qfjauy\.js$/, '')

importScripts(swBase + 'gja/lbue.bundle.js')
importScripts(swBase + 'gja/lbue.config.js')
importScripts(__uv$config.sw || swBase + 'gja/lbue.sw.js')

importScripts(swBase + 'kfcy/doop.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cjau/')) {
