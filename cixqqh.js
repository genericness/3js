...
const swBase = self.location.pathname.replace(/cixqqh\.js$/, '')

importScripts(swBase + 'duu/gznv.bundle.js')
importScripts(swBase + 'duu/gznv.config.js')
importScripts(__uv$config.sw || swBase + 'duu/gznv.sw.js')

importScripts(swBase + 'svtb/kyhj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pwom/')) {
