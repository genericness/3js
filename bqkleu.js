const swBase = self.location.pathname.replace(/bqkleu\.js$/, '')

importScripts(swBase + 'iqn/jnad.bundle.js')
importScripts(swBase + 'iqn/jnad.config.js')
importScripts(__uv$config.sw || swBase + 'iqn/jnad.sw.js')

importScripts(swBase + 'dhrx/cpwu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xaxn/')) {
