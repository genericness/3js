const swBase = self.location.pathname.replace(/dlakhg\.js$/, '')

importScripts(swBase + 'ggr/xgzt.bundle.js')
importScripts(swBase + 'ggr/xgzt.config.js')
importScripts(__uv$config.sw || swBase + 'ggr/xgzt.sw.js')

importScripts(swBase + 'yhuz/yocj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vxbn/')) {
