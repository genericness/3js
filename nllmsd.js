...
const swBase = self.location.pathname.replace(/nllmsd\.js$/, '')

importScripts(swBase + 'buy/dzuv.bundle.js')
importScripts(swBase + 'buy/dzuv.config.js')
importScripts(__uv$config.sw || swBase + 'buy/dzuv.sw.js')

importScripts(swBase + 'eqem/hzft.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bdgw/')) {
