...
const swBase = self.location.pathname.replace(/dhuqzc\.js$/, '')

importScripts(swBase + 'enz/wnrh.bundle.js')
importScripts(swBase + 'enz/wnrh.config.js')
importScripts(__uv$config.sw || swBase + 'enz/wnrh.sw.js')

importScripts(swBase + 'jcfm/japp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cjfp/')) {
