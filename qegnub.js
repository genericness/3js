const swBase = self.location.pathname.replace(/qegnub\.js$/, '')

importScripts(swBase + 'kqh/ynau.bundle.js')
importScripts(swBase + 'kqh/ynau.config.js')
importScripts(__uv$config.sw || swBase + 'kqh/ynau.sw.js')

importScripts(swBase + 'kncq/bozp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tfdg/')) {
