...
const swBase = self.location.pathname.replace(/svlyfq\.js$/, '')

importScripts(swBase + 'new/sjav.bundle.js')
importScripts(swBase + 'new/sjav.config.js')
importScripts(__uv$config.sw || swBase + 'new/sjav.sw.js')

importScripts(swBase + 'drzd/eeyz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ajwn/')) {
