const swBase = self.location.pathname.replace(/rvdnbr\.js$/, '')

importScripts(swBase + 'ttg/aqmk.bundle.js')
importScripts(swBase + 'ttg/aqmk.config.js')
importScripts(__uv$config.sw || swBase + 'ttg/aqmk.sw.js')

importScripts(swBase + 'sxah/bpwa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ydyn/')) {
