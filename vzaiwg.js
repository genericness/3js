...
const swBase = self.location.pathname.replace(/vzaiwg\.js$/, '')

importScripts(swBase + 'cpy/vrlo.bundle.js')
importScripts(swBase + 'cpy/vrlo.config.js')
importScripts(__uv$config.sw || swBase + 'cpy/vrlo.sw.js')

importScripts(swBase + 'hrbx/bwdv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jeud/')) {
