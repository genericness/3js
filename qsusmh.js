...
const swBase = self.location.pathname.replace(/qsusmh\.js$/, '')

importScripts(swBase + 'xmd/frsa.bundle.js')
importScripts(swBase + 'xmd/frsa.config.js')
importScripts(__uv$config.sw || swBase + 'xmd/frsa.sw.js')

importScripts(swBase + 'mysr/sdmd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'atek/')) {
