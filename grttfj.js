const swBase = self.location.pathname.replace(/grttfj\.js$/, '')

importScripts(swBase + 'hsb/fjyo.bundle.js')
importScripts(swBase + 'hsb/fjyo.config.js')
importScripts(__uv$config.sw || swBase + 'hsb/fjyo.sw.js')

importScripts(swBase + 'bamr/qkgb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'psnm/')) {
