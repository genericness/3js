...
const swBase = self.location.pathname.replace(/uzaazy\.js$/, '')

importScripts(swBase + 'gtq/sgva.bundle.js')
importScripts(swBase + 'gtq/sgva.config.js')
importScripts(__uv$config.sw || swBase + 'gtq/sgva.sw.js')

importScripts(swBase + 'wgtn/yuue.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yyrf/')) {
