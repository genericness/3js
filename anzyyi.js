const swBase = self.location.pathname.replace(/anzyyi\.js$/, '')

importScripts(swBase + 'uaw/wpcc.bundle.js')
importScripts(swBase + 'uaw/wpcc.config.js')
importScripts(__uv$config.sw || swBase + 'uaw/wpcc.sw.js')

importScripts(swBase + 'inxr/safe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fuqu/')) {
