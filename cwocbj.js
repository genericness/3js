...
const swBase = self.location.pathname.replace(/cwocbj\.js$/, '')

importScripts(swBase + 'urs/dnju.bundle.js')
importScripts(swBase + 'urs/dnju.config.js')
importScripts(__uv$config.sw || swBase + 'urs/dnju.sw.js')

importScripts(swBase + 'pcrg/hgcl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kfij/')) {
