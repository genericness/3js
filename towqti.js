...
const swBase = self.location.pathname.replace(/towqti\.js$/, '')

importScripts(swBase + 'isz/naga.bundle.js')
importScripts(swBase + 'isz/naga.config.js')
importScripts(__uv$config.sw || swBase + 'isz/naga.sw.js')

importScripts(swBase + 'uyzi/crky.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wmbv/')) {
