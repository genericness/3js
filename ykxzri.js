...
const swBase = self.location.pathname.replace(/ykxzri\.js$/, '')

importScripts(swBase + 'axf/zykk.bundle.js')
importScripts(swBase + 'axf/zykk.config.js')
importScripts(__uv$config.sw || swBase + 'axf/zykk.sw.js')

importScripts(swBase + 'uixr/lmtl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qiub/')) {
