const swBase = self.location.pathname.replace(/siyhlc\.js$/, '')

importScripts(swBase + 'nip/manb.bundle.js')
importScripts(swBase + 'nip/manb.config.js')
importScripts(__uv$config.sw || swBase + 'nip/manb.sw.js')

importScripts(swBase + 'hrmb/palx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rpys/')) {
