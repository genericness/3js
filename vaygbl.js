...
const swBase = self.location.pathname.replace(/vaygbl\.js$/, '')

importScripts(swBase + 'jpr/kacz.bundle.js')
importScripts(swBase + 'jpr/kacz.config.js')
importScripts(__uv$config.sw || swBase + 'jpr/kacz.sw.js')

importScripts(swBase + 'elmq/huvc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'edbq/')) {
