...
const swBase = self.location.pathname.replace(/uwcawm\.js$/, '')

importScripts(swBase + 'ect/uotf.bundle.js')
importScripts(swBase + 'ect/uotf.config.js')
importScripts(__uv$config.sw || swBase + 'ect/uotf.sw.js')

importScripts(swBase + 'izkn/gqtr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xwpo/')) {
