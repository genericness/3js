...
const swBase = self.location.pathname.replace(/pxgajl\.js$/, '')

importScripts(swBase + 'gri/heps.bundle.js')
importScripts(swBase + 'gri/heps.config.js')
importScripts(__uv$config.sw || swBase + 'gri/heps.sw.js')

importScripts(swBase + 'mviq/dztt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qcmd/')) {
