const swBase = self.location.pathname.replace(/zlowaa\.js$/, '')

importScripts(swBase + 'iqe/vvai.bundle.js')
importScripts(swBase + 'iqe/vvai.config.js')
importScripts(__uv$config.sw || swBase + 'iqe/vvai.sw.js')

importScripts(swBase + 'tshq/hhdq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bxrf/')) {
