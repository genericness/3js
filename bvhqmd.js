...
const swBase = self.location.pathname.replace(/bvhqmd\.js$/, '')

importScripts(swBase + 'yyn/potd.bundle.js')
importScripts(swBase + 'yyn/potd.config.js')
importScripts(__uv$config.sw || swBase + 'yyn/potd.sw.js')

importScripts(swBase + 'zhgk/njux.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gqmv/')) {
