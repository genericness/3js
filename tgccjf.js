...
const swBase = self.location.pathname.replace(/tgccjf\.js$/, '')

importScripts(swBase + 'ocj/xvhy.bundle.js')
importScripts(swBase + 'ocj/xvhy.config.js')
importScripts(__uv$config.sw || swBase + 'ocj/xvhy.sw.js')

importScripts(swBase + 'xhvo/smcb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nmli/')) {
