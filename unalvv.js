...
const swBase = self.location.pathname.replace(/unalvv\.js$/, '')

importScripts(swBase + 'zaf/ujae.bundle.js')
importScripts(swBase + 'zaf/ujae.config.js')
importScripts(__uv$config.sw || swBase + 'zaf/ujae.sw.js')

importScripts(swBase + 'cqby/peba.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qkwg/')) {
