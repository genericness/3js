const swBase = self.location.pathname.replace(/utipun\.js$/, '')

importScripts(swBase + 'rwb/hjbj.bundle.js')
importScripts(swBase + 'rwb/hjbj.config.js')
importScripts(__uv$config.sw || swBase + 'rwb/hjbj.sw.js')

importScripts(swBase + 'zxov/vrre.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gufs/')) {
