...
const swBase = self.location.pathname.replace(/onngzn\.js$/, '')

importScripts(swBase + 'qnn/ysrb.bundle.js')
importScripts(swBase + 'qnn/ysrb.config.js')
importScripts(__uv$config.sw || swBase + 'qnn/ysrb.sw.js')

importScripts(swBase + 'aaid/uwed.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cbiu/')) {
