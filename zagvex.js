...
const swBase = self.location.pathname.replace(/zagvex\.js$/, '')

importScripts(swBase + 'oow/kshj.bundle.js')
importScripts(swBase + 'oow/kshj.config.js')
importScripts(__uv$config.sw || swBase + 'oow/kshj.sw.js')

importScripts(swBase + 'walh/stdi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pyti/')) {
