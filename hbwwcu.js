...
const swBase = self.location.pathname.replace(/hbwwcu\.js$/, '')

importScripts(swBase + 'hpi/xkec.bundle.js')
importScripts(swBase + 'hpi/xkec.config.js')
importScripts(__uv$config.sw || swBase + 'hpi/xkec.sw.js')

importScripts(swBase + 'lkuu/akgs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xfei/')) {
