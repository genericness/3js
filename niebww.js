...
const swBase = self.location.pathname.replace(/niebww\.js$/, '')

importScripts(swBase + 'oxs/iagk.bundle.js')
importScripts(swBase + 'oxs/iagk.config.js')
importScripts(__uv$config.sw || swBase + 'oxs/iagk.sw.js')

importScripts(swBase + 'dicm/ikdg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uwnl/')) {
