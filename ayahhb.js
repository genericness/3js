...
const swBase = self.location.pathname.replace(/ayahhb\.js$/, '')

importScripts(swBase + 'ysy/agub.bundle.js')
importScripts(swBase + 'ysy/agub.config.js')
importScripts(__uv$config.sw || swBase + 'ysy/agub.sw.js')

importScripts(swBase + 'cqut/cscg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vzqb/')) {
