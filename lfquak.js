...
const swBase = self.location.pathname.replace(/lfquak\.js$/, '')

importScripts(swBase + 'hql/njay.bundle.js')
importScripts(swBase + 'hql/njay.config.js')
importScripts(__uv$config.sw || swBase + 'hql/njay.sw.js')

importScripts(swBase + 'jkjr/pych.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zkcf/')) {
