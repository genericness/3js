...
const swBase = self.location.pathname.replace(/zsgakd\.js$/, '')

importScripts(swBase + 'trb/ltlb.bundle.js')
importScripts(swBase + 'trb/ltlb.config.js')
importScripts(__uv$config.sw || swBase + 'trb/ltlb.sw.js')

importScripts(swBase + 'sgmr/bxwh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xjat/')) {
