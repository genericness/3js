...
const swBase = self.location.pathname.replace(/umfkbl\.js$/, '')

importScripts(swBase + 'yfu/tfpp.bundle.js')
importScripts(swBase + 'yfu/tfpp.config.js')
importScripts(__uv$config.sw || swBase + 'yfu/tfpp.sw.js')

importScripts(swBase + 'rjsu/togt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kwaw/')) {
