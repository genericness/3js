...
const swBase = self.location.pathname.replace(/yfrfbk\.js$/, '')

importScripts(swBase + 'vpd/ming.bundle.js')
importScripts(swBase + 'vpd/ming.config.js')
importScripts(__uv$config.sw || swBase + 'vpd/ming.sw.js')

importScripts(swBase + 'nbzd/fpxr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'urkf/')) {
