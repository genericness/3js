...
const swBase = self.location.pathname.replace(/vnzqyk\.js$/, '')

importScripts(swBase + 'qbj/zjoj.bundle.js')
importScripts(swBase + 'qbj/zjoj.config.js')
importScripts(__uv$config.sw || swBase + 'qbj/zjoj.sw.js')

importScripts(swBase + 'jzfn/tder.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zhws/')) {
