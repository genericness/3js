...
const swBase = self.location.pathname.replace(/xipjdq\.js$/, '')

importScripts(swBase + 'tel/itqa.bundle.js')
importScripts(swBase + 'tel/itqa.config.js')
importScripts(__uv$config.sw || swBase + 'tel/itqa.sw.js')

importScripts(swBase + 'dfsr/bppe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zexw/')) {
