...
const swBase = self.location.pathname.replace(/ndpfax\.js$/, '')

importScripts(swBase + 'kdd/odrk.bundle.js')
importScripts(swBase + 'kdd/odrk.config.js')
importScripts(__uv$config.sw || swBase + 'kdd/odrk.sw.js')

importScripts(swBase + 'dqib/grcc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fusw/')) {
