const swBase = self.location.pathname.replace(/ppykhx\.js$/, '')

importScripts(swBase + 'unp/vnmr.bundle.js')
importScripts(swBase + 'unp/vnmr.config.js')
importScripts(__uv$config.sw || swBase + 'unp/vnmr.sw.js')

importScripts(swBase + 'suza/utzv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ivfg/')) {
