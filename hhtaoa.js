const swBase = self.location.pathname.replace(/hhtaoa\.js$/, '')

importScripts(swBase + 'wvx/tgyf.bundle.js')
importScripts(swBase + 'wvx/tgyf.config.js')
importScripts(__uv$config.sw || swBase + 'wvx/tgyf.sw.js')

importScripts(swBase + 'lvfw/wtlj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vprl/')) {
