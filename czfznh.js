...
const swBase = self.location.pathname.replace(/czfznh\.js$/, '')

importScripts(swBase + 'vze/zvxw.bundle.js')
importScripts(swBase + 'vze/zvxw.config.js')
importScripts(__uv$config.sw || swBase + 'vze/zvxw.sw.js')

importScripts(swBase + 'prpm/mxox.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jien/')) {
