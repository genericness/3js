...
const swBase = self.location.pathname.replace(/pikfxs\.js$/, '')

importScripts(swBase + 'gvb/erke.bundle.js')
importScripts(swBase + 'gvb/erke.config.js')
importScripts(__uv$config.sw || swBase + 'gvb/erke.sw.js')

importScripts(swBase + 'xlzl/itmd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ycel/')) {
