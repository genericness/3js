...
const swBase = self.location.pathname.replace(/ormyvn\.js$/, '')

importScripts(swBase + 'xeq/cbls.bundle.js')
importScripts(swBase + 'xeq/cbls.config.js')
importScripts(__uv$config.sw || swBase + 'xeq/cbls.sw.js')

importScripts(swBase + 'alhl/gqap.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jjut/')) {
