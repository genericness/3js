...
const swBase = self.location.pathname.replace(/hzvyau\.js$/, '')

importScripts(swBase + 'ess/xycs.bundle.js')
importScripts(swBase + 'ess/xycs.config.js')
importScripts(__uv$config.sw || swBase + 'ess/xycs.sw.js')

importScripts(swBase + 'djpw/epex.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ljew/')) {
