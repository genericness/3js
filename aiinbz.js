...
const swBase = self.location.pathname.replace(/aiinbz\.js$/, '')

importScripts(swBase + 'mhp/ymwg.bundle.js')
importScripts(swBase + 'mhp/ymwg.config.js')
importScripts(__uv$config.sw || swBase + 'mhp/ymwg.sw.js')

importScripts(swBase + 'uwtw/iupt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ummq/')) {
