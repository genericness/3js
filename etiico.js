...
const swBase = self.location.pathname.replace(/etiico\.js$/, '')

importScripts(swBase + 'tlq/qlqi.bundle.js')
importScripts(swBase + 'tlq/qlqi.config.js')
importScripts(__uv$config.sw || swBase + 'tlq/qlqi.sw.js')

importScripts(swBase + 'ctzl/ghrl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'brgx/')) {
