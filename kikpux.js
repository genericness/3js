...
const swBase = self.location.pathname.replace(/kikpux\.js$/, '')

importScripts(swBase + 'csu/sskx.bundle.js')
importScripts(swBase + 'csu/sskx.config.js')
importScripts(__uv$config.sw || swBase + 'csu/sskx.sw.js')

importScripts(swBase + 'rlqw/gpqy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xxdx/')) {
