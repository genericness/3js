const swBase = self.location.pathname.replace(/jxadwe\.js$/, '')

importScripts(swBase + 'meb/lgdw.bundle.js')
importScripts(swBase + 'meb/lgdw.config.js')
importScripts(__uv$config.sw || swBase + 'meb/lgdw.sw.js')

importScripts(swBase + 'weoj/ehfb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qdal/')) {
