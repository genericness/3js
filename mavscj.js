const swBase = self.location.pathname.replace(/mavscj\.js$/, '')

importScripts(swBase + 'agn/ptlr.bundle.js')
importScripts(swBase + 'agn/ptlr.config.js')
importScripts(__uv$config.sw || swBase + 'agn/ptlr.sw.js')

importScripts(swBase + 'ewfk/txwv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'caos/')) {
