...
const swBase = self.location.pathname.replace(/dtzqps\.js$/, '')

importScripts(swBase + 'pnz/imss.bundle.js')
importScripts(swBase + 'pnz/imss.config.js')
importScripts(__uv$config.sw || swBase + 'pnz/imss.sw.js')

importScripts(swBase + 'kbhr/lthw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xkaw/')) {
