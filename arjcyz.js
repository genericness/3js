...
const swBase = self.location.pathname.replace(/arjcyz\.js$/, '')

importScripts(swBase + 'qpd/opqq.bundle.js')
importScripts(swBase + 'qpd/opqq.config.js')
importScripts(__uv$config.sw || swBase + 'qpd/opqq.sw.js')

importScripts(swBase + 'mzlx/lbct.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lnze/')) {
