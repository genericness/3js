...
const swBase = self.location.pathname.replace(/gbwdnb\.js$/, '')

importScripts(swBase + 'axs/llxp.bundle.js')
importScripts(swBase + 'axs/llxp.config.js')
importScripts(__uv$config.sw || swBase + 'axs/llxp.sw.js')

importScripts(swBase + 'dhdf/ftms.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rwhu/')) {
