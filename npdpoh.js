...
const swBase = self.location.pathname.replace(/npdpoh\.js$/, '')

importScripts(swBase + 'rdn/iswy.bundle.js')
importScripts(swBase + 'rdn/iswy.config.js')
importScripts(__uv$config.sw || swBase + 'rdn/iswy.sw.js')

importScripts(swBase + 'gzmc/ehxq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ilbm/')) {
