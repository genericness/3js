...
const swBase = self.location.pathname.replace(/ymsgik\.js$/, '')

importScripts(swBase + 'wtr/wlyp.bundle.js')
importScripts(swBase + 'wtr/wlyp.config.js')
importScripts(__uv$config.sw || swBase + 'wtr/wlyp.sw.js')

importScripts(swBase + 'bmzg/whgp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gbgu/')) {
