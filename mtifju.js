...
const swBase = self.location.pathname.replace(/mtifju\.js$/, '')

importScripts(swBase + 'hoe/imtm.bundle.js')
importScripts(swBase + 'hoe/imtm.config.js')
importScripts(__uv$config.sw || swBase + 'hoe/imtm.sw.js')

importScripts(swBase + 'mzkg/bncl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ugwa/')) {
