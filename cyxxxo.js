...
const swBase = self.location.pathname.replace(/cyxxxo\.js$/, '')

importScripts(swBase + 'zhw/robk.bundle.js')
importScripts(swBase + 'zhw/robk.config.js')
importScripts(__uv$config.sw || swBase + 'zhw/robk.sw.js')

importScripts(swBase + 'louq/lfav.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rkta/')) {
