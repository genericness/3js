...
const swBase = self.location.pathname.replace(/ncruxo\.js$/, '')

importScripts(swBase + 'wav/slgv.bundle.js')
importScripts(swBase + 'wav/slgv.config.js')
importScripts(__uv$config.sw || swBase + 'wav/slgv.sw.js')

importScripts(swBase + 'bybd/mjxt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cfpl/')) {
