...
const swBase = self.location.pathname.replace(/chjsiy\.js$/, '')

importScripts(swBase + 'nut/meyo.bundle.js')
importScripts(swBase + 'nut/meyo.config.js')
importScripts(__uv$config.sw || swBase + 'nut/meyo.sw.js')

importScripts(swBase + 'eond/ceje.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pnvp/')) {
