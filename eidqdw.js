...
const swBase = self.location.pathname.replace(/eidqdw\.js$/, '')

importScripts(swBase + 'obn/yepy.bundle.js')
importScripts(swBase + 'obn/yepy.config.js')
importScripts(__uv$config.sw || swBase + 'obn/yepy.sw.js')

importScripts(swBase + 'qvup/phjq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hqcf/')) {
