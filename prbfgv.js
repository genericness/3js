...
const swBase = self.location.pathname.replace(/prbfgv\.js$/, '')

importScripts(swBase + 'jdb/tzkb.bundle.js')
importScripts(swBase + 'jdb/tzkb.config.js')
importScripts(__uv$config.sw || swBase + 'jdb/tzkb.sw.js')

importScripts(swBase + 'wpcz/mpbb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qeoa/')) {
