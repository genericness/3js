const swBase = self.location.pathname.replace(/syeeye\.js$/, '')

importScripts(swBase + 'htu/gmeh.bundle.js')
importScripts(swBase + 'htu/gmeh.config.js')
importScripts(__uv$config.sw || swBase + 'htu/gmeh.sw.js')

importScripts(swBase + 'xbcj/llky.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lgdp/')) {
