...
const swBase = self.location.pathname.replace(/cymlcx\.js$/, '')

importScripts(swBase + 'tdm/sgnu.bundle.js')
importScripts(swBase + 'tdm/sgnu.config.js')
importScripts(__uv$config.sw || swBase + 'tdm/sgnu.sw.js')

importScripts(swBase + 'xnts/biln.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yxtb/')) {
