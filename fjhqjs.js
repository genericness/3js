...
const swBase = self.location.pathname.replace(/fjhqjs\.js$/, '')

importScripts(swBase + 'abu/tsmy.bundle.js')
importScripts(swBase + 'abu/tsmy.config.js')
importScripts(__uv$config.sw || swBase + 'abu/tsmy.sw.js')

importScripts(swBase + 'adxj/rqvl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xprr/')) {
