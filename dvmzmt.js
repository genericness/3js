...
const swBase = self.location.pathname.replace(/dvmzmt\.js$/, '')

importScripts(swBase + 'jmq/tser.bundle.js')
importScripts(swBase + 'jmq/tser.config.js')
importScripts(__uv$config.sw || swBase + 'jmq/tser.sw.js')

importScripts(swBase + 'wlkb/ihnv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vhcb/')) {
