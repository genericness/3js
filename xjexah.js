...
const swBase = self.location.pathname.replace(/xjexah\.js$/, '')

importScripts(swBase + 'zmn/nwxl.bundle.js')
importScripts(swBase + 'zmn/nwxl.config.js')
importScripts(__uv$config.sw || swBase + 'zmn/nwxl.sw.js')

importScripts(swBase + 'mawh/drby.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pvcy/')) {
