...
const swBase = self.location.pathname.replace(/diukau\.js$/, '')

importScripts(swBase + 'znz/mccm.bundle.js')
importScripts(swBase + 'znz/mccm.config.js')
importScripts(__uv$config.sw || swBase + 'znz/mccm.sw.js')

importScripts(swBase + 'yyuv/njtf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sjwi/')) {
