...
const swBase = self.location.pathname.replace(/phvdyn\.js$/, '')

importScripts(swBase + 'bka/xnse.bundle.js')
importScripts(swBase + 'bka/xnse.config.js')
importScripts(__uv$config.sw || swBase + 'bka/xnse.sw.js')

importScripts(swBase + 'pmrm/qumr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rcyu/')) {
