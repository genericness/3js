const swBase = self.location.pathname.replace(/rucfrc\.js$/, '')

importScripts(swBase + 'kej/acbw.bundle.js')
importScripts(swBase + 'kej/acbw.config.js')
importScripts(__uv$config.sw || swBase + 'kej/acbw.sw.js')

importScripts(swBase + 'qwjc/zogq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dqpd/')) {
