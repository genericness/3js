...
const swBase = self.location.pathname.replace(/fdufgx\.js$/, '')

importScripts(swBase + 'wqu/lgux.bundle.js')
importScripts(swBase + 'wqu/lgux.config.js')
importScripts(__uv$config.sw || swBase + 'wqu/lgux.sw.js')

importScripts(swBase + 'rtxa/xnqk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gjdi/')) {
