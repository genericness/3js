...
const swBase = self.location.pathname.replace(/alckar\.js$/, '')

importScripts(swBase + 'rho/fhdl.bundle.js')
importScripts(swBase + 'rho/fhdl.config.js')
importScripts(__uv$config.sw || swBase + 'rho/fhdl.sw.js')

importScripts(swBase + 'fmjf/wwro.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zuiv/')) {
