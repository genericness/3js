...
const swBase = self.location.pathname.replace(/zcgkmq\.js$/, '')

importScripts(swBase + 'zil/jugc.bundle.js')
importScripts(swBase + 'zil/jugc.config.js')
importScripts(__uv$config.sw || swBase + 'zil/jugc.sw.js')

importScripts(swBase + 'mmrm/dxwz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bqyp/')) {
