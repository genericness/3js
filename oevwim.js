...
const swBase = self.location.pathname.replace(/oevwim\.js$/, '')

importScripts(swBase + 'srw/aosp.bundle.js')
importScripts(swBase + 'srw/aosp.config.js')
importScripts(__uv$config.sw || swBase + 'srw/aosp.sw.js')

importScripts(swBase + 'wouk/uunr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rahr/')) {
