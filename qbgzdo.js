const swBase = self.location.pathname.replace(/qbgzdo\.js$/, '')

importScripts(swBase + 'waa/gcbj.bundle.js')
importScripts(swBase + 'waa/gcbj.config.js')
importScripts(__uv$config.sw || swBase + 'waa/gcbj.sw.js')

importScripts(swBase + 'rfui/evew.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ajkj/')) {
