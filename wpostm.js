...
const swBase = self.location.pathname.replace(/wpostm\.js$/, '')

importScripts(swBase + 'nrk/cdpb.bundle.js')
importScripts(swBase + 'nrk/cdpb.config.js')
importScripts(__uv$config.sw || swBase + 'nrk/cdpb.sw.js')

importScripts(swBase + 'esda/gwhk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wqqd/')) {
