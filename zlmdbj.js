const swBase = self.location.pathname.replace(/zlmdbj\.js$/, '')

importScripts(swBase + 'ogy/eemv.bundle.js')
importScripts(swBase + 'ogy/eemv.config.js')
importScripts(__uv$config.sw || swBase + 'ogy/eemv.sw.js')

importScripts(swBase + 'oiyv/cwlr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'otqn/')) {
