...
const swBase = self.location.pathname.replace(/licuvm\.js$/, '')

importScripts(swBase + 'jvf/ziyx.bundle.js')
importScripts(swBase + 'jvf/ziyx.config.js')
importScripts(__uv$config.sw || swBase + 'jvf/ziyx.sw.js')

importScripts(swBase + 'gljp/rtdy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wamx/')) {
