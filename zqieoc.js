const swBase = self.location.pathname.replace(/zqieoc\.js$/, '')

importScripts(swBase + 'qfz/ctbo.bundle.js')
importScripts(swBase + 'qfz/ctbo.config.js')
importScripts(__uv$config.sw || swBase + 'qfz/ctbo.sw.js')

importScripts(swBase + 'ejmx/duos.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dgiz/')) {
