...
const swBase = self.location.pathname.replace(/spxdpu\.js$/, '')

importScripts(swBase + 'msy/mksw.bundle.js')
importScripts(swBase + 'msy/mksw.config.js')
importScripts(__uv$config.sw || swBase + 'msy/mksw.sw.js')

importScripts(swBase + 'zykq/upie.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'myvc/')) {
