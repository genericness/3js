...
const swBase = self.location.pathname.replace(/vbfjwl\.js$/, '')

importScripts(swBase + 'lth/bvvx.bundle.js')
importScripts(swBase + 'lth/bvvx.config.js')
importScripts(__uv$config.sw || swBase + 'lth/bvvx.sw.js')

importScripts(swBase + 'uwzk/doab.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fmwu/')) {
