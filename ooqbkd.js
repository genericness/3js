...
const swBase = self.location.pathname.replace(/ooqbkd\.js$/, '')

importScripts(swBase + 'bvz/lwox.bundle.js')
importScripts(swBase + 'bvz/lwox.config.js')
importScripts(__uv$config.sw || swBase + 'bvz/lwox.sw.js')

importScripts(swBase + 'ytno/dsiv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'appp/')) {
