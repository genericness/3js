...
const swBase = self.location.pathname.replace(/asazio\.js$/, '')

importScripts(swBase + 'xaw/ofky.bundle.js')
importScripts(swBase + 'xaw/ofky.config.js')
importScripts(__uv$config.sw || swBase + 'xaw/ofky.sw.js')

importScripts(swBase + 'oqrr/pkay.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'paex/')) {
