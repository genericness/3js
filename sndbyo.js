...
const swBase = self.location.pathname.replace(/sndbyo\.js$/, '')

importScripts(swBase + 'wyu/wmft.bundle.js')
importScripts(swBase + 'wyu/wmft.config.js')
importScripts(__uv$config.sw || swBase + 'wyu/wmft.sw.js')

importScripts(swBase + 'ezxj/ipif.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'myiq/')) {
