...
const swBase = self.location.pathname.replace(/hracha\.js$/, '')

importScripts(swBase + 'uwn/ykhg.bundle.js')
importScripts(swBase + 'uwn/ykhg.config.js')
importScripts(__uv$config.sw || swBase + 'uwn/ykhg.sw.js')

importScripts(swBase + 'qdqf/dedp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rrmp/')) {
