...
const swBase = self.location.pathname.replace(/udqzoi\.js$/, '')

importScripts(swBase + 'jcf/mmfs.bundle.js')
importScripts(swBase + 'jcf/mmfs.config.js')
importScripts(__uv$config.sw || swBase + 'jcf/mmfs.sw.js')

importScripts(swBase + 'wzyp/jssf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wgsf/')) {
