...
const swBase = self.location.pathname.replace(/gukyad\.js$/, '')

importScripts(swBase + 'hci/ssbx.bundle.js')
importScripts(swBase + 'hci/ssbx.config.js')
importScripts(__uv$config.sw || swBase + 'hci/ssbx.sw.js')

importScripts(swBase + 'lgvw/jlbo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rmgq/')) {
