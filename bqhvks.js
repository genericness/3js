...
const swBase = self.location.pathname.replace(/bqhvks\.js$/, '')

importScripts(swBase + 'yzo/hsjb.bundle.js')
importScripts(swBase + 'yzo/hsjb.config.js')
importScripts(__uv$config.sw || swBase + 'yzo/hsjb.sw.js')

importScripts(swBase + 'bury/jifd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ojvz/')) {
