...
const swBase = self.location.pathname.replace(/kefhdl\.js$/, '')

importScripts(swBase + 'ede/kbyq.bundle.js')
importScripts(swBase + 'ede/kbyq.config.js')
importScripts(__uv$config.sw || swBase + 'ede/kbyq.sw.js')

importScripts(swBase + 'fpzf/mwiy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tisl/')) {
