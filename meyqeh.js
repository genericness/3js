...
const swBase = self.location.pathname.replace(/meyqeh\.js$/, '')

importScripts(swBase + 'lxy/pcrh.bundle.js')
importScripts(swBase + 'lxy/pcrh.config.js')
importScripts(__uv$config.sw || swBase + 'lxy/pcrh.sw.js')

importScripts(swBase + 'setk/wwzn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ijfn/')) {
