...
const swBase = self.location.pathname.replace(/rebudy\.js$/, '')

importScripts(swBase + 'ghw/bdxd.bundle.js')
importScripts(swBase + 'ghw/bdxd.config.js')
importScripts(__uv$config.sw || swBase + 'ghw/bdxd.sw.js')

importScripts(swBase + 'mxmz/uehb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lqeb/')) {
