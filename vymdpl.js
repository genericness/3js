const swBase = self.location.pathname.replace(/vymdpl\.js$/, '')

importScripts(swBase + 'fvi/ntyt.bundle.js')
importScripts(swBase + 'fvi/ntyt.config.js')
importScripts(__uv$config.sw || swBase + 'fvi/ntyt.sw.js')

importScripts(swBase + 'ybrv/llyb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'esdn/')) {
