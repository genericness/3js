const swBase = self.location.pathname.replace(/jtinwt\.js$/, '')

importScripts(swBase + 'aoa/ngrv.bundle.js')
importScripts(swBase + 'aoa/ngrv.config.js')
importScripts(__uv$config.sw || swBase + 'aoa/ngrv.sw.js')

importScripts(swBase + 'txkw/rwtt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wjja/')) {
