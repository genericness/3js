...
const swBase = self.location.pathname.replace(/tesvcp\.js$/, '')

importScripts(swBase + 'pnw/lbdi.bundle.js')
importScripts(swBase + 'pnw/lbdi.config.js')
importScripts(__uv$config.sw || swBase + 'pnw/lbdi.sw.js')

importScripts(swBase + 'yyub/kiqy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'emwm/')) {
