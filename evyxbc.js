...
const swBase = self.location.pathname.replace(/evyxbc\.js$/, '')

importScripts(swBase + 'thw/qzto.bundle.js')
importScripts(swBase + 'thw/qzto.config.js')
importScripts(__uv$config.sw || swBase + 'thw/qzto.sw.js')

importScripts(swBase + 'weep/vikm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'drqj/')) {
