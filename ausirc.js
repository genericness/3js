...
const swBase = self.location.pathname.replace(/ausirc\.js$/, '')

importScripts(swBase + 'qem/ueem.bundle.js')
importScripts(swBase + 'qem/ueem.config.js')
importScripts(__uv$config.sw || swBase + 'qem/ueem.sw.js')

importScripts(swBase + 'iwpv/gjeg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'skpd/')) {
