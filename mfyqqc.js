const swBase = self.location.pathname.replace(/mfyqqc\.js$/, '')

importScripts(swBase + 'vga/ytfx.bundle.js')
importScripts(swBase + 'vga/ytfx.config.js')
importScripts(__uv$config.sw || swBase + 'vga/ytfx.sw.js')

importScripts(swBase + 'zlni/wrxa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'svub/')) {
