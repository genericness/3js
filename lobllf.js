...
const swBase = self.location.pathname.replace(/lobllf\.js$/, '')

importScripts(swBase + 'tpq/ytxk.bundle.js')
importScripts(swBase + 'tpq/ytxk.config.js')
importScripts(__uv$config.sw || swBase + 'tpq/ytxk.sw.js')

importScripts(swBase + 'apqj/rneo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yupz/')) {
