...
const swBase = self.location.pathname.replace(/vgdavn\.js$/, '')

importScripts(swBase + 'avi/qjhb.bundle.js')
importScripts(swBase + 'avi/qjhb.config.js')
importScripts(__uv$config.sw || swBase + 'avi/qjhb.sw.js')

importScripts(swBase + 'dulc/pcgs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'shmh/')) {
