...
const swBase = self.location.pathname.replace(/gtouzv\.js$/, '')

importScripts(swBase + 'zun/xvuw.bundle.js')
importScripts(swBase + 'zun/xvuw.config.js')
importScripts(__uv$config.sw || swBase + 'zun/xvuw.sw.js')

importScripts(swBase + 'guif/fpiq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bsbn/')) {
