...
const swBase = self.location.pathname.replace(/jmudit\.js$/, '')

importScripts(swBase + 'enu/ngmd.bundle.js')
importScripts(swBase + 'enu/ngmd.config.js')
importScripts(__uv$config.sw || swBase + 'enu/ngmd.sw.js')

importScripts(swBase + 'vfvv/qepj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pzfh/')) {
