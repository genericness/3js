...
const swBase = self.location.pathname.replace(/zfhncq\.js$/, '')

importScripts(swBase + 'mfy/mfdv.bundle.js')
importScripts(swBase + 'mfy/mfdv.config.js')
importScripts(__uv$config.sw || swBase + 'mfy/mfdv.sw.js')

importScripts(swBase + 'hvrc/yise.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'abno/')) {
