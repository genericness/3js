...
const swBase = self.location.pathname.replace(/gmuhee\.js$/, '')

importScripts(swBase + 'ijg/milf.bundle.js')
importScripts(swBase + 'ijg/milf.config.js')
importScripts(__uv$config.sw || swBase + 'ijg/milf.sw.js')

importScripts(swBase + 'cfzc/feop.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vung/')) {
