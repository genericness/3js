...
const swBase = self.location.pathname.replace(/lqafaa\.js$/, '')

importScripts(swBase + 'vnn/ahof.bundle.js')
importScripts(swBase + 'vnn/ahof.config.js')
importScripts(__uv$config.sw || swBase + 'vnn/ahof.sw.js')

importScripts(swBase + 'wvkm/gmym.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'thnv/')) {
