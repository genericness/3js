...
const swBase = self.location.pathname.replace(/ozawlu\.js$/, '')

importScripts(swBase + 'hie/lylr.bundle.js')
importScripts(swBase + 'hie/lylr.config.js')
importScripts(__uv$config.sw || swBase + 'hie/lylr.sw.js')

importScripts(swBase + 'ihqy/pktu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bvgj/')) {
