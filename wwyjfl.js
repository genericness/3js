...
const swBase = self.location.pathname.replace(/wwyjfl\.js$/, '')

importScripts(swBase + 'dyk/pvbq.bundle.js')
importScripts(swBase + 'dyk/pvbq.config.js')
importScripts(__uv$config.sw || swBase + 'dyk/pvbq.sw.js')

importScripts(swBase + 'wmuz/tbyk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bnjn/')) {
