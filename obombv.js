const swBase = self.location.pathname.replace(/obombv\.js$/, '')

importScripts(swBase + 'oji/pfie.bundle.js')
importScripts(swBase + 'oji/pfie.config.js')
importScripts(__uv$config.sw || swBase + 'oji/pfie.sw.js')

importScripts(swBase + 'dide/xkmd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tnfl/')) {
