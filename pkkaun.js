const swBase = self.location.pathname.replace(/pkkaun\.js$/, '')

importScripts(swBase + 'gdq/wnle.bundle.js')
importScripts(swBase + 'gdq/wnle.config.js')
importScripts(__uv$config.sw || swBase + 'gdq/wnle.sw.js')

importScripts(swBase + 'feps/anwd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kmpt/')) {
