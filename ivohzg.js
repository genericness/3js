...
const swBase = self.location.pathname.replace(/ivohzg\.js$/, '')

importScripts(swBase + 'qip/xbbv.bundle.js')
importScripts(swBase + 'qip/xbbv.config.js')
importScripts(__uv$config.sw || swBase + 'qip/xbbv.sw.js')

importScripts(swBase + 'pctk/dequ.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'majb/')) {
