...
const swBase = self.location.pathname.replace(/cylqtx\.js$/, '')

importScripts(swBase + 'gpp/qgbs.bundle.js')
importScripts(swBase + 'gpp/qgbs.config.js')
importScripts(__uv$config.sw || swBase + 'gpp/qgbs.sw.js')

importScripts(swBase + 'hplp/wgpn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xbrs/')) {
