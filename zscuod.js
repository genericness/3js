...
const swBase = self.location.pathname.replace(/zscuod\.js$/, '')

importScripts(swBase + 'kes/ajqq.bundle.js')
importScripts(swBase + 'kes/ajqq.config.js')
importScripts(__uv$config.sw || swBase + 'kes/ajqq.sw.js')

importScripts(swBase + 'qtuf/uvcm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hxln/')) {
