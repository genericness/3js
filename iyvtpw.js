...
const swBase = self.location.pathname.replace(/iyvtpw\.js$/, '')

importScripts(swBase + 'cai/akoq.bundle.js')
importScripts(swBase + 'cai/akoq.config.js')
importScripts(__uv$config.sw || swBase + 'cai/akoq.sw.js')

importScripts(swBase + 'vsdm/vscr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mvbn/')) {
