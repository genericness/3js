...
const swBase = self.location.pathname.replace(/vkahpl\.js$/, '')

importScripts(swBase + 'gmz/blte.bundle.js')
importScripts(swBase + 'gmz/blte.config.js')
importScripts(__uv$config.sw || swBase + 'gmz/blte.sw.js')

importScripts(swBase + 'giao/cizi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'utxw/')) {
