...
const swBase = self.location.pathname.replace(/yvjzcu\.js$/, '')

importScripts(swBase + 'hfw/heoa.bundle.js')
importScripts(swBase + 'hfw/heoa.config.js')
importScripts(__uv$config.sw || swBase + 'hfw/heoa.sw.js')

importScripts(swBase + 'ygqi/rnbp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hxou/')) {
