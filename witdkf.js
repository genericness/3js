...
const swBase = self.location.pathname.replace(/witdkf\.js$/, '')

importScripts(swBase + 'dqj/eklj.bundle.js')
importScripts(swBase + 'dqj/eklj.config.js')
importScripts(__uv$config.sw || swBase + 'dqj/eklj.sw.js')

importScripts(swBase + 'gdej/dxye.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fynl/')) {
