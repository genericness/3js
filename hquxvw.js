...
const swBase = self.location.pathname.replace(/hquxvw\.js$/, '')

importScripts(swBase + 'vjx/roqw.bundle.js')
importScripts(swBase + 'vjx/roqw.config.js')
importScripts(__uv$config.sw || swBase + 'vjx/roqw.sw.js')

importScripts(swBase + 'vwby/uspl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'otgr/')) {
