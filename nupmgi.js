const swBase = self.location.pathname.replace(/nupmgi\.js$/, '')

importScripts(swBase + 'hjn/wxcp.bundle.js')
importScripts(swBase + 'hjn/wxcp.config.js')
importScripts(__uv$config.sw || swBase + 'hjn/wxcp.sw.js')

importScripts(swBase + 'dafn/srds.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bope/')) {
