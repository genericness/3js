...
const swBase = self.location.pathname.replace(/mbxszl\.js$/, '')

importScripts(swBase + 'ndq/flzm.bundle.js')
importScripts(swBase + 'ndq/flzm.config.js')
importScripts(__uv$config.sw || swBase + 'ndq/flzm.sw.js')

importScripts(swBase + 'suua/vfoc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rjfc/')) {
