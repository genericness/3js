...
const swBase = self.location.pathname.replace(/xxmypa\.js$/, '')

importScripts(swBase + 'crd/mpnh.bundle.js')
importScripts(swBase + 'crd/mpnh.config.js')
importScripts(__uv$config.sw || swBase + 'crd/mpnh.sw.js')

importScripts(swBase + 'ztna/cnud.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hrlz/')) {
