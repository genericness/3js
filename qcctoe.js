const swBase = self.location.pathname.replace(/qcctoe\.js$/, '')

importScripts(swBase + 'srv/kdzx.bundle.js')
importScripts(swBase + 'srv/kdzx.config.js')
importScripts(__uv$config.sw || swBase + 'srv/kdzx.sw.js')

importScripts(swBase + 'ifmg/qiaa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fwku/')) {
