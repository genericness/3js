...
const swBase = self.location.pathname.replace(/chlrmd\.js$/, '')

importScripts(swBase + 'efy/cguw.bundle.js')
importScripts(swBase + 'efy/cguw.config.js')
importScripts(__uv$config.sw || swBase + 'efy/cguw.sw.js')

importScripts(swBase + 'uamh/oosk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qzba/')) {
