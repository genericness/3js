...
const swBase = self.location.pathname.replace(/jmryzv\.js$/, '')

importScripts(swBase + 'jnf/mgzt.bundle.js')
importScripts(swBase + 'jnf/mgzt.config.js')
importScripts(__uv$config.sw || swBase + 'jnf/mgzt.sw.js')

importScripts(swBase + 'pkyn/veny.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'blxj/')) {
