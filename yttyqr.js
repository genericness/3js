const swBase = self.location.pathname.replace(/yttyqr\.js$/, '')

importScripts(swBase + 'iau/eafb.bundle.js')
importScripts(swBase + 'iau/eafb.config.js')
importScripts(__uv$config.sw || swBase + 'iau/eafb.sw.js')

importScripts(swBase + 'ampn/tumm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cpjt/')) {
