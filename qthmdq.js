const swBase = self.location.pathname.replace(/qthmdq\.js$/, '')

importScripts(swBase + 'dbn/bwmb.bundle.js')
importScripts(swBase + 'dbn/bwmb.config.js')
importScripts(__uv$config.sw || swBase + 'dbn/bwmb.sw.js')

importScripts(swBase + 'otsp/oubp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'afbg/')) {
