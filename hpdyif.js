...
const swBase = self.location.pathname.replace(/hpdyif\.js$/, '')

importScripts(swBase + 'quq/nxtj.bundle.js')
importScripts(swBase + 'quq/nxtj.config.js')
importScripts(__uv$config.sw || swBase + 'quq/nxtj.sw.js')

importScripts(swBase + 'ynnx/tapl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'brmk/')) {
