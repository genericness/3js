...
const swBase = self.location.pathname.replace(/vxytnp\.js$/, '')

importScripts(swBase + 'hiw/yihb.bundle.js')
importScripts(swBase + 'hiw/yihb.config.js')
importScripts(__uv$config.sw || swBase + 'hiw/yihb.sw.js')

importScripts(swBase + 'jkds/rlqo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lvth/')) {
