...
const swBase = self.location.pathname.replace(/jrqtml\.js$/, '')

importScripts(swBase + 'zco/amtn.bundle.js')
importScripts(swBase + 'zco/amtn.config.js')
importScripts(__uv$config.sw || swBase + 'zco/amtn.sw.js')

importScripts(swBase + 'afrk/wudf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'arnu/')) {
