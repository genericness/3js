...
const swBase = self.location.pathname.replace(/xhffjw\.js$/, '')

importScripts(swBase + 'byr/bvsk.bundle.js')
importScripts(swBase + 'byr/bvsk.config.js')
importScripts(__uv$config.sw || swBase + 'byr/bvsk.sw.js')

importScripts(swBase + 'gjso/fmmv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pktt/')) {
