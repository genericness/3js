...
const swBase = self.location.pathname.replace(/wnkvov\.js$/, '')

importScripts(swBase + 'ztt/fdaj.bundle.js')
importScripts(swBase + 'ztt/fdaj.config.js')
importScripts(__uv$config.sw || swBase + 'ztt/fdaj.sw.js')

importScripts(swBase + 'ztox/imjf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vhcx/')) {
