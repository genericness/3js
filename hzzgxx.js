const swBase = self.location.pathname.replace(/hzzgxx\.js$/, '')

importScripts(swBase + 'gco/yyir.bundle.js')
importScripts(swBase + 'gco/yyir.config.js')
importScripts(__uv$config.sw || swBase + 'gco/yyir.sw.js')

importScripts(swBase + 'nzml/tjpy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jfof/')) {
