...
const swBase = self.location.pathname.replace(/fokzek\.js$/, '')

importScripts(swBase + 'ugb/zyhu.bundle.js')
importScripts(swBase + 'ugb/zyhu.config.js')
importScripts(__uv$config.sw || swBase + 'ugb/zyhu.sw.js')

importScripts(swBase + 'qkmw/uyun.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'okhz/')) {
