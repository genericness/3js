...
const swBase = self.location.pathname.replace(/pijrsu\.js$/, '')

importScripts(swBase + 'tvf/awpk.bundle.js')
importScripts(swBase + 'tvf/awpk.config.js')
importScripts(__uv$config.sw || swBase + 'tvf/awpk.sw.js')

importScripts(swBase + 'ahbt/ylef.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xlho/')) {
