...
const swBase = self.location.pathname.replace(/fgmvdb\.js$/, '')

importScripts(swBase + 'dag/kwzk.bundle.js')
importScripts(swBase + 'dag/kwzk.config.js')
importScripts(__uv$config.sw || swBase + 'dag/kwzk.sw.js')

importScripts(swBase + 'lwov/vudn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mpap/')) {
