...
const swBase = self.location.pathname.replace(/pgergp\.js$/, '')

importScripts(swBase + 'uwd/jhdf.bundle.js')
importScripts(swBase + 'uwd/jhdf.config.js')
importScripts(__uv$config.sw || swBase + 'uwd/jhdf.sw.js')

importScripts(swBase + 'mixq/xbbv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'crcf/')) {
