...
const swBase = self.location.pathname.replace(/bxkose\.js$/, '')

importScripts(swBase + 'dqf/ufyk.bundle.js')
importScripts(swBase + 'dqf/ufyk.config.js')
importScripts(__uv$config.sw || swBase + 'dqf/ufyk.sw.js')

importScripts(swBase + 'fnaq/xpic.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ugbu/')) {
