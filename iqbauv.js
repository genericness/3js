...
const swBase = self.location.pathname.replace(/iqbauv\.js$/, '')

importScripts(swBase + 'yhm/cdas.bundle.js')
importScripts(swBase + 'yhm/cdas.config.js')
importScripts(__uv$config.sw || swBase + 'yhm/cdas.sw.js')

importScripts(swBase + 'xgki/srwy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nyto/')) {
