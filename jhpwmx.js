...
const swBase = self.location.pathname.replace(/jhpwmx\.js$/, '')

importScripts(swBase + 'vzv/yezb.bundle.js')
importScripts(swBase + 'vzv/yezb.config.js')
importScripts(__uv$config.sw || swBase + 'vzv/yezb.sw.js')

importScripts(swBase + 'epfz/dwpm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nubt/')) {
