...
const swBase = self.location.pathname.replace(/okbcqs\.js$/, '')

importScripts(swBase + 'qct/tkrf.bundle.js')
importScripts(swBase + 'qct/tkrf.config.js')
importScripts(__uv$config.sw || swBase + 'qct/tkrf.sw.js')

importScripts(swBase + 'incs/bfzb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vxya/')) {
