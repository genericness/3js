const swBase = self.location.pathname.replace(/ezfner\.js$/, '')

importScripts(swBase + 'ugl/axki.bundle.js')
importScripts(swBase + 'ugl/axki.config.js')
importScripts(__uv$config.sw || swBase + 'ugl/axki.sw.js')

importScripts(swBase + 'oqdp/ggud.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'szjr/')) {
