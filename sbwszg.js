...
const swBase = self.location.pathname.replace(/sbwszg\.js$/, '')

importScripts(swBase + 'tvf/vviu.bundle.js')
importScripts(swBase + 'tvf/vviu.config.js')
importScripts(__uv$config.sw || swBase + 'tvf/vviu.sw.js')

importScripts(swBase + 'ujgx/mvtf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'urkr/')) {
