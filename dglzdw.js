...
const swBase = self.location.pathname.replace(/dglzdw\.js$/, '')

importScripts(swBase + 'pjl/ehkx.bundle.js')
importScripts(swBase + 'pjl/ehkx.config.js')
importScripts(__uv$config.sw || swBase + 'pjl/ehkx.sw.js')

importScripts(swBase + 'oscg/iljh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'osbm/')) {
