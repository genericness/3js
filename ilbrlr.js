...
const swBase = self.location.pathname.replace(/ilbrlr\.js$/, '')

importScripts(swBase + 'kgb/cxqg.bundle.js')
importScripts(swBase + 'kgb/cxqg.config.js')
importScripts(__uv$config.sw || swBase + 'kgb/cxqg.sw.js')

importScripts(swBase + 'htkc/xlss.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wecs/')) {
