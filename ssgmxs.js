const swBase = self.location.pathname.replace(/ssgmxs\.js$/, '')

importScripts(swBase + 'jfr/ufzq.bundle.js')
importScripts(swBase + 'jfr/ufzq.config.js')
importScripts(__uv$config.sw || swBase + 'jfr/ufzq.sw.js')

importScripts(swBase + 'mmqa/hnjg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tcit/')) {
