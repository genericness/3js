const swBase = self.location.pathname.replace(/rxmsoj\.js$/, '')

importScripts(swBase + 'jbz/coal.bundle.js')
importScripts(swBase + 'jbz/coal.config.js')
importScripts(__uv$config.sw || swBase + 'jbz/coal.sw.js')

importScripts(swBase + 'zodv/tvim.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'twfa/')) {
