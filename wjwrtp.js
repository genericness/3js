...
const swBase = self.location.pathname.replace(/wjwrtp\.js$/, '')

importScripts(swBase + 'eet/rfjb.bundle.js')
importScripts(swBase + 'eet/rfjb.config.js')
importScripts(__uv$config.sw || swBase + 'eet/rfjb.sw.js')

importScripts(swBase + 'wuxr/lbwn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vvqn/')) {
