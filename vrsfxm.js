...
const swBase = self.location.pathname.replace(/vrsfxm\.js$/, '')

importScripts(swBase + 'glf/gzge.bundle.js')
importScripts(swBase + 'glf/gzge.config.js')
importScripts(__uv$config.sw || swBase + 'glf/gzge.sw.js')

importScripts(swBase + 'zdng/oqxt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bxhp/')) {
