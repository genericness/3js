...
const swBase = self.location.pathname.replace(/jppqli\.js$/, '')

importScripts(swBase + 'qbg/vpim.bundle.js')
importScripts(swBase + 'qbg/vpim.config.js')
importScripts(__uv$config.sw || swBase + 'qbg/vpim.sw.js')

importScripts(swBase + 'basr/xdnr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ybah/')) {
