...
const swBase = self.location.pathname.replace(/ozdbro\.js$/, '')

importScripts(swBase + 'trs/pfhv.bundle.js')
importScripts(swBase + 'trs/pfhv.config.js')
importScripts(__uv$config.sw || swBase + 'trs/pfhv.sw.js')

importScripts(swBase + 'dssw/iggv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'irkf/')) {
