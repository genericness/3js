...
const swBase = self.location.pathname.replace(/wcqmki\.js$/, '')

importScripts(swBase + 'kzb/njvf.bundle.js')
importScripts(swBase + 'kzb/njvf.config.js')
importScripts(__uv$config.sw || swBase + 'kzb/njvf.sw.js')

importScripts(swBase + 'neil/gfoi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tkcd/')) {
