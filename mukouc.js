...
const swBase = self.location.pathname.replace(/mukouc\.js$/, '')

importScripts(swBase + 'egq/igbr.bundle.js')
importScripts(swBase + 'egq/igbr.config.js')
importScripts(__uv$config.sw || swBase + 'egq/igbr.sw.js')

importScripts(swBase + 'whxe/fdkw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ixoh/')) {
