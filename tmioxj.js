...
const swBase = self.location.pathname.replace(/tmioxj\.js$/, '')

importScripts(swBase + 'xed/nysq.bundle.js')
importScripts(swBase + 'xed/nysq.config.js')
importScripts(__uv$config.sw || swBase + 'xed/nysq.sw.js')

importScripts(swBase + 'ssvk/foiv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'igbg/')) {
