...
const swBase = self.location.pathname.replace(/bqoprm\.js$/, '')

importScripts(swBase + 'vmm/svzp.bundle.js')
importScripts(swBase + 'vmm/svzp.config.js')
importScripts(__uv$config.sw || swBase + 'vmm/svzp.sw.js')

importScripts(swBase + 'ihao/qhoo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'phyo/')) {
