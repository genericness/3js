...
const swBase = self.location.pathname.replace(/wscgck\.js$/, '')

importScripts(swBase + 'hux/tcrr.bundle.js')
importScripts(swBase + 'hux/tcrr.config.js')
importScripts(__uv$config.sw || swBase + 'hux/tcrr.sw.js')

importScripts(swBase + 'wjgh/bves.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wmro/')) {
