...
const swBase = self.location.pathname.replace(/wbtezv\.js$/, '')

importScripts(swBase + 'lgk/dpjw.bundle.js')
importScripts(swBase + 'lgk/dpjw.config.js')
importScripts(__uv$config.sw || swBase + 'lgk/dpjw.sw.js')

importScripts(swBase + 'iawt/mpxy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'slns/')) {
