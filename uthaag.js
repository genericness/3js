...
const swBase = self.location.pathname.replace(/uthaag\.js$/, '')

importScripts(swBase + 'bfa/buhm.bundle.js')
importScripts(swBase + 'bfa/buhm.config.js')
importScripts(__uv$config.sw || swBase + 'bfa/buhm.sw.js')

importScripts(swBase + 'stew/uwes.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vkli/')) {
