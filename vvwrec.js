...
const swBase = self.location.pathname.replace(/vvwrec\.js$/, '')

importScripts(swBase + 'paw/ivjw.bundle.js')
importScripts(swBase + 'paw/ivjw.config.js')
importScripts(__uv$config.sw || swBase + 'paw/ivjw.sw.js')

importScripts(swBase + 'tiyv/qegs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mfga/')) {
