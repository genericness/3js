...
const swBase = self.location.pathname.replace(/xchtuw\.js$/, '')

importScripts(swBase + 'lxr/unck.bundle.js')
importScripts(swBase + 'lxr/unck.config.js')
importScripts(__uv$config.sw || swBase + 'lxr/unck.sw.js')

importScripts(swBase + 'deei/uski.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nzbs/')) {
