...
const swBase = self.location.pathname.replace(/wshjed\.js$/, '')

importScripts(swBase + 'kqr/wiaw.bundle.js')
importScripts(swBase + 'kqr/wiaw.config.js')
importScripts(__uv$config.sw || swBase + 'kqr/wiaw.sw.js')

importScripts(swBase + 'kcwm/uisv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gwgr/')) {
