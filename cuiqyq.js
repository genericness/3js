...
const swBase = self.location.pathname.replace(/cuiqyq\.js$/, '')

importScripts(swBase + 'rrj/nwgx.bundle.js')
importScripts(swBase + 'rrj/nwgx.config.js')
importScripts(__uv$config.sw || swBase + 'rrj/nwgx.sw.js')

importScripts(swBase + 'fout/fxxg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'biza/')) {
