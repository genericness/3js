...
const swBase = self.location.pathname.replace(/okjekt\.js$/, '')

importScripts(swBase + 'mod/ygut.bundle.js')
importScripts(swBase + 'mod/ygut.config.js')
importScripts(__uv$config.sw || swBase + 'mod/ygut.sw.js')

importScripts(swBase + 'uyks/lyvi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nppc/')) {
