...
const swBase = self.location.pathname.replace(/utzugv\.js$/, '')

importScripts(swBase + 'fsh/uotz.bundle.js')
importScripts(swBase + 'fsh/uotz.config.js')
importScripts(__uv$config.sw || swBase + 'fsh/uotz.sw.js')

importScripts(swBase + 'yesj/axjx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yghy/')) {
