...
const swBase = self.location.pathname.replace(/qrnkyr\.js$/, '')

importScripts(swBase + 'yzb/fppy.bundle.js')
importScripts(swBase + 'yzb/fppy.config.js')
importScripts(__uv$config.sw || swBase + 'yzb/fppy.sw.js')

importScripts(swBase + 'nnnq/famm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iflm/')) {
