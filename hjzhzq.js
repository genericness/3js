...
const swBase = self.location.pathname.replace(/hjzhzq\.js$/, '')

importScripts(swBase + 'tld/djps.bundle.js')
importScripts(swBase + 'tld/djps.config.js')
importScripts(__uv$config.sw || swBase + 'tld/djps.sw.js')

importScripts(swBase + 'ipeb/scramjet.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eutu/')) {
