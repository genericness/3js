...
const swBase = self.location.pathname.replace(/zfziit\.js$/, '')

importScripts(swBase + 'cxc/povs.bundle.js')
importScripts(swBase + 'cxc/povs.config.js')
importScripts(__uv$config.sw || swBase + 'cxc/povs.sw.js')

importScripts(swBase + 'nfzm/qgcd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'epwj/')) {
