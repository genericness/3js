...
const swBase = self.location.pathname.replace(/qyioyi\.js$/, '')

importScripts(swBase + 'ggs/dvsz.bundle.js')
importScripts(swBase + 'ggs/dvsz.config.js')
importScripts(__uv$config.sw || swBase + 'ggs/dvsz.sw.js')

importScripts(swBase + 'fdyy/thfv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ezzy/')) {
