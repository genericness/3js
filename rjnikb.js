...
const swBase = self.location.pathname.replace(/rjnikb\.js$/, '')

importScripts(swBase + 'bhx/rtun.bundle.js')
importScripts(swBase + 'bhx/rtun.config.js')
importScripts(__uv$config.sw || swBase + 'bhx/rtun.sw.js')

importScripts(swBase + 'rsac/wytu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yqci/')) {
