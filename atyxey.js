...
const swBase = self.location.pathname.replace(/atyxey\.js$/, '')

importScripts(swBase + 'xhw/hrcr.bundle.js')
importScripts(swBase + 'xhw/hrcr.config.js')
importScripts(__uv$config.sw || swBase + 'xhw/hrcr.sw.js')

importScripts(swBase + 'ovlb/zrgn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'flek/')) {
