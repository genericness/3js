...
const swBase = self.location.pathname.replace(/ndakso\.js$/, '')

importScripts(swBase + 'nxu/pbin.bundle.js')
importScripts(swBase + 'nxu/pbin.config.js')
importScripts(__uv$config.sw || swBase + 'nxu/pbin.sw.js')

importScripts(swBase + 'qtww/frju.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'crby/')) {
