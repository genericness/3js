const swBase = self.location.pathname.replace(/boqejh\.js$/, '')

importScripts(swBase + 'xvx/fato.bundle.js')
importScripts(swBase + 'xvx/fato.config.js')
importScripts(__uv$config.sw || swBase + 'xvx/fato.sw.js')

importScripts(swBase + 'uiwb/augj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'msif/')) {
