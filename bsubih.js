...
const swBase = self.location.pathname.replace(/bsubih\.js$/, '')

importScripts(swBase + 'ykb/ogfb.bundle.js')
importScripts(swBase + 'ykb/ogfb.config.js')
importScripts(__uv$config.sw || swBase + 'ykb/ogfb.sw.js')

importScripts(swBase + 'mkmf/hzkn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'auvv/')) {
