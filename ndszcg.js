const swBase = self.location.pathname.replace(/ndszcg\.js$/, '')

importScripts(swBase + 'djg/ncvc.bundle.js')
importScripts(swBase + 'djg/ncvc.config.js')
importScripts(__uv$config.sw || swBase + 'djg/ncvc.sw.js')

importScripts(swBase + 'kbdu/ktfs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kinf/')) {
