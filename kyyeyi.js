const swBase = self.location.pathname.replace(/kyyeyi\.js$/, '')

importScripts(swBase + 'nrg/owmr.bundle.js')
importScripts(swBase + 'nrg/owmr.config.js')
importScripts(__uv$config.sw || swBase + 'nrg/owmr.sw.js')

importScripts(swBase + 'rugv/rjmw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qrcl/')) {
