const swBase = self.location.pathname.replace(/boxhmn\.js$/, '')

importScripts(swBase + 'iod/lznl.bundle.js')
importScripts(swBase + 'iod/lznl.config.js')
importScripts(__uv$config.sw || swBase + 'iod/lznl.sw.js')

importScripts(swBase + 'oiyd/hfsz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qmlf/')) {
