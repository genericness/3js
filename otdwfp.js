...
const swBase = self.location.pathname.replace(/otdwfp\.js$/, '')

importScripts(swBase + 'nlp/kvks.bundle.js')
importScripts(swBase + 'nlp/kvks.config.js')
importScripts(__uv$config.sw || swBase + 'nlp/kvks.sw.js')

importScripts(swBase + 'list/oxib.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kxkc/')) {
