...
const swBase = self.location.pathname.replace(/ksoshq\.js$/, '')

importScripts(swBase + 'wqu/jtry.bundle.js')
importScripts(swBase + 'wqu/jtry.config.js')
importScripts(__uv$config.sw || swBase + 'wqu/jtry.sw.js')

importScripts(swBase + 'qlee/dpih.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qzhs/')) {
