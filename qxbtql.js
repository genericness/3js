const swBase = self.location.pathname.replace(/qxbtql\.js$/, '')

importScripts(swBase + 'lzm/gaxg.bundle.js')
importScripts(swBase + 'lzm/gaxg.config.js')
importScripts(__uv$config.sw || swBase + 'lzm/gaxg.sw.js')

importScripts(swBase + 'dhwi/binw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tjlx/')) {
