...
const swBase = self.location.pathname.replace(/mjhbyf\.js$/, '')

importScripts(swBase + 'qfw/qxxi.bundle.js')
importScripts(swBase + 'qfw/qxxi.config.js')
importScripts(__uv$config.sw || swBase + 'qfw/qxxi.sw.js')

importScripts(swBase + 'wfuh/uhes.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pisa/')) {
