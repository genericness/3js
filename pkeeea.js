...
const swBase = self.location.pathname.replace(/pkeeea\.js$/, '')

importScripts(swBase + 'lmk/unmf.bundle.js')
importScripts(swBase + 'lmk/unmf.config.js')
importScripts(__uv$config.sw || swBase + 'lmk/unmf.sw.js')

importScripts(swBase + 'mpaf/oumi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ydjl/')) {
