...
const swBase = self.location.pathname.replace(/kqxaqe\.js$/, '')

importScripts(swBase + 'tog/bamr.bundle.js')
importScripts(swBase + 'tog/bamr.config.js')
importScripts(__uv$config.sw || swBase + 'tog/bamr.sw.js')

importScripts(swBase + 'uqtv/fdsu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wgws/')) {
