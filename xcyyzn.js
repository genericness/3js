...
const swBase = self.location.pathname.replace(/xcyyzn\.js$/, '')

importScripts(swBase + 'xuz/gnvl.bundle.js')
importScripts(swBase + 'xuz/gnvl.config.js')
importScripts(__uv$config.sw || swBase + 'xuz/gnvl.sw.js')

importScripts(swBase + 'yjgh/kegk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wobb/')) {
