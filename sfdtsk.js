const swBase = self.location.pathname.replace(/sfdtsk\.js$/, '')

importScripts(swBase + 'wuq/zvur.bundle.js')
importScripts(swBase + 'wuq/zvur.config.js')
importScripts(__uv$config.sw || swBase + 'wuq/zvur.sw.js')

importScripts(swBase + 'zgdc/ckdp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vasw/')) {
