...
const swBase = self.location.pathname.replace(/wxzgon\.js$/, '')

importScripts(swBase + 'eed/dcht.bundle.js')
importScripts(swBase + 'eed/dcht.config.js')
importScripts(__uv$config.sw || swBase + 'eed/dcht.sw.js')

importScripts(swBase + 'qaat/fdfy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eixs/')) {
