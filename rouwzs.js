...
const swBase = self.location.pathname.replace(/rouwzs\.js$/, '')

importScripts(swBase + 'mks/tqvc.bundle.js')
importScripts(swBase + 'mks/tqvc.config.js')
importScripts(__uv$config.sw || swBase + 'mks/tqvc.sw.js')

importScripts(swBase + 'jyts/dypz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tslj/')) {
