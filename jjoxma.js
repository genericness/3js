...
const swBase = self.location.pathname.replace(/jjoxma\.js$/, '')

importScripts(swBase + 'xmu/dvbu.bundle.js')
importScripts(swBase + 'xmu/dvbu.config.js')
importScripts(__uv$config.sw || swBase + 'xmu/dvbu.sw.js')

importScripts(swBase + 'umsw/wygh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qoao/')) {
