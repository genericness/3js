...
const swBase = self.location.pathname.replace(/qoblfx\.js$/, '')

importScripts(swBase + 'bam/iwwg.bundle.js')
importScripts(swBase + 'bam/iwwg.config.js')
importScripts(__uv$config.sw || swBase + 'bam/iwwg.sw.js')

importScripts(swBase + 'ujso/jlnn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jcva/')) {
