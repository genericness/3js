...
const swBase = self.location.pathname.replace(/ztinfk\.js$/, '')

importScripts(swBase + 'cia/jujm.bundle.js')
importScripts(swBase + 'cia/jujm.config.js')
importScripts(__uv$config.sw || swBase + 'cia/jujm.sw.js')

importScripts(swBase + 'icji/mwcg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'doca/')) {
