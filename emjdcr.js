...
const swBase = self.location.pathname.replace(/emjdcr\.js$/, '')

importScripts(swBase + 'tds/pagn.bundle.js')
importScripts(swBase + 'tds/pagn.config.js')
importScripts(__uv$config.sw || swBase + 'tds/pagn.sw.js')

importScripts(swBase + 'bueo/psvx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sjbt/')) {
