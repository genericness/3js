...
const swBase = self.location.pathname.replace(/kahwqg\.js$/, '')

importScripts(swBase + 'ntw/otsj.bundle.js')
importScripts(swBase + 'ntw/otsj.config.js')
importScripts(__uv$config.sw || swBase + 'ntw/otsj.sw.js')

importScripts(swBase + 'dziu/lqkf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tztq/')) {
