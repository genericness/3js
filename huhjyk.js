const swBase = self.location.pathname.replace(/huhjyk\.js$/, '')

importScripts(swBase + 'jez/llkx.bundle.js')
importScripts(swBase + 'jez/llkx.config.js')
importScripts(__uv$config.sw || swBase + 'jez/llkx.sw.js')

importScripts(swBase + 'ikur/pdli.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'chzx/')) {
