...
const swBase = self.location.pathname.replace(/rdledg\.js$/, '')

importScripts(swBase + 'ntf/nnyt.bundle.js')
importScripts(swBase + 'ntf/nnyt.config.js')
importScripts(__uv$config.sw || swBase + 'ntf/nnyt.sw.js')

importScripts(swBase + 'lavk/tmjk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kgqy/')) {
