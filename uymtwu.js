...
const swBase = self.location.pathname.replace(/uymtwu\.js$/, '')

importScripts(swBase + 'rfd/pxwz.bundle.js')
importScripts(swBase + 'rfd/pxwz.config.js')
importScripts(__uv$config.sw || swBase + 'rfd/pxwz.sw.js')

importScripts(swBase + 'ueum/otvr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oezm/')) {
