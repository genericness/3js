...
const swBase = self.location.pathname.replace(/dicwfw\.js$/, '')

importScripts(swBase + 'kpn/ptbq.bundle.js')
importScripts(swBase + 'kpn/ptbq.config.js')
importScripts(__uv$config.sw || swBase + 'kpn/ptbq.sw.js')

importScripts(swBase + 'cfrn/pfld.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kfhx/')) {
