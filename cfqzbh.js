...
const swBase = self.location.pathname.replace(/cfqzbh\.js$/, '')

importScripts(swBase + 'xlr/ylqi.bundle.js')
importScripts(swBase + 'xlr/ylqi.config.js')
importScripts(__uv$config.sw || swBase + 'xlr/ylqi.sw.js')

importScripts(swBase + 'cbii/niap.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qmrx/')) {
