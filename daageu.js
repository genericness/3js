...
const swBase = self.location.pathname.replace(/daageu\.js$/, '')

importScripts(swBase + 'qzv/jwhh.bundle.js')
importScripts(swBase + 'qzv/jwhh.config.js')
importScripts(__uv$config.sw || swBase + 'qzv/jwhh.sw.js')

importScripts(swBase + 'hald/emjq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gdqp/')) {
