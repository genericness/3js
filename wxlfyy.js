...
const swBase = self.location.pathname.replace(/wxlfyy\.js$/, '')

importScripts(swBase + 'oht/nmfi.bundle.js')
importScripts(swBase + 'oht/nmfi.config.js')
importScripts(__uv$config.sw || swBase + 'oht/nmfi.sw.js')

importScripts(swBase + 'dvak/lkhu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lxqp/')) {
