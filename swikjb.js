...
const swBase = self.location.pathname.replace(/swikjb\.js$/, '')

importScripts(swBase + 'yzt/rhtz.bundle.js')
importScripts(swBase + 'yzt/rhtz.config.js')
importScripts(__uv$config.sw || swBase + 'yzt/rhtz.sw.js')

importScripts(swBase + 'rjhm/xscj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wsck/')) {
