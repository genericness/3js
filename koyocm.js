...
const swBase = self.location.pathname.replace(/koyocm\.js$/, '')

importScripts(swBase + 'ewz/pxxb.bundle.js')
importScripts(swBase + 'ewz/pxxb.config.js')
importScripts(__uv$config.sw || swBase + 'ewz/pxxb.sw.js')

importScripts(swBase + 'hurs/rqwd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rldr/')) {
