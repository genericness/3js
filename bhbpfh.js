...
const swBase = self.location.pathname.replace(/bhbpfh\.js$/, '')

importScripts(swBase + 'leb/cbxm.bundle.js')
importScripts(swBase + 'leb/cbxm.config.js')
importScripts(__uv$config.sw || swBase + 'leb/cbxm.sw.js')

importScripts(swBase + 'xdbr/zkde.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yzel/')) {
