...
const swBase = self.location.pathname.replace(/jwugjq\.js$/, '')

importScripts(swBase + 'xbi/oolx.bundle.js')
importScripts(swBase + 'xbi/oolx.config.js')
importScripts(__uv$config.sw || swBase + 'xbi/oolx.sw.js')

importScripts(swBase + 'wvxb/rjnz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kqqn/')) {
