const swBase = self.location.pathname.replace(/gzdhkm\.js$/, '')

importScripts(swBase + 'oqg/bukc.bundle.js')
importScripts(swBase + 'oqg/bukc.config.js')
importScripts(__uv$config.sw || swBase + 'oqg/bukc.sw.js')

importScripts(swBase + 'ckvn/liuf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mfwm/')) {
