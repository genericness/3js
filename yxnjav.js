...
const swBase = self.location.pathname.replace(/yxnjav\.js$/, '')

importScripts(swBase + 'ydb/szpq.bundle.js')
importScripts(swBase + 'ydb/szpq.config.js')
importScripts(__uv$config.sw || swBase + 'ydb/szpq.sw.js')

importScripts(swBase + 'pzpb/vuzm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mwss/')) {
