...
const swBase = self.location.pathname.replace(/wwwhra\.js$/, '')

importScripts(swBase + 'kxs/ujvx.bundle.js')
importScripts(swBase + 'kxs/ujvx.config.js')
importScripts(__uv$config.sw || swBase + 'kxs/ujvx.sw.js')

importScripts(swBase + 'cdvx/wahs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'feag/')) {
