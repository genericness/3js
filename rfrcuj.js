...
const swBase = self.location.pathname.replace(/rfrcuj\.js$/, '')

importScripts(swBase + 'zcc/xqbe.bundle.js')
importScripts(swBase + 'zcc/xqbe.config.js')
importScripts(__uv$config.sw || swBase + 'zcc/xqbe.sw.js')

importScripts(swBase + 'rose/udjx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kgkn/')) {
