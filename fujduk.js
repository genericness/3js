...
const swBase = self.location.pathname.replace(/fujduk\.js$/, '')

importScripts(swBase + 'ecx/tptz.bundle.js')
importScripts(swBase + 'ecx/tptz.config.js')
importScripts(__uv$config.sw || swBase + 'ecx/tptz.sw.js')

importScripts(swBase + 'rjjg/bweh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gbkx/')) {
