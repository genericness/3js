...
const swBase = self.location.pathname.replace(/ceocvz\.js$/, '')

importScripts(swBase + 'fce/acyr.bundle.js')
importScripts(swBase + 'fce/acyr.config.js')
importScripts(__uv$config.sw || swBase + 'fce/acyr.sw.js')

importScripts(swBase + 'vzya/rbzw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bqrf/')) {
