...
const swBase = self.location.pathname.replace(/yqjeqp\.js$/, '')

importScripts(swBase + 'uaw/oszx.bundle.js')
importScripts(swBase + 'uaw/oszx.config.js')
importScripts(__uv$config.sw || swBase + 'uaw/oszx.sw.js')

importScripts(swBase + 'ylmy/gktg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ddla/')) {
