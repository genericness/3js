...
const swBase = self.location.pathname.replace(/vhblxq\.js$/, '')

importScripts(swBase + 'psk/vese.bundle.js')
importScripts(swBase + 'psk/vese.config.js')
importScripts(__uv$config.sw || swBase + 'psk/vese.sw.js')

importScripts(swBase + 'qgse/zkyy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cwmt/')) {
