...
const swBase = self.location.pathname.replace(/febjog\.js$/, '')

importScripts(swBase + 'xbg/gntn.bundle.js')
importScripts(swBase + 'xbg/gntn.config.js')
importScripts(__uv$config.sw || swBase + 'xbg/gntn.sw.js')

importScripts(swBase + 'ogju/qxag.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gbmw/')) {
