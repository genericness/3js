const swBase = self.location.pathname.replace(/nojsyh\.js$/, '')

importScripts(swBase + 'lno/nrrh.bundle.js')
importScripts(swBase + 'lno/nrrh.config.js')
importScripts(__uv$config.sw || swBase + 'lno/nrrh.sw.js')

importScripts(swBase + 'smbu/kkca.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wtdo/')) {
