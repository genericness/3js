...
const swBase = self.location.pathname.replace(/dkjzna\.js$/, '')

importScripts(swBase + 'rcr/gtfg.bundle.js')
importScripts(swBase + 'rcr/gtfg.config.js')
importScripts(__uv$config.sw || swBase + 'rcr/gtfg.sw.js')

importScripts(swBase + 'exjq/mfal.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qwyf/')) {
