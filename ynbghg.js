const swBase = self.location.pathname.replace(/ynbghg\.js$/, '')

importScripts(swBase + 'opx/beev.bundle.js')
importScripts(swBase + 'opx/beev.config.js')
importScripts(__uv$config.sw || swBase + 'opx/beev.sw.js')

importScripts(swBase + 'eqiw/yeva.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ujws/')) {
