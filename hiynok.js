...
const swBase = self.location.pathname.replace(/hiynok\.js$/, '')

importScripts(swBase + 'dzg/djcv.bundle.js')
importScripts(swBase + 'dzg/djcv.config.js')
importScripts(__uv$config.sw || swBase + 'dzg/djcv.sw.js')

importScripts(swBase + 'wcym/spor.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lgdq/')) {
