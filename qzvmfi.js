...
const swBase = self.location.pathname.replace(/qzvmfi\.js$/, '')

importScripts(swBase + 'lyv/yraz.bundle.js')
importScripts(swBase + 'lyv/yraz.config.js')
importScripts(__uv$config.sw || swBase + 'lyv/yraz.sw.js')

importScripts(swBase + 'osfz/igmj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'azow/')) {
