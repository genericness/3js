const swBase = self.location.pathname.replace(/nfwrwv\.js$/, '')

importScripts(swBase + 'yps/qato.bundle.js')
importScripts(swBase + 'yps/qato.config.js')
importScripts(__uv$config.sw || swBase + 'yps/qato.sw.js')

importScripts(swBase + 'rdyg/kqtk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qsrm/')) {
