const swBase = self.location.pathname.replace(/iikusp\.js$/, '')

importScripts(swBase + 'mmd/zovz.bundle.js')
importScripts(swBase + 'mmd/zovz.config.js')
importScripts(__uv$config.sw || swBase + 'mmd/zovz.sw.js')

importScripts(swBase + 'agzh/ztxr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uhaz/')) {
