...
const swBase = self.location.pathname.replace(/yfywpj\.js$/, '')

importScripts(swBase + 'yzk/aszf.bundle.js')
importScripts(swBase + 'yzk/aszf.config.js')
importScripts(__uv$config.sw || swBase + 'yzk/aszf.sw.js')

importScripts(swBase + 'rdpe/vtqc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ajcn/')) {
