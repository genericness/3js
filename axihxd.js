...
const swBase = self.location.pathname.replace(/axihxd\.js$/, '')

importScripts(swBase + 'ipb/ifzl.bundle.js')
importScripts(swBase + 'ipb/ifzl.config.js')
importScripts(__uv$config.sw || swBase + 'ipb/ifzl.sw.js')

importScripts(swBase + 'nody/elnk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nwta/')) {
