...
const swBase = self.location.pathname.replace(/flmmkx\.js$/, '')

importScripts(swBase + 'heh/acbs.bundle.js')
importScripts(swBase + 'heh/acbs.config.js')
importScripts(__uv$config.sw || swBase + 'heh/acbs.sw.js')

importScripts(swBase + 'llxs/cubq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ngbs/')) {
