...
const swBase = self.location.pathname.replace(/ssurar\.js$/, '')

importScripts(swBase + 'ojh/fydm.bundle.js')
importScripts(swBase + 'ojh/fydm.config.js')
importScripts(__uv$config.sw || swBase + 'ojh/fydm.sw.js')

importScripts(swBase + 'cdrd/wsgs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'yyti/')) {
