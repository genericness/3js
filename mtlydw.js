...
const swBase = self.location.pathname.replace(/mtlydw\.js$/, '')

importScripts(swBase + 'elc/tzct.bundle.js')
importScripts(swBase + 'elc/tzct.config.js')
importScripts(__uv$config.sw || swBase + 'elc/tzct.sw.js')

importScripts(swBase + 'jjod/svlz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fxlg/')) {
