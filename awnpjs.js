...
const swBase = self.location.pathname.replace(/awnpjs\.js$/, '')

importScripts(swBase + 'tcr/otbz.bundle.js')
importScripts(swBase + 'tcr/otbz.config.js')
importScripts(__uv$config.sw || swBase + 'tcr/otbz.sw.js')

importScripts(swBase + 'jfso/kngu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dfco/')) {
