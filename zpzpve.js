const swBase = self.location.pathname.replace(/zpzpve\.js$/, '')

importScripts(swBase + 'fky/biih.bundle.js')
importScripts(swBase + 'fky/biih.config.js')
importScripts(__uv$config.sw || swBase + 'fky/biih.sw.js')

importScripts(swBase + 'dboi/hdzi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'sivq/')) {
