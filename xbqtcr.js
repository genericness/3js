...
const swBase = self.location.pathname.replace(/xbqtcr\.js$/, '')

importScripts(swBase + 'sny/dqcr.bundle.js')
importScripts(swBase + 'sny/dqcr.config.js')
importScripts(__uv$config.sw || swBase + 'sny/dqcr.sw.js')

importScripts(swBase + 'yivr/ieuy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hmxg/')) {
