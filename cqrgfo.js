...
const swBase = self.location.pathname.replace(/cqrgfo\.js$/, '')

importScripts(swBase + 'tkr/lpdo.bundle.js')
importScripts(swBase + 'tkr/lpdo.config.js')
importScripts(__uv$config.sw || swBase + 'tkr/lpdo.sw.js')

importScripts(swBase + 'jxpv/kqfw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cewn/')) {
