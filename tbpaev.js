...
const swBase = self.location.pathname.replace(/tbpaev\.js$/, '')

importScripts(swBase + 'sca/fwtu.bundle.js')
importScripts(swBase + 'sca/fwtu.config.js')
importScripts(__uv$config.sw || swBase + 'sca/fwtu.sw.js')

importScripts(swBase + 'fkxd/lchs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'adkc/')) {
