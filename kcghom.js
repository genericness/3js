...
const swBase = self.location.pathname.replace(/kcghom\.js$/, '')

importScripts(swBase + 'sbz/fchp.bundle.js')
importScripts(swBase + 'sbz/fchp.config.js')
importScripts(__uv$config.sw || swBase + 'sbz/fchp.sw.js')

importScripts(swBase + 'npfr/wuqv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'csvh/')) {
