...
const swBase = self.location.pathname.replace(/fgoiyc\.js$/, '')

importScripts(swBase + 'rlx/rhvc.bundle.js')
importScripts(swBase + 'rlx/rhvc.config.js')
importScripts(__uv$config.sw || swBase + 'rlx/rhvc.sw.js')

importScripts(swBase + 'ilxd/vmgl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'miut/')) {
