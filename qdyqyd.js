...
const swBase = self.location.pathname.replace(/qdyqyd\.js$/, '')

importScripts(swBase + 'zhu/htkj.bundle.js')
importScripts(swBase + 'zhu/htkj.config.js')
importScripts(__uv$config.sw || swBase + 'zhu/htkj.sw.js')

importScripts(swBase + 'tumg/omlb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ngng/')) {
