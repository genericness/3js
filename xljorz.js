const swBase = self.location.pathname.replace(/xljorz\.js$/, '')

importScripts(swBase + 'iob/yixp.bundle.js')
importScripts(swBase + 'iob/yixp.config.js')
importScripts(__uv$config.sw || swBase + 'iob/yixp.sw.js')

importScripts(swBase + 'nnoe/iiax.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bicf/')) {
