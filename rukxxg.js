...
const swBase = self.location.pathname.replace(/rukxxg\.js$/, '')

importScripts(swBase + 'rym/lcrp.bundle.js')
importScripts(swBase + 'rym/lcrp.config.js')
importScripts(__uv$config.sw || swBase + 'rym/lcrp.sw.js')

importScripts(swBase + 'krcj/jlxs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lqeh/')) {
