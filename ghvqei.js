...
const swBase = self.location.pathname.replace(/ghvqei\.js$/, '')

importScripts(swBase + 'sry/gskd.bundle.js')
importScripts(swBase + 'sry/gskd.config.js')
importScripts(__uv$config.sw || swBase + 'sry/gskd.sw.js')

importScripts(swBase + 'voms/oqhy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ebgr/')) {
