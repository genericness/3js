...
const swBase = self.location.pathname.replace(/ihpnqk\.js$/, '')

importScripts(swBase + 'yqa/vezx.bundle.js')
importScripts(swBase + 'yqa/vezx.config.js')
importScripts(__uv$config.sw || swBase + 'yqa/vezx.sw.js')

importScripts(swBase + 'cgiz/qofh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wefw/')) {
