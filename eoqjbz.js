...
const swBase = self.location.pathname.replace(/eoqjbz\.js$/, '')

importScripts(swBase + 'euf/ztou.bundle.js')
importScripts(swBase + 'euf/ztou.config.js')
importScripts(__uv$config.sw || swBase + 'euf/ztou.sw.js')

importScripts(swBase + 'dsbs/chnn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tucf/')) {
