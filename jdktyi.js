...
const swBase = self.location.pathname.replace(/jdktyi\.js$/, '')

importScripts(swBase + 'ybc/dphj.bundle.js')
importScripts(swBase + 'ybc/dphj.config.js')
importScripts(__uv$config.sw || swBase + 'ybc/dphj.sw.js')

importScripts(swBase + 'uiju/cvjn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'suyn/')) {
