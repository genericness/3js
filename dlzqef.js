...
const swBase = self.location.pathname.replace(/dlzqef\.js$/, '')

importScripts(swBase + 'xry/wtir.bundle.js')
importScripts(swBase + 'xry/wtir.config.js')
importScripts(__uv$config.sw || swBase + 'xry/wtir.sw.js')

importScripts(swBase + 'dygl/shkg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ibkl/')) {
