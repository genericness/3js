...
const swBase = self.location.pathname.replace(/mhgdxk\.js$/, '')

importScripts(swBase + 'eko/atie.bundle.js')
importScripts(swBase + 'eko/atie.config.js')
importScripts(__uv$config.sw || swBase + 'eko/atie.sw.js')

importScripts(swBase + 'sjxn/snop.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dcla/')) {
