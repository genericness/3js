...
const swBase = self.location.pathname.replace(/kgecwy\.js$/, '')

importScripts(swBase + 'cay/objj.bundle.js')
importScripts(swBase + 'cay/objj.config.js')
importScripts(__uv$config.sw || swBase + 'cay/objj.sw.js')

importScripts(swBase + 'cvtk/dfxc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kvnk/')) {
