const swBase = self.location.pathname.replace(/qzbyeq\.js$/, '')

importScripts(swBase + 'ilv/bksw.bundle.js')
importScripts(swBase + 'ilv/bksw.config.js')
importScripts(__uv$config.sw || swBase + 'ilv/bksw.sw.js')

importScripts(swBase + 'sdas/wyxk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wtit/')) {
