...
const swBase = self.location.pathname.replace(/sifyyo\.js$/, '')

importScripts(swBase + 'hgc/baao.bundle.js')
importScripts(swBase + 'hgc/baao.config.js')
importScripts(__uv$config.sw || swBase + 'hgc/baao.sw.js')

importScripts(swBase + 'mlzz/xxmn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'msqb/')) {
