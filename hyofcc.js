...
const swBase = self.location.pathname.replace(/hyofcc\.js$/, '')

importScripts(swBase + 'ity/dhvz.bundle.js')
importScripts(swBase + 'ity/dhvz.config.js')
importScripts(__uv$config.sw || swBase + 'ity/dhvz.sw.js')

importScripts(swBase + 'rwcq/pjuo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ludy/')) {
