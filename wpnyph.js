...
const swBase = self.location.pathname.replace(/wpnyph\.js$/, '')

importScripts(swBase + 'pkr/qgkh.bundle.js')
importScripts(swBase + 'pkr/qgkh.config.js')
importScripts(__uv$config.sw || swBase + 'pkr/qgkh.sw.js')

importScripts(swBase + 'cyqv/ipny.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dtrs/')) {
