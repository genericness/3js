...
const swBase = self.location.pathname.replace(/sqkqhe\.js$/, '')

importScripts(swBase + 'wlq/mwht.bundle.js')
importScripts(swBase + 'wlq/mwht.config.js')
importScripts(__uv$config.sw || swBase + 'wlq/mwht.sw.js')

importScripts(swBase + 'fggk/skkw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ktwu/')) {
