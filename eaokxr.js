...
const swBase = self.location.pathname.replace(/eaokxr\.js$/, '')

importScripts(swBase + 'mgn/icix.bundle.js')
importScripts(swBase + 'mgn/icix.config.js')
importScripts(__uv$config.sw || swBase + 'mgn/icix.sw.js')

importScripts(swBase + 'svul/zmbm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lukr/')) {
