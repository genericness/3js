...
const swBase = self.location.pathname.replace(/yfdgfq\.js$/, '')

importScripts(swBase + 'sks/sfku.bundle.js')
importScripts(swBase + 'sks/sfku.config.js')
importScripts(__uv$config.sw || swBase + 'sks/sfku.sw.js')

importScripts(swBase + 'xyfp/rnem.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kwbi/')) {
