...
const swBase = self.location.pathname.replace(/cdqsbn\.js$/, '')

importScripts(swBase + 'esf/hghl.bundle.js')
importScripts(swBase + 'esf/hghl.config.js')
importScripts(__uv$config.sw || swBase + 'esf/hghl.sw.js')

importScripts(swBase + 'nxbw/oyvg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bjll/')) {
