...
const swBase = self.location.pathname.replace(/urnixy\.js$/, '')

importScripts(swBase + 'knc/cdkw.bundle.js')
importScripts(swBase + 'knc/cdkw.config.js')
importScripts(__uv$config.sw || swBase + 'knc/cdkw.sw.js')

importScripts(swBase + 'qjph/kaxr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'moki/')) {
