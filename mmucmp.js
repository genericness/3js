...
const swBase = self.location.pathname.replace(/mmucmp\.js$/, '')

importScripts(swBase + 'rqr/edau.bundle.js')
importScripts(swBase + 'rqr/edau.config.js')
importScripts(__uv$config.sw || swBase + 'rqr/edau.sw.js')

importScripts(swBase + 'samq/foet.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wihy/')) {
