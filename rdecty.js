...
const swBase = self.location.pathname.replace(/rdecty\.js$/, '')

importScripts(swBase + 'azy/ojec.bundle.js')
importScripts(swBase + 'azy/ojec.config.js')
importScripts(__uv$config.sw || swBase + 'azy/ojec.sw.js')

importScripts(swBase + 'yzke/wojb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cjkx/')) {
