...
const swBase = self.location.pathname.replace(/eljxnr\.js$/, '')

importScripts(swBase + 'zsy/wxsd.bundle.js')
importScripts(swBase + 'zsy/wxsd.config.js')
importScripts(__uv$config.sw || swBase + 'zsy/wxsd.sw.js')

importScripts(swBase + 'jrxv/itbc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'okip/')) {
