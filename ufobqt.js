...
const swBase = self.location.pathname.replace(/ufobqt\.js$/, '')

importScripts(swBase + 'kxe/rqiz.bundle.js')
importScripts(swBase + 'kxe/rqiz.config.js')
importScripts(__uv$config.sw || swBase + 'kxe/rqiz.sw.js')

importScripts(swBase + 'prrv/blme.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'znjo/')) {
