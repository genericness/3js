...
const swBase = self.location.pathname.replace(/cvqdtj\.js$/, '')

importScripts(swBase + 'fma/gdzv.bundle.js')
importScripts(swBase + 'fma/gdzv.config.js')
importScripts(__uv$config.sw || swBase + 'fma/gdzv.sw.js')

importScripts(swBase + 'yyht/muaq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'luyb/')) {
