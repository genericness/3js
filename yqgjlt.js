...
const swBase = self.location.pathname.replace(/yqgjlt\.js$/, '')

importScripts(swBase + 'ixo/rffg.bundle.js')
importScripts(swBase + 'ixo/rffg.config.js')
importScripts(__uv$config.sw || swBase + 'ixo/rffg.sw.js')

importScripts(swBase + 'qrfx/lizh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dwng/')) {
