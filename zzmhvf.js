...
const swBase = self.location.pathname.replace(/zzmhvf\.js$/, '')

importScripts(swBase + 'djx/elin.bundle.js')
importScripts(swBase + 'djx/elin.config.js')
importScripts(__uv$config.sw || swBase + 'djx/elin.sw.js')

importScripts(swBase + 'yxvn/eyof.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'worh/')) {
