...
const swBase = self.location.pathname.replace(/kphodv\.js$/, '')

importScripts(swBase + 'cnr/kccz.bundle.js')
importScripts(swBase + 'cnr/kccz.config.js')
importScripts(__uv$config.sw || swBase + 'cnr/kccz.sw.js')

importScripts(swBase + 'ebsk/dsvf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rrsm/')) {
