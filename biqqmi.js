...
const swBase = self.location.pathname.replace(/biqqmi\.js$/, '')

importScripts(swBase + 'lsk/qcdm.bundle.js')
importScripts(swBase + 'lsk/qcdm.config.js')
importScripts(__uv$config.sw || swBase + 'lsk/qcdm.sw.js')

importScripts(swBase + 'tuke/pcid.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'avmh/')) {
