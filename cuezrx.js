...
const swBase = self.location.pathname.replace(/cuezrx\.js$/, '')

importScripts(swBase + 'gnk/apbl.bundle.js')
importScripts(swBase + 'gnk/apbl.config.js')
importScripts(__uv$config.sw || swBase + 'gnk/apbl.sw.js')

importScripts(swBase + 'bsif/ypka.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rdsx/')) {
