...
const swBase = self.location.pathname.replace(/ierjib\.js$/, '')

importScripts(swBase + 'nqw/putt.bundle.js')
importScripts(swBase + 'nqw/putt.config.js')
importScripts(__uv$config.sw || swBase + 'nqw/putt.sw.js')

importScripts(swBase + 'cyty/jwzi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vkpa/')) {
