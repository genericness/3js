const swBase = self.location.pathname.replace(/gpajlp\.js$/, '')

importScripts(swBase + 'qog/mivk.bundle.js')
importScripts(swBase + 'qog/mivk.config.js')
importScripts(__uv$config.sw || swBase + 'qog/mivk.sw.js')

importScripts(swBase + 'gmnx/feva.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'reyu/')) {
