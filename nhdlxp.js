...
const swBase = self.location.pathname.replace(/nhdlxp\.js$/, '')

importScripts(swBase + 'ysb/xpdx.bundle.js')
importScripts(swBase + 'ysb/xpdx.config.js')
importScripts(__uv$config.sw || swBase + 'ysb/xpdx.sw.js')

importScripts(swBase + 'dyyo/pxur.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vzor/')) {
