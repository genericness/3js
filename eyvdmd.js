...
const swBase = self.location.pathname.replace(/eyvdmd\.js$/, '')

importScripts(swBase + 'zgp/hhjx.bundle.js')
importScripts(swBase + 'zgp/hhjx.config.js')
importScripts(__uv$config.sw || swBase + 'zgp/hhjx.sw.js')

importScripts(swBase + 'peyr/kykg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ypul/')) {
