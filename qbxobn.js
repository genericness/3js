...
const swBase = self.location.pathname.replace(/qbxobn\.js$/, '')

importScripts(swBase + 'vxj/efgq.bundle.js')
importScripts(swBase + 'vxj/efgq.config.js')
importScripts(__uv$config.sw || swBase + 'vxj/efgq.sw.js')

importScripts(swBase + 'nhie/wxjp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ixle/')) {
