...
const swBase = self.location.pathname.replace(/wbdhuq\.js$/, '')

importScripts(swBase + 'qed/vsoc.bundle.js')
importScripts(swBase + 'qed/vsoc.config.js')
importScripts(__uv$config.sw || swBase + 'qed/vsoc.sw.js')

importScripts(swBase + 'vggq/ckzp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'etfb/')) {
