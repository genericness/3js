const swBase = self.location.pathname.replace(/pijzcq\.js$/, '')

importScripts(swBase + 'usc/vvnp.bundle.js')
importScripts(swBase + 'usc/vvnp.config.js')
importScripts(__uv$config.sw || swBase + 'usc/vvnp.sw.js')

importScripts(swBase + 'rbbs/ogll.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'broa/')) {
