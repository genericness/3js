...
const swBase = self.location.pathname.replace(/lshngb\.js$/, '')

importScripts(swBase + 'yyn/pkxo.bundle.js')
importScripts(swBase + 'yyn/pkxo.config.js')
importScripts(__uv$config.sw || swBase + 'yyn/pkxo.sw.js')

importScripts(swBase + 'utvs/zrqc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iwme/')) {
