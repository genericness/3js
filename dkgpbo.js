...
const swBase = self.location.pathname.replace(/dkgpbo\.js$/, '')

importScripts(swBase + 'uyu/cbya.bundle.js')
importScripts(swBase + 'uyu/cbya.config.js')
importScripts(__uv$config.sw || swBase + 'uyu/cbya.sw.js')

importScripts(swBase + 'gjou/klhl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'aocy/')) {
