...
const swBase = self.location.pathname.replace(/madurl\.js$/, '')

importScripts(swBase + 'wji/fvce.bundle.js')
importScripts(swBase + 'wji/fvce.config.js')
importScripts(__uv$config.sw || swBase + 'wji/fvce.sw.js')

importScripts(swBase + 'nrxg/lany.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nrvi/')) {
