const swBase = self.location.pathname.replace(/ytwgry\.js$/, '')

importScripts(swBase + 'yen/jvto.bundle.js')
importScripts(swBase + 'yen/jvto.config.js')
importScripts(__uv$config.sw || swBase + 'yen/jvto.sw.js')

importScripts(swBase + 'vyny/kcvm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wjqd/')) {
