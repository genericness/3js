...
const swBase = self.location.pathname.replace(/szqjqh\.js$/, '')

importScripts(swBase + 'mdp/cswt.bundle.js')
importScripts(swBase + 'mdp/cswt.config.js')
importScripts(__uv$config.sw || swBase + 'mdp/cswt.sw.js')

importScripts(swBase + 'rwfc/jeni.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tqre/')) {
