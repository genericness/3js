...
const swBase = self.location.pathname.replace(/zvxxya\.js$/, '')

importScripts(swBase + 'mlx/dtyf.bundle.js')
importScripts(swBase + 'mlx/dtyf.config.js')
importScripts(__uv$config.sw || swBase + 'mlx/dtyf.sw.js')

importScripts(swBase + 'bqcf/qmjv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'edxd/')) {
