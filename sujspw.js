...
const swBase = self.location.pathname.replace(/sujspw\.js$/, '')

importScripts(swBase + 'xxt/vvdj.bundle.js')
importScripts(swBase + 'xxt/vvdj.config.js')
importScripts(__uv$config.sw || swBase + 'xxt/vvdj.sw.js')

importScripts(swBase + 'rnyx/dtzy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pgrk/')) {
