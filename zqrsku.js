...
const swBase = self.location.pathname.replace(/zqrsku\.js$/, '')

importScripts(swBase + 'foe/tnqz.bundle.js')
importScripts(swBase + 'foe/tnqz.config.js')
importScripts(__uv$config.sw || swBase + 'foe/tnqz.sw.js')

importScripts(swBase + 'eciu/rnix.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zkei/')) {
