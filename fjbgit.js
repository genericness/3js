...
const swBase = self.location.pathname.replace(/fjbgit\.js$/, '')

importScripts(swBase + 'nhw/wskp.bundle.js')
importScripts(swBase + 'nhw/wskp.config.js')
importScripts(__uv$config.sw || swBase + 'nhw/wskp.sw.js')

importScripts(swBase + 'zzck/ruqs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cewa/')) {
