...
const swBase = self.location.pathname.replace(/ulojyx\.js$/, '')

importScripts(swBase + 'utn/done.bundle.js')
importScripts(swBase + 'utn/done.config.js')
importScripts(__uv$config.sw || swBase + 'utn/done.sw.js')

importScripts(swBase + 'djfh/bpgi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oryr/')) {
