...
const swBase = self.location.pathname.replace(/dynbtx\.js$/, '')

importScripts(swBase + 'zai/fodz.bundle.js')
importScripts(swBase + 'zai/fodz.config.js')
importScripts(__uv$config.sw || swBase + 'zai/fodz.sw.js')

importScripts(swBase + 'vdfu/bcen.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kucj/')) {
