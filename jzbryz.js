...
const swBase = self.location.pathname.replace(/jzbryz\.js$/, '')

importScripts(swBase + 'fqo/exsn.bundle.js')
importScripts(swBase + 'fqo/exsn.config.js')
importScripts(__uv$config.sw || swBase + 'fqo/exsn.sw.js')

importScripts(swBase + 'umqn/aapa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jgji/')) {
