...
const swBase = self.location.pathname.replace(/hznwrn\.js$/, '')

importScripts(swBase + 'ioo/sull.bundle.js')
importScripts(swBase + 'ioo/sull.config.js')
importScripts(__uv$config.sw || swBase + 'ioo/sull.sw.js')

importScripts(swBase + 'bdyi/xtki.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lqjg/')) {
