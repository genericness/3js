...
const swBase = self.location.pathname.replace(/picmzg\.js$/, '')

importScripts(swBase + 'ynx/lfjd.bundle.js')
importScripts(swBase + 'ynx/lfjd.config.js')
importScripts(__uv$config.sw || swBase + 'ynx/lfjd.sw.js')

importScripts(swBase + 'easl/zkma.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kbux/')) {
