...
const swBase = self.location.pathname.replace(/xkiiab\.js$/, '')

importScripts(swBase + 'add/rzcy.bundle.js')
importScripts(swBase + 'add/rzcy.config.js')
importScripts(__uv$config.sw || swBase + 'add/rzcy.sw.js')

importScripts(swBase + 'xeyj/dwlp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xtrw/')) {
