...
const swBase = self.location.pathname.replace(/gtkqvf\.js$/, '')

importScripts(swBase + 'qwr/vdbc.bundle.js')
importScripts(swBase + 'qwr/vdbc.config.js')
importScripts(__uv$config.sw || swBase + 'qwr/vdbc.sw.js')

importScripts(swBase + 'fckk/fcwj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mhuh/')) {
