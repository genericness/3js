...
const swBase = self.location.pathname.replace(/ydihzq\.js$/, '')

importScripts(swBase + 'uvx/bhff.bundle.js')
importScripts(swBase + 'uvx/bhff.config.js')
importScripts(__uv$config.sw || swBase + 'uvx/bhff.sw.js')

importScripts(swBase + 'hxdp/txwf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eyyh/')) {
