...
const swBase = self.location.pathname.replace(/rdzage\.js$/, '')

importScripts(swBase + 'wlv/kend.bundle.js')
importScripts(swBase + 'wlv/kend.config.js')
importScripts(__uv$config.sw || swBase + 'wlv/kend.sw.js')

importScripts(swBase + 'xpsz/mmyf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ixvx/')) {
