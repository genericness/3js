...
const swBase = self.location.pathname.replace(/tyvolw\.js$/, '')

importScripts(swBase + 'tnt/dshq.bundle.js')
importScripts(swBase + 'tnt/dshq.config.js')
importScripts(__uv$config.sw || swBase + 'tnt/dshq.sw.js')

importScripts(swBase + 'vvhv/asfc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cdju/')) {
