...
const swBase = self.location.pathname.replace(/tfabxb\.js$/, '')

importScripts(swBase + 'waw/bxej.bundle.js')
importScripts(swBase + 'waw/bxej.config.js')
importScripts(__uv$config.sw || swBase + 'waw/bxej.sw.js')

importScripts(swBase + 'udbf/hrkj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ccot/')) {
