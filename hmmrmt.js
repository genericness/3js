const swBase = self.location.pathname.replace(/hmmrmt\.js$/, '')

importScripts(swBase + 'vpf/quij.bundle.js')
importScripts(swBase + 'vpf/quij.config.js')
importScripts(__uv$config.sw || swBase + 'vpf/quij.sw.js')

importScripts(swBase + 'oyzx/ujnk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vynn/')) {
