const swBase = self.location.pathname.replace(/tltjth\.js$/, '')

importScripts(swBase + 'fcu/easv.bundle.js')
importScripts(swBase + 'fcu/easv.config.js')
importScripts(__uv$config.sw || swBase + 'fcu/easv.sw.js')

importScripts(swBase + 'wkpx/soul.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nnbq/')) {
