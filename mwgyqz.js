...
const swBase = self.location.pathname.replace(/mwgyqz\.js$/, '')

importScripts(swBase + 'awm/kzra.bundle.js')
importScripts(swBase + 'awm/kzra.config.js')
importScripts(__uv$config.sw || swBase + 'awm/kzra.sw.js')

importScripts(swBase + 'dmht/pyic.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ihpo/')) {
