...
const swBase = self.location.pathname.replace(/jqkddy\.js$/, '')

importScripts(swBase + 'zix/qzuv.bundle.js')
importScripts(swBase + 'zix/qzuv.config.js')
importScripts(__uv$config.sw || swBase + 'zix/qzuv.sw.js')

importScripts(swBase + 'pktq/gron.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rorc/')) {
