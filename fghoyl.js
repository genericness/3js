...
const swBase = self.location.pathname.replace(/fghoyl\.js$/, '')

importScripts(swBase + 'fjk/pavv.bundle.js')
importScripts(swBase + 'fjk/pavv.config.js')
importScripts(__uv$config.sw || swBase + 'fjk/pavv.sw.js')

importScripts(swBase + 'kelc/dryk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'geam/')) {
