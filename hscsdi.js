...
const swBase = self.location.pathname.replace(/hscsdi\.js$/, '')

importScripts(swBase + 'oqz/xjjx.bundle.js')
importScripts(swBase + 'oqz/xjjx.config.js')
importScripts(__uv$config.sw || swBase + 'oqz/xjjx.sw.js')

importScripts(swBase + 'ffzu/jrjw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zqdb/')) {
