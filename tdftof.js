...
const swBase = self.location.pathname.replace(/tdftof\.js$/, '')

importScripts(swBase + 'piy/dddf.bundle.js')
importScripts(swBase + 'piy/dddf.config.js')
importScripts(__uv$config.sw || swBase + 'piy/dddf.sw.js')

importScripts(swBase + 'lzfl/jqao.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pgcd/')) {
