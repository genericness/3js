...
const swBase = self.location.pathname.replace(/xlhqqu\.js$/, '')

importScripts(swBase + 'axw/qmzr.bundle.js')
importScripts(swBase + 'axw/qmzr.config.js')
importScripts(__uv$config.sw || swBase + 'axw/qmzr.sw.js')

importScripts(swBase + 'fmyo/awfa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'snnr/')) {
