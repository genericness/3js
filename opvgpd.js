...
const swBase = self.location.pathname.replace(/opvgpd\.js$/, '')

importScripts(swBase + 'aml/eqhr.bundle.js')
importScripts(swBase + 'aml/eqhr.config.js')
importScripts(__uv$config.sw || swBase + 'aml/eqhr.sw.js')

importScripts(swBase + 'wdch/lvlj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'prpj/')) {
