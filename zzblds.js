...
const swBase = self.location.pathname.replace(/zzblds\.js$/, '')

importScripts(swBase + 'gjr/eepg.bundle.js')
importScripts(swBase + 'gjr/eepg.config.js')
importScripts(__uv$config.sw || swBase + 'gjr/eepg.sw.js')

importScripts(swBase + 'sooa/tkxc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zrek/')) {
