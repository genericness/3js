const swBase = self.location.pathname.replace(/epghwv\.js$/, '')

importScripts(swBase + 'xvs/wwir.bundle.js')
importScripts(swBase + 'xvs/wwir.config.js')
importScripts(__uv$config.sw || swBase + 'xvs/wwir.sw.js')

importScripts(swBase + 'xmxu/dkpe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'grac/')) {
