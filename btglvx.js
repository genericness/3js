...
const swBase = self.location.pathname.replace(/btglvx\.js$/, '')

importScripts(swBase + 'whh/okaz.bundle.js')
importScripts(swBase + 'whh/okaz.config.js')
importScripts(__uv$config.sw || swBase + 'whh/okaz.sw.js')

importScripts(swBase + 'wzol/mxfc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nxgc/')) {
