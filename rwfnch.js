...
const swBase = self.location.pathname.replace(/rwfnch\.js$/, '')

importScripts(swBase + 'gvy/awlo.bundle.js')
importScripts(swBase + 'gvy/awlo.config.js')
importScripts(__uv$config.sw || swBase + 'gvy/awlo.sw.js')

importScripts(swBase + 'uadx/teyv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tuxj/')) {
