...
const swBase = self.location.pathname.replace(/ayzrks\.js$/, '')

importScripts(swBase + 'owm/bswu.bundle.js')
importScripts(swBase + 'owm/bswu.config.js')
importScripts(__uv$config.sw || swBase + 'owm/bswu.sw.js')

importScripts(swBase + 'rxyg/cwzs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'albw/')) {
