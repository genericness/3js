...
const swBase = self.location.pathname.replace(/lqqyur\.js$/, '')

importScripts(swBase + 'zad/yzwc.bundle.js')
importScripts(swBase + 'zad/yzwc.config.js')
importScripts(__uv$config.sw || swBase + 'zad/yzwc.sw.js')

importScripts(swBase + 'ekzb/cvcb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hlyt/')) {
