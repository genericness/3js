const swBase = self.location.pathname.replace(/wjjqyk\.js$/, '')

importScripts(swBase + 'xbu/cwsb.bundle.js')
importScripts(swBase + 'xbu/cwsb.config.js')
importScripts(__uv$config.sw || swBase + 'xbu/cwsb.sw.js')

importScripts(swBase + 'dpdw/skya.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ryvq/')) {
