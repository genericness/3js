...
const swBase = self.location.pathname.replace(/jjybgf\.js$/, '')

importScripts(swBase + 'ypi/sfte.bundle.js')
importScripts(swBase + 'ypi/sfte.config.js')
importScripts(__uv$config.sw || swBase + 'ypi/sfte.sw.js')

importScripts(swBase + 'kolf/kxin.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kgkl/')) {
