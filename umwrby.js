...
const swBase = self.location.pathname.replace(/umwrby\.js$/, '')

importScripts(swBase + 'rtz/zvgp.bundle.js')
importScripts(swBase + 'rtz/zvgp.config.js')
importScripts(__uv$config.sw || swBase + 'rtz/zvgp.sw.js')

importScripts(swBase + 'zpko/qnlm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mzcz/')) {
