...
const swBase = self.location.pathname.replace(/xszlxk\.js$/, '')

importScripts(swBase + 'jgj/fzgg.bundle.js')
importScripts(swBase + 'jgj/fzgg.config.js')
importScripts(__uv$config.sw || swBase + 'jgj/fzgg.sw.js')

importScripts(swBase + 'rwed/sngm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'igcj/')) {
