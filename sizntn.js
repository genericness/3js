...
const swBase = self.location.pathname.replace(/sizntn\.js$/, '')

importScripts(swBase + 'bha/jvlf.bundle.js')
importScripts(swBase + 'bha/jvlf.config.js')
importScripts(__uv$config.sw || swBase + 'bha/jvlf.sw.js')

importScripts(swBase + 'sdvg/hqls.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'obmb/')) {
