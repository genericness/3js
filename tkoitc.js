...
const swBase = self.location.pathname.replace(/tkoitc\.js$/, '')

importScripts(swBase + 'vxf/ooco.bundle.js')
importScripts(swBase + 'vxf/ooco.config.js')
importScripts(__uv$config.sw || swBase + 'vxf/ooco.sw.js')

importScripts(swBase + 'tecw/eojx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pxzt/')) {
