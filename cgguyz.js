const swBase = self.location.pathname.replace(/cgguyz\.js$/, '')

importScripts(swBase + 'rhe/ylnr.bundle.js')
importScripts(swBase + 'rhe/ylnr.config.js')
importScripts(__uv$config.sw || swBase + 'rhe/ylnr.sw.js')

importScripts(swBase + 'lobc/nufl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rxdn/')) {
