...
const swBase = self.location.pathname.replace(/idjmez\.js$/, '')

importScripts(swBase + 'fox/xnzo.bundle.js')
importScripts(swBase + 'fox/xnzo.config.js')
importScripts(__uv$config.sw || swBase + 'fox/xnzo.sw.js')

importScripts(swBase + 'jceg/lgga.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jmyj/')) {
