...
const swBase = self.location.pathname.replace(/cjuoov\.js$/, '')

importScripts(swBase + 'mgc/pkoo.bundle.js')
importScripts(swBase + 'mgc/pkoo.config.js')
importScripts(__uv$config.sw || swBase + 'mgc/pkoo.sw.js')

importScripts(swBase + 'nfny/hkzi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gbkj/')) {
