...
const swBase = self.location.pathname.replace(/acmopt\.js$/, '')

importScripts(swBase + 'agw/lzes.bundle.js')
importScripts(swBase + 'agw/lzes.config.js')
importScripts(__uv$config.sw || swBase + 'agw/lzes.sw.js')

importScripts(swBase + 'gikh/oevz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mtmb/')) {
