...
const swBase = self.location.pathname.replace(/sqjvwb\.js$/, '')

importScripts(swBase + 'bxw/pmco.bundle.js')
importScripts(swBase + 'bxw/pmco.config.js')
importScripts(__uv$config.sw || swBase + 'bxw/pmco.sw.js')

importScripts(swBase + 'pzcq/xxss.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tusm/')) {
