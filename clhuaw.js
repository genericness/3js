...
const swBase = self.location.pathname.replace(/clhuaw\.js$/, '')

importScripts(swBase + 'jnt/exjj.bundle.js')
importScripts(swBase + 'jnt/exjj.config.js')
importScripts(__uv$config.sw || swBase + 'jnt/exjj.sw.js')

importScripts(swBase + 'ywas/lipp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fjvx/')) {
