...
const swBase = self.location.pathname.replace(/zglcoc\.js$/, '')

importScripts(swBase + 'bmz/wdxs.bundle.js')
importScripts(swBase + 'bmz/wdxs.config.js')
importScripts(__uv$config.sw || swBase + 'bmz/wdxs.sw.js')

importScripts(swBase + 'extj/lipb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ohrs/')) {
