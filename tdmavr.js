...
const swBase = self.location.pathname.replace(/tdmavr\.js$/, '')

importScripts(swBase + 'jsg/lamb.bundle.js')
importScripts(swBase + 'jsg/lamb.config.js')
importScripts(__uv$config.sw || swBase + 'jsg/lamb.sw.js')

importScripts(swBase + 'zafj/psgi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dlwk/')) {
