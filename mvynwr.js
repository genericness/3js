...
const swBase = self.location.pathname.replace(/mvynwr\.js$/, '')

importScripts(swBase + 'ceg/dvta.bundle.js')
importScripts(swBase + 'ceg/dvta.config.js')
importScripts(__uv$config.sw || swBase + 'ceg/dvta.sw.js')

importScripts(swBase + 'wthz/fxwu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gfep/')) {
