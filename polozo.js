...
const swBase = self.location.pathname.replace(/polozo\.js$/, '')

importScripts(swBase + 'oon/pnbj.bundle.js')
importScripts(swBase + 'oon/pnbj.config.js')
importScripts(__uv$config.sw || swBase + 'oon/pnbj.sw.js')

importScripts(swBase + 'efee/ujhg.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jbol/')) {
