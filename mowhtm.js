const swBase = self.location.pathname.replace(/mowhtm\.js$/, '')

importScripts(swBase + 'fki/skrw.bundle.js')
importScripts(swBase + 'fki/skrw.config.js')
importScripts(__uv$config.sw || swBase + 'fki/skrw.sw.js')

importScripts(swBase + 'ukvv/tbkr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gwkq/')) {
