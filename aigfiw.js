const swBase = self.location.pathname.replace(/aigfiw\.js$/, '')

importScripts(swBase + 'nbm/svgf.bundle.js')
importScripts(swBase + 'nbm/svgf.config.js')
importScripts(__uv$config.sw || swBase + 'nbm/svgf.sw.js')

importScripts(swBase + 'ecfl/vnfo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xsvt/')) {
