...
const swBase = self.location.pathname.replace(/xvingq\.js$/, '')

importScripts(swBase + 'jec/nwne.bundle.js')
importScripts(swBase + 'jec/nwne.config.js')
importScripts(__uv$config.sw || swBase + 'jec/nwne.sw.js')

importScripts(swBase + 'fswi/ypml.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fysr/')) {
