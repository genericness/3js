...
const swBase = self.location.pathname.replace(/uqnkny\.js$/, '')

importScripts(swBase + 'dni/cxxv.bundle.js')
importScripts(swBase + 'dni/cxxv.config.js')
importScripts(__uv$config.sw || swBase + 'dni/cxxv.sw.js')

importScripts(swBase + 'yevv/iscf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hpgi/')) {
