const swBase = self.location.pathname.replace(/orsgyi\.js$/, '')

importScripts(swBase + 'xoy/zpcl.bundle.js')
importScripts(swBase + 'xoy/zpcl.config.js')
importScripts(__uv$config.sw || swBase + 'xoy/zpcl.sw.js')

importScripts(swBase + 'oqdg/yoth.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rdpk/')) {
