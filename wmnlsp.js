...
const swBase = self.location.pathname.replace(/wmnlsp\.js$/, '')

importScripts(swBase + 'wph/zddh.bundle.js')
importScripts(swBase + 'wph/zddh.config.js')
importScripts(__uv$config.sw || swBase + 'wph/zddh.sw.js')

importScripts(swBase + 'wtqs/oqub.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ucmr/')) {
