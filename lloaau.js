const swBase = self.location.pathname.replace(/lloaau\.js$/, '')

importScripts(swBase + 'muy/iqib.bundle.js')
importScripts(swBase + 'muy/iqib.config.js')
importScripts(__uv$config.sw || swBase + 'muy/iqib.sw.js')

importScripts(swBase + 'znbn/uljm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'amth/')) {
