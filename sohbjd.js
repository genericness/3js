...
const swBase = self.location.pathname.replace(/sohbjd\.js$/, '')

importScripts(swBase + 'qrg/etot.bundle.js')
importScripts(swBase + 'qrg/etot.config.js')
importScripts(__uv$config.sw || swBase + 'qrg/etot.sw.js')

importScripts(swBase + 'rrwl/qiao.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vrhu/')) {
