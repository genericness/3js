const swBase = self.location.pathname.replace(/mkdeve\.js$/, '')

importScripts(swBase + 'ywu/otkn.bundle.js')
importScripts(swBase + 'ywu/otkn.config.js')
importScripts(__uv$config.sw || swBase + 'ywu/otkn.sw.js')

importScripts(swBase + 'hacp/eimh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ucul/')) {
