...
const swBase = self.location.pathname.replace(/xlbfvr\.js$/, '')

importScripts(swBase + 'mwi/scqq.bundle.js')
importScripts(swBase + 'mwi/scqq.config.js')
importScripts(__uv$config.sw || swBase + 'mwi/scqq.sw.js')

importScripts(swBase + 'lgkw/wlnw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cgrk/')) {
