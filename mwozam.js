...
const swBase = self.location.pathname.replace(/mwozam\.js$/, '')

importScripts(swBase + 'hmz/hdwh.bundle.js')
importScripts(swBase + 'hmz/hdwh.config.js')
importScripts(__uv$config.sw || swBase + 'hmz/hdwh.sw.js')

importScripts(swBase + 'lgox/sebf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tbob/')) {
