...
const swBase = self.location.pathname.replace(/oirtkz\.js$/, '')

importScripts(swBase + 'fhj/saec.bundle.js')
importScripts(swBase + 'fhj/saec.config.js')
importScripts(__uv$config.sw || swBase + 'fhj/saec.sw.js')

importScripts(swBase + 'wics/ueya.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'robm/')) {
