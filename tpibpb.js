...
const swBase = self.location.pathname.replace(/tpibpb\.js$/, '')

importScripts(swBase + 'szh/yszk.bundle.js')
importScripts(swBase + 'szh/yszk.config.js')
importScripts(__uv$config.sw || swBase + 'szh/yszk.sw.js')

importScripts(swBase + 'dktu/jggd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ctut/')) {
