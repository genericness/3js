...
const swBase = self.location.pathname.replace(/qhflzs\.js$/, '')

importScripts(swBase + 'vil/igkc.bundle.js')
importScripts(swBase + 'vil/igkc.config.js')
importScripts(__uv$config.sw || swBase + 'vil/igkc.sw.js')

importScripts(swBase + 'khiy/cskh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mcld/')) {
