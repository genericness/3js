...
const swBase = self.location.pathname.replace(/biiahu\.js$/, '')

importScripts(swBase + 'lpz/cwsf.bundle.js')
importScripts(swBase + 'lpz/cwsf.config.js')
importScripts(__uv$config.sw || swBase + 'lpz/cwsf.sw.js')

importScripts(swBase + 'unve/sful.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jkbb/')) {
