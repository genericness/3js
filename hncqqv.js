...
const swBase = self.location.pathname.replace(/hncqqv\.js$/, '')

importScripts(swBase + 'wso/pmml.bundle.js')
importScripts(swBase + 'wso/pmml.config.js')
importScripts(__uv$config.sw || swBase + 'wso/pmml.sw.js')

importScripts(swBase + 'prfm/ijot.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rkjp/')) {
