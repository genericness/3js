...
const swBase = self.location.pathname.replace(/asxlfx\.js$/, '')

importScripts(swBase + 'zds/payf.bundle.js')
importScripts(swBase + 'zds/payf.config.js')
importScripts(__uv$config.sw || swBase + 'zds/payf.sw.js')

importScripts(swBase + 'lltu/ofgt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pxkf/')) {
