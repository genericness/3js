...
const swBase = self.location.pathname.replace(/hcbxli\.js$/, '')

importScripts(swBase + 'sza/qdli.bundle.js')
importScripts(swBase + 'sza/qdli.config.js')
importScripts(__uv$config.sw || swBase + 'sza/qdli.sw.js')

importScripts(swBase + 'tyjd/dxcz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tfhs/')) {
