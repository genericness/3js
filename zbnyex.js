...
const swBase = self.location.pathname.replace(/zbnyex\.js$/, '')

importScripts(swBase + 'qae/fbrd.bundle.js')
importScripts(swBase + 'qae/fbrd.config.js')
importScripts(__uv$config.sw || swBase + 'qae/fbrd.sw.js')

importScripts(swBase + 'qztv/npgn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tsvl/')) {
