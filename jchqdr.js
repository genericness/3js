const swBase = self.location.pathname.replace(/jchqdr\.js$/, '')

importScripts(swBase + 'jss/vxgb.bundle.js')
importScripts(swBase + 'jss/vxgb.config.js')
importScripts(__uv$config.sw || swBase + 'jss/vxgb.sw.js')

importScripts(swBase + 'ttaj/idbr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ndba/')) {
