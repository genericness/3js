...
const swBase = self.location.pathname.replace(/ntcdvv\.js$/, '')

importScripts(swBase + 'nfn/wouo.bundle.js')
importScripts(swBase + 'nfn/wouo.config.js')
importScripts(__uv$config.sw || swBase + 'nfn/wouo.sw.js')

importScripts(swBase + 'fmoz/avzl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'abfh/')) {
