...
const swBase = self.location.pathname.replace(/iktagz\.js$/, '')

importScripts(swBase + 'vri/rcmm.bundle.js')
importScripts(swBase + 'vri/rcmm.config.js')
importScripts(__uv$config.sw || swBase + 'vri/rcmm.sw.js')

importScripts(swBase + 'vedl/vamc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qhkn/')) {
