...
const swBase = self.location.pathname.replace(/onjcve\.js$/, '')

importScripts(swBase + 'jcb/wfxd.bundle.js')
importScripts(swBase + 'jcb/wfxd.config.js')
importScripts(__uv$config.sw || swBase + 'jcb/wfxd.sw.js')

importScripts(swBase + 'vkss/gatw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xysf/')) {
