...
const swBase = self.location.pathname.replace(/awwpzk\.js$/, '')

importScripts(swBase + 'pgx/pmaw.bundle.js')
importScripts(swBase + 'pgx/pmaw.config.js')
importScripts(__uv$config.sw || swBase + 'pgx/pmaw.sw.js')

importScripts(swBase + 'gytd/jngv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kfof/')) {
