...
const swBase = self.location.pathname.replace(/vltfnt\.js$/, '')

importScripts(swBase + 'nqa/ilxp.bundle.js')
importScripts(swBase + 'nqa/ilxp.config.js')
importScripts(__uv$config.sw || swBase + 'nqa/ilxp.sw.js')

importScripts(swBase + 'qgsf/kiwn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'birf/')) {
