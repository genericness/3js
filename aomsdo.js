...
const swBase = self.location.pathname.replace(/aomsdo\.js$/, '')

importScripts(swBase + 'mpz/lsai.bundle.js')
importScripts(swBase + 'mpz/lsai.config.js')
importScripts(__uv$config.sw || swBase + 'mpz/lsai.sw.js')

importScripts(swBase + 'lwnn/vlir.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kyfs/')) {
