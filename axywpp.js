const swBase = self.location.pathname.replace(/axywpp\.js$/, '')

importScripts(swBase + 'bxu/olft.bundle.js')
importScripts(swBase + 'bxu/olft.config.js')
importScripts(__uv$config.sw || swBase + 'bxu/olft.sw.js')

importScripts(swBase + 'rqib/dzwz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'foms/')) {
