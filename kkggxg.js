...
const swBase = self.location.pathname.replace(/kkggxg\.js$/, '')

importScripts(swBase + 'mkm/cazt.bundle.js')
importScripts(swBase + 'mkm/cazt.config.js')
importScripts(__uv$config.sw || swBase + 'mkm/cazt.sw.js')

importScripts(swBase + 'ywnr/wnmc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cnkq/')) {
