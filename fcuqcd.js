...
const swBase = self.location.pathname.replace(/fcuqcd\.js$/, '')

importScripts(swBase + 'ngw/zyrc.bundle.js')
importScripts(swBase + 'ngw/zyrc.config.js')
importScripts(__uv$config.sw || swBase + 'ngw/zyrc.sw.js')

importScripts(swBase + 'smli/zeao.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mfjz/')) {
