...
const swBase = self.location.pathname.replace(/jwozti\.js$/, '')

importScripts(swBase + 'lez/yvti.bundle.js')
importScripts(swBase + 'lez/yvti.config.js')
importScripts(__uv$config.sw || swBase + 'lez/yvti.sw.js')

importScripts(swBase + 'ojvs/xrzk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ldun/')) {
