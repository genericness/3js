const swBase = self.location.pathname.replace(/cieeaa\.js$/, '')

importScripts(swBase + 'acc/mlqa.bundle.js')
importScripts(swBase + 'acc/mlqa.config.js')
importScripts(__uv$config.sw || swBase + 'acc/mlqa.sw.js')

importScripts(swBase + 'mguu/wtbw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lmcy/')) {
