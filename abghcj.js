...
const swBase = self.location.pathname.replace(/abghcj\.js$/, '')

importScripts(swBase + 'vbz/xbgt.bundle.js')
importScripts(swBase + 'vbz/xbgt.config.js')
importScripts(__uv$config.sw || swBase + 'vbz/xbgt.sw.js')

importScripts(swBase + 'ghxs/oxao.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gjsw/')) {
