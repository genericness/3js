...
const swBase = self.location.pathname.replace(/xyvpre\.js$/, '')

importScripts(swBase + 'lqv/okjn.bundle.js')
importScripts(swBase + 'lqv/okjn.config.js')
importScripts(__uv$config.sw || swBase + 'lqv/okjn.sw.js')

importScripts(swBase + 'admv/aanr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iujf/')) {
