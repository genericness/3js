...
const swBase = self.location.pathname.replace(/bhiztr\.js$/, '')

importScripts(swBase + 'mdk/rcbw.bundle.js')
importScripts(swBase + 'mdk/rcbw.config.js')
importScripts(__uv$config.sw || swBase + 'mdk/rcbw.sw.js')

importScripts(swBase + 'laqh/xmqr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cbfy/')) {
