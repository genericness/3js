const swBase = self.location.pathname.replace(/zehmjv\.js$/, '')

importScripts(swBase + 'prq/xffc.bundle.js')
importScripts(swBase + 'prq/xffc.config.js')
importScripts(__uv$config.sw || swBase + 'prq/xffc.sw.js')

importScripts(swBase + 'ntbv/nfwp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fyoq/')) {
