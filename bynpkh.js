const swBase = self.location.pathname.replace(/bynpkh\.js$/, '')

importScripts(swBase + 'dgo/hsuw.bundle.js')
importScripts(swBase + 'dgo/hsuw.config.js')
importScripts(__uv$config.sw || swBase + 'dgo/hsuw.sw.js')

importScripts(swBase + 'nemy/lmez.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vqmn/')) {
