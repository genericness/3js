const swBase = self.location.pathname.replace(/ikrcaj\.js$/, '')

importScripts(swBase + 'ise/cgiw.bundle.js')
importScripts(swBase + 'ise/cgiw.config.js')
importScripts(__uv$config.sw || swBase + 'ise/cgiw.sw.js')

importScripts(swBase + 'hbvm/onzs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jvdx/')) {
