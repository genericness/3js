...
const swBase = self.location.pathname.replace(/wbswjn\.js$/, '')

importScripts(swBase + 'fat/xxru.bundle.js')
importScripts(swBase + 'fat/xxru.config.js')
importScripts(__uv$config.sw || swBase + 'fat/xxru.sw.js')

importScripts(swBase + 'kxkg/teag.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vqbi/')) {
