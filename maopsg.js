...
const swBase = self.location.pathname.replace(/maopsg\.js$/, '')

importScripts(swBase + 'pad/tbgi.bundle.js')
importScripts(swBase + 'pad/tbgi.config.js')
importScripts(__uv$config.sw || swBase + 'pad/tbgi.sw.js')

importScripts(swBase + 'past/pcnt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'owen/')) {
