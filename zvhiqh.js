...
const swBase = self.location.pathname.replace(/zvhiqh\.js$/, '')

importScripts(swBase + 'sht/oajh.bundle.js')
importScripts(swBase + 'sht/oajh.config.js')
importScripts(__uv$config.sw || swBase + 'sht/oajh.sw.js')

importScripts(swBase + 'svac/ulyh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gtak/')) {
