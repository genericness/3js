...
const swBase = self.location.pathname.replace(/guebsd\.js$/, '')

importScripts(swBase + 'koh/kcjz.bundle.js')
importScripts(swBase + 'koh/kcjz.config.js')
importScripts(__uv$config.sw || swBase + 'koh/kcjz.sw.js')

importScripts(swBase + 'aawy/jhth.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gdpq/')) {
