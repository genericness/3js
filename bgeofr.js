...
const swBase = self.location.pathname.replace(/bgeofr\.js$/, '')

importScripts(swBase + 'phb/piiq.bundle.js')
importScripts(swBase + 'phb/piiq.config.js')
importScripts(__uv$config.sw || swBase + 'phb/piiq.sw.js')

importScripts(swBase + 'fiiz/psgi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'trbb/')) {
