...
const swBase = self.location.pathname.replace(/pnihzf\.js$/, '')

importScripts(swBase + 'jep/zbsz.bundle.js')
importScripts(swBase + 'jep/zbsz.config.js')
importScripts(__uv$config.sw || swBase + 'jep/zbsz.sw.js')

importScripts(swBase + 'dila/scmj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vuca/')) {
