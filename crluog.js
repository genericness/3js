...
const swBase = self.location.pathname.replace(/crluog\.js$/, '')

importScripts(swBase + 'chf/bdmd.bundle.js')
importScripts(swBase + 'chf/bdmd.config.js')
importScripts(__uv$config.sw || swBase + 'chf/bdmd.sw.js')

importScripts(swBase + 'rvyi/gyrc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pzks/')) {
