...
const swBase = self.location.pathname.replace(/bnozuw\.js$/, '')

importScripts(swBase + 'rmn/hhdy.bundle.js')
importScripts(swBase + 'rmn/hhdy.config.js')
importScripts(__uv$config.sw || swBase + 'rmn/hhdy.sw.js')

importScripts(swBase + 'gspf/xotj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'etis/')) {
