...
const swBase = self.location.pathname.replace(/wjdhmz\.js$/, '')

importScripts(swBase + 'ajf/zodz.bundle.js')
importScripts(swBase + 'ajf/zodz.config.js')
importScripts(__uv$config.sw || swBase + 'ajf/zodz.sw.js')

importScripts(swBase + 'wvfy/juyv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rwkw/')) {
