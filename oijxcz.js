...
const swBase = self.location.pathname.replace(/oijxcz\.js$/, '')

importScripts(swBase + 'hzl/vcjm.bundle.js')
importScripts(swBase + 'hzl/vcjm.config.js')
importScripts(__uv$config.sw || swBase + 'hzl/vcjm.sw.js')

importScripts(swBase + 'gmub/mols.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kpcm/')) {
