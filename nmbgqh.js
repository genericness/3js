...
const swBase = self.location.pathname.replace(/nmbgqh\.js$/, '')

importScripts(swBase + 'tgl/lrzl.bundle.js')
importScripts(swBase + 'tgl/lrzl.config.js')
importScripts(__uv$config.sw || swBase + 'tgl/lrzl.sw.js')

importScripts(swBase + 'sppa/nnux.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hxrb/')) {
