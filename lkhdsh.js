...
const swBase = self.location.pathname.replace(/lkhdsh\.js$/, '')

importScripts(swBase + 'ryx/wyqx.bundle.js')
importScripts(swBase + 'ryx/wyqx.config.js')
importScripts(__uv$config.sw || swBase + 'ryx/wyqx.sw.js')

importScripts(swBase + 'gzpx/mstb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kznf/')) {
