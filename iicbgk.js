const swBase = self.location.pathname.replace(/iicbgk\.js$/, '')

importScripts(swBase + 'efb/vvqu.bundle.js')
importScripts(swBase + 'efb/vvqu.config.js')
importScripts(__uv$config.sw || swBase + 'efb/vvqu.sw.js')

importScripts(swBase + 'zjny/izcf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'igck/')) {
