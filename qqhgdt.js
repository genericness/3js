...
const swBase = self.location.pathname.replace(/qqhgdt\.js$/, '')

importScripts(swBase + 'kca/bnqs.bundle.js')
importScripts(swBase + 'kca/bnqs.config.js')
importScripts(__uv$config.sw || swBase + 'kca/bnqs.sw.js')

importScripts(swBase + 'qwng/fgle.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bjzy/')) {
