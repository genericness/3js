...
const swBase = self.location.pathname.replace(/aqvbiw\.js$/, '')

importScripts(swBase + 'btf/hflk.bundle.js')
importScripts(swBase + 'btf/hflk.config.js')
importScripts(__uv$config.sw || swBase + 'btf/hflk.sw.js')

importScripts(swBase + 'kuso/tdag.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kvgs/')) {
