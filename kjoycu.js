...
const swBase = self.location.pathname.replace(/kjoycu\.js$/, '')

importScripts(swBase + 'txh/umte.bundle.js')
importScripts(swBase + 'txh/umte.config.js')
importScripts(__uv$config.sw || swBase + 'txh/umte.sw.js')

importScripts(swBase + 'jrbi/wxxf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'swvc/')) {
