...
const swBase = self.location.pathname.replace(/qbwdap\.js$/, '')

importScripts(swBase + 'bum/tmai.bundle.js')
importScripts(swBase + 'bum/tmai.config.js')
importScripts(__uv$config.sw || swBase + 'bum/tmai.sw.js')

importScripts(swBase + 'blmi/adjn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gwyt/')) {
