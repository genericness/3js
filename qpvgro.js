...
const swBase = self.location.pathname.replace(/qpvgro\.js$/, '')

importScripts(swBase + 'htp/nvix.bundle.js')
importScripts(swBase + 'htp/nvix.config.js')
importScripts(__uv$config.sw || swBase + 'htp/nvix.sw.js')

importScripts(swBase + 'wdkz/iekf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ezej/')) {
