const swBase = self.location.pathname.replace(/ieifvf\.js$/, '')

importScripts(swBase + 'szw/porl.bundle.js')
importScripts(swBase + 'szw/porl.config.js')
importScripts(__uv$config.sw || swBase + 'szw/porl.sw.js')

importScripts(swBase + 'rtzl/whcc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'saka/')) {
