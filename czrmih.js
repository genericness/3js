...
const swBase = self.location.pathname.replace(/czrmih\.js$/, '')

importScripts(swBase + 'rng/hnjv.bundle.js')
importScripts(swBase + 'rng/hnjv.config.js')
importScripts(__uv$config.sw || swBase + 'rng/hnjv.sw.js')

importScripts(swBase + 'rkhq/dlmb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qjuk/')) {
