...
const swBase = self.location.pathname.replace(/cblyho\.js$/, '')

importScripts(swBase + 'giu/yibf.bundle.js')
importScripts(swBase + 'giu/yibf.config.js')
importScripts(__uv$config.sw || swBase + 'giu/yibf.sw.js')

importScripts(swBase + 'shrz/crhi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oudl/')) {
