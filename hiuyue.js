...
const swBase = self.location.pathname.replace(/hiuyue\.js$/, '')

importScripts(swBase + 'oko/empl.bundle.js')
importScripts(swBase + 'oko/empl.config.js')
importScripts(__uv$config.sw || swBase + 'oko/empl.sw.js')

importScripts(swBase + 'cggr/nkfu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'irqo/')) {
