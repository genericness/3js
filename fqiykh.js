...
const swBase = self.location.pathname.replace(/fqiykh\.js$/, '')

importScripts(swBase + 'uyn/eaww.bundle.js')
importScripts(swBase + 'uyn/eaww.config.js')
importScripts(__uv$config.sw || swBase + 'uyn/eaww.sw.js')

importScripts(swBase + 'kfag/eshs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jire/')) {
