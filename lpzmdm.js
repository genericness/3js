...
const swBase = self.location.pathname.replace(/lpzmdm\.js$/, '')

importScripts(swBase + 'skx/dmdd.bundle.js')
importScripts(swBase + 'skx/dmdd.config.js')
importScripts(__uv$config.sw || swBase + 'skx/dmdd.sw.js')

importScripts(swBase + 'pnqi/ibpq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rztb/')) {
