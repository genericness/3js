...
const swBase = self.location.pathname.replace(/lcckxf\.js$/, '')

importScripts(swBase + 'qni/krxw.bundle.js')
importScripts(swBase + 'qni/krxw.config.js')
importScripts(__uv$config.sw || swBase + 'qni/krxw.sw.js')

importScripts(swBase + 'aink/roum.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ggom/')) {
