...
const swBase = self.location.pathname.replace(/pvuifw\.js$/, '')

importScripts(swBase + 'uyt/shal.bundle.js')
importScripts(swBase + 'uyt/shal.config.js')
importScripts(__uv$config.sw || swBase + 'uyt/shal.sw.js')

importScripts(swBase + 'jegq/pxzw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qspz/')) {
