...
const swBase = self.location.pathname.replace(/obkrpd\.js$/, '')

importScripts(swBase + 'bgf/upqs.bundle.js')
importScripts(swBase + 'bgf/upqs.config.js')
importScripts(__uv$config.sw || swBase + 'bgf/upqs.sw.js')

importScripts(swBase + 'kwaw/vbws.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ndbc/')) {
