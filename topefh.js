...
const swBase = self.location.pathname.replace(/topefh\.js$/, '')

importScripts(swBase + 'ipp/byeu.bundle.js')
importScripts(swBase + 'ipp/byeu.config.js')
importScripts(__uv$config.sw || swBase + 'ipp/byeu.sw.js')

importScripts(swBase + 'kzea/gcfc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pqmi/')) {
