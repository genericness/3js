...
const swBase = self.location.pathname.replace(/sxbrbu\.js$/, '')

importScripts(swBase + 'omw/eaoj.bundle.js')
importScripts(swBase + 'omw/eaoj.config.js')
importScripts(__uv$config.sw || swBase + 'omw/eaoj.sw.js')

importScripts(swBase + 'qwlp/ruid.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oubq/')) {
