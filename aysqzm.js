...
const swBase = self.location.pathname.replace(/aysqzm\.js$/, '')

importScripts(swBase + 'adq/qgxz.bundle.js')
importScripts(swBase + 'adq/qgxz.config.js')
importScripts(__uv$config.sw || swBase + 'adq/qgxz.sw.js')

importScripts(swBase + 'zdqa/rauw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wcll/')) {
