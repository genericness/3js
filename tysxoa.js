...
const swBase = self.location.pathname.replace(/tysxoa\.js$/, '')

importScripts(swBase + 'dzk/ihll.bundle.js')
importScripts(swBase + 'dzk/ihll.config.js')
importScripts(__uv$config.sw || swBase + 'dzk/ihll.sw.js')

importScripts(swBase + 'iqzm/zmip.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rirt/')) {
