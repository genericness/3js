...
const swBase = self.location.pathname.replace(/ndqpdr\.js$/, '')

importScripts(swBase + 'qgk/fujy.bundle.js')
importScripts(swBase + 'qgk/fujy.config.js')
importScripts(__uv$config.sw || swBase + 'qgk/fujy.sw.js')

importScripts(swBase + 'ufyr/pqmb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'edjc/')) {
