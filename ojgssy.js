...
const swBase = self.location.pathname.replace(/ojgssy\.js$/, '')

importScripts(swBase + 'tqz/gymr.bundle.js')
importScripts(swBase + 'tqz/gymr.config.js')
importScripts(__uv$config.sw || swBase + 'tqz/gymr.sw.js')

importScripts(swBase + 'bjpe/cpkf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'suqk/')) {
