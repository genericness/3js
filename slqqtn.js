...
const swBase = self.location.pathname.replace(/slqqtn\.js$/, '')

importScripts(swBase + 'bjb/fpcy.bundle.js')
importScripts(swBase + 'bjb/fpcy.config.js')
importScripts(__uv$config.sw || swBase + 'bjb/fpcy.sw.js')

importScripts(swBase + 'kpna/caqx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bmws/')) {
