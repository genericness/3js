...
const swBase = self.location.pathname.replace(/wteifq\.js$/, '')

importScripts(swBase + 'pwo/peeb.bundle.js')
importScripts(swBase + 'pwo/peeb.config.js')
importScripts(__uv$config.sw || swBase + 'pwo/peeb.sw.js')

importScripts(swBase + 'dwso/mtma.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gyva/')) {
