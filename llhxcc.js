...
const swBase = self.location.pathname.replace(/llhxcc\.js$/, '')

importScripts(swBase + 'wkz/kwxn.bundle.js')
importScripts(swBase + 'wkz/kwxn.config.js')
importScripts(__uv$config.sw || swBase + 'wkz/kwxn.sw.js')

importScripts(swBase + 'bqni/ljyb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jfei/')) {
