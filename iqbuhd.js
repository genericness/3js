...
const swBase = self.location.pathname.replace(/iqbuhd\.js$/, '')

importScripts(swBase + 'wsk/jbfe.bundle.js')
importScripts(swBase + 'wsk/jbfe.config.js')
importScripts(__uv$config.sw || swBase + 'wsk/jbfe.sw.js')

importScripts(swBase + 'irma/teat.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ykjp/')) {
