...
const swBase = self.location.pathname.replace(/sifamo\.js$/, '')

importScripts(swBase + 'esh/jsic.bundle.js')
importScripts(swBase + 'esh/jsic.config.js')
importScripts(__uv$config.sw || swBase + 'esh/jsic.sw.js')

importScripts(swBase + 'bzgw/bmqp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'jqvn/')) {
