const swBase = self.location.pathname.replace(/lprdbi\.js$/, '')

importScripts(swBase + 'nqo/cqmx.bundle.js')
importScripts(swBase + 'nqo/cqmx.config.js')
importScripts(__uv$config.sw || swBase + 'nqo/cqmx.sw.js')

importScripts(swBase + 'fhzc/mxbt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qzui/')) {
