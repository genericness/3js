...
const swBase = self.location.pathname.replace(/jobsyg\.js$/, '')

importScripts(swBase + 'csq/lqpd.bundle.js')
importScripts(swBase + 'csq/lqpd.config.js')
importScripts(__uv$config.sw || swBase + 'csq/lqpd.sw.js')

importScripts(swBase + 'snmh/ight.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pqxw/')) {
