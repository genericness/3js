...
const swBase = self.location.pathname.replace(/fvlvpr\.js$/, '')

importScripts(swBase + 'kqs/xllf.bundle.js')
importScripts(swBase + 'kqs/xllf.config.js')
importScripts(__uv$config.sw || swBase + 'kqs/xllf.sw.js')

importScripts(swBase + 'rpmg/bigd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'afna/')) {
