...
const swBase = self.location.pathname.replace(/tclfbc\.js$/, '')

importScripts(swBase + 'zuw/lole.bundle.js')
importScripts(swBase + 'zuw/lole.config.js')
importScripts(__uv$config.sw || swBase + 'zuw/lole.sw.js')

importScripts(swBase + 'qnsu/blsy.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qdxy/')) {
