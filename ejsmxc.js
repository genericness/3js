...
const swBase = self.location.pathname.replace(/ejsmxc\.js$/, '')

importScripts(swBase + 'fvl/jhzv.bundle.js')
importScripts(swBase + 'fvl/jhzv.config.js')
importScripts(__uv$config.sw || swBase + 'fvl/jhzv.sw.js')

importScripts(swBase + 'wfza/iati.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rvdf/')) {
