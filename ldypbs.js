...
const swBase = self.location.pathname.replace(/ldypbs\.js$/, '')

importScripts(swBase + 'eta/uekq.bundle.js')
importScripts(swBase + 'eta/uekq.config.js')
importScripts(__uv$config.sw || swBase + 'eta/uekq.sw.js')

importScripts(swBase + 'tidt/sogf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'woax/')) {
