...
const swBase = self.location.pathname.replace(/dvkabw\.js$/, '')

importScripts(swBase + 'ipa/fsrp.bundle.js')
importScripts(swBase + 'ipa/fsrp.config.js')
importScripts(__uv$config.sw || swBase + 'ipa/fsrp.sw.js')

importScripts(swBase + 'ycbz/ixms.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tmlu/')) {
