...
const swBase = self.location.pathname.replace(/qvaobv\.js$/, '')

importScripts(swBase + 'sjh/bzyi.bundle.js')
importScripts(swBase + 'sjh/bzyi.config.js')
importScripts(__uv$config.sw || swBase + 'sjh/bzyi.sw.js')

importScripts(swBase + 'vrgw/hvzn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zmuc/')) {
