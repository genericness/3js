...
const swBase = self.location.pathname.replace(/tbkwdq\.js$/, '')

importScripts(swBase + 'ugq/qpmx.bundle.js')
importScripts(swBase + 'ugq/qpmx.config.js')
importScripts(__uv$config.sw || swBase + 'ugq/qpmx.sw.js')

importScripts(swBase + 'bayp/wndb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'eldz/')) {
