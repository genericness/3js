...
const swBase = self.location.pathname.replace(/ybuucz\.js$/, '')

importScripts(swBase + 'hna/fujq.bundle.js')
importScripts(swBase + 'hna/fujq.config.js')
importScripts(__uv$config.sw || swBase + 'hna/fujq.sw.js')

importScripts(swBase + 'ybbr/rigm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hyzk/')) {
