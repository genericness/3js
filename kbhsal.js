...
const swBase = self.location.pathname.replace(/kbhsal\.js$/, '')

importScripts(swBase + 'lxw/pzhg.bundle.js')
importScripts(swBase + 'lxw/pzhg.config.js')
importScripts(__uv$config.sw || swBase + 'lxw/pzhg.sw.js')

importScripts(swBase + 'jyji/kbzu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'dpqn/')) {
