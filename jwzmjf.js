...
const swBase = self.location.pathname.replace(/jwzmjf\.js$/, '')

importScripts(swBase + 'xpk/jsxm.bundle.js')
importScripts(swBase + 'xpk/jsxm.config.js')
importScripts(__uv$config.sw || swBase + 'xpk/jsxm.sw.js')

importScripts(swBase + 'xlqc/msxs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nyhg/')) {
