...
const swBase = self.location.pathname.replace(/nyoheu\.js$/, '')

importScripts(swBase + 'trg/zvac.bundle.js')
importScripts(swBase + 'trg/zvac.config.js')
importScripts(__uv$config.sw || swBase + 'trg/zvac.sw.js')

importScripts(swBase + 'gmjc/kroa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ujle/')) {
