...
const swBase = self.location.pathname.replace(/cwaqrz\.js$/, '')

importScripts(swBase + 'myx/epzw.bundle.js')
importScripts(swBase + 'myx/epzw.config.js')
importScripts(__uv$config.sw || swBase + 'myx/epzw.sw.js')

importScripts(swBase + 'pdkf/budv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pyml/')) {
