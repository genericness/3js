...
const swBase = self.location.pathname.replace(/objdgt\.js$/, '')

importScripts(swBase + 'odt/zlco.bundle.js')
importScripts(swBase + 'odt/zlco.config.js')
importScripts(__uv$config.sw || swBase + 'odt/zlco.sw.js')

importScripts(swBase + 'qhls/vlab.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gmec/')) {
