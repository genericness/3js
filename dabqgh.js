...
const swBase = self.location.pathname.replace(/dabqgh\.js$/, '')

importScripts(swBase + 'lkq/gwlh.bundle.js')
importScripts(swBase + 'lkq/gwlh.config.js')
importScripts(__uv$config.sw || swBase + 'lkq/gwlh.sw.js')

importScripts(swBase + 'joxd/vxor.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xcrz/')) {
