...
const swBase = self.location.pathname.replace(/payvxt\.js$/, '')

importScripts(swBase + 'vjv/rduh.bundle.js')
importScripts(swBase + 'vjv/rduh.config.js')
importScripts(__uv$config.sw || swBase + 'vjv/rduh.sw.js')

importScripts(swBase + 'vaij/nvsu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hokz/')) {
