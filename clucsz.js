...
const swBase = self.location.pathname.replace(/clucsz\.js$/, '')

importScripts(swBase + 'mrm/ltkr.bundle.js')
importScripts(swBase + 'mrm/ltkr.config.js')
importScripts(__uv$config.sw || swBase + 'mrm/ltkr.sw.js')

importScripts(swBase + 'svdm/oneh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lifq/')) {
