...
const swBase = self.location.pathname.replace(/qobjak\.js$/, '')

importScripts(swBase + 'eln/vezb.bundle.js')
importScripts(swBase + 'eln/vezb.config.js')
importScripts(__uv$config.sw || swBase + 'eln/vezb.sw.js')

importScripts(swBase + 'qqqy/gyyh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fzqy/')) {
