...
const swBase = self.location.pathname.replace(/auwsfc\.js$/, '')

importScripts(swBase + 'tnb/ygaa.bundle.js')
importScripts(swBase + 'tnb/ygaa.config.js')
importScripts(__uv$config.sw || swBase + 'tnb/ygaa.sw.js')

importScripts(swBase + 'aauk/iohl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'fnfn/')) {
