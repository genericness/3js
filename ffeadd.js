...
const swBase = self.location.pathname.replace(/ffeadd\.js$/, '')

importScripts(swBase + 'ehh/qwvq.bundle.js')
importScripts(swBase + 'ehh/qwvq.config.js')
importScripts(__uv$config.sw || swBase + 'ehh/qwvq.sw.js')

importScripts(swBase + 'eykl/fzaq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kuis/')) {
