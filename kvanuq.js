...
const swBase = self.location.pathname.replace(/kvanuq\.js$/, '')

importScripts(swBase + 'pkw/jhbn.bundle.js')
importScripts(swBase + 'pkw/jhbn.config.js')
importScripts(__uv$config.sw || swBase + 'pkw/jhbn.sw.js')

importScripts(swBase + 'ntfc/wyvd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'quga/')) {
