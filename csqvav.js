...
const swBase = self.location.pathname.replace(/csqvav\.js$/, '')

importScripts(swBase + 'ptc/nqhf.bundle.js')
importScripts(swBase + 'ptc/nqhf.config.js')
importScripts(__uv$config.sw || swBase + 'ptc/nqhf.sw.js')

importScripts(swBase + 'hswf/bptu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ddbs/')) {
