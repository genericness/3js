...
const swBase = self.location.pathname.replace(/kvogne\.js$/, '')

importScripts(swBase + 'lsn/dair.bundle.js')
importScripts(swBase + 'lsn/dair.config.js')
importScripts(__uv$config.sw || swBase + 'lsn/dair.sw.js')

importScripts(swBase + 'iosw/ivux.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ffcq/')) {
