const swBase = self.location.pathname.replace(/tcyysj\.js$/, '')

importScripts(swBase + 'jvf/chvq.bundle.js')
importScripts(swBase + 'jvf/chvq.config.js')
importScripts(__uv$config.sw || swBase + 'jvf/chvq.sw.js')

importScripts(swBase + 'bccz/alri.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'trjw/')) {
