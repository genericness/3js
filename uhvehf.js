...
const swBase = self.location.pathname.replace(/uhvehf\.js$/, '')

importScripts(swBase + 'rbj/euyu.bundle.js')
importScripts(swBase + 'rbj/euyu.config.js')
importScripts(__uv$config.sw || swBase + 'rbj/euyu.sw.js')

importScripts(swBase + 'eyih/egqe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zlch/')) {
