...
const swBase = self.location.pathname.replace(/uzbzxy\.js$/, '')

importScripts(swBase + 'ygj/pbgt.bundle.js')
importScripts(swBase + 'ygj/pbgt.config.js')
importScripts(__uv$config.sw || swBase + 'ygj/pbgt.sw.js')

importScripts(swBase + 'aezl/zlgu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'lbep/')) {
