const swBase = self.location.pathname.replace(/xqlxov\.js$/, '')

importScripts(swBase + 'awx/kkmg.bundle.js')
importScripts(swBase + 'awx/kkmg.config.js')
importScripts(__uv$config.sw || swBase + 'awx/kkmg.sw.js')

importScripts(swBase + 'drmw/lfvs.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nqor/')) {
