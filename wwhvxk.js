...
const swBase = self.location.pathname.replace(/wwhvxk\.js$/, '')

importScripts(swBase + 'cqy/ixnk.bundle.js')
importScripts(swBase + 'cqy/ixnk.config.js')
importScripts(__uv$config.sw || swBase + 'cqy/ixnk.sw.js')

importScripts(swBase + 'hzrp/ksbd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ddbv/')) {
