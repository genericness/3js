...
const swBase = self.location.pathname.replace(/kaznlq\.js$/, '')

importScripts(swBase + 'led/ikog.bundle.js')
importScripts(swBase + 'led/ikog.config.js')
importScripts(__uv$config.sw || swBase + 'led/ikog.sw.js')

importScripts(swBase + 'qshw/fyct.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tfkk/')) {
