...
const swBase = self.location.pathname.replace(/xcqiwc\.js$/, '')

importScripts(swBase + 'wmy/gkpo.bundle.js')
importScripts(swBase + 'wmy/gkpo.config.js')
importScripts(__uv$config.sw || swBase + 'wmy/gkpo.sw.js')

importScripts(swBase + 'qars/iebh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qgby/')) {
