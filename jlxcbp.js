const swBase = self.location.pathname.replace(/jlxcbp\.js$/, '')

importScripts(swBase + 'hbh/bzos.bundle.js')
importScripts(swBase + 'hbh/bzos.config.js')
importScripts(__uv$config.sw || swBase + 'hbh/bzos.sw.js')

importScripts(swBase + 'pnps/vewx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oasy/')) {
