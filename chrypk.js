...
const swBase = self.location.pathname.replace(/chrypk\.js$/, '')

importScripts(swBase + 'ass/untj.bundle.js')
importScripts(swBase + 'ass/untj.config.js')
importScripts(__uv$config.sw || swBase + 'ass/untj.sw.js')

importScripts(swBase + 'kpqa/xchm.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xlwv/')) {
