const swBase = self.location.pathname.replace(/mzybjd\.js$/, '')

importScripts(swBase + 'sxx/lcyq.bundle.js')
importScripts(swBase + 'sxx/lcyq.config.js')
importScripts(__uv$config.sw || swBase + 'sxx/lcyq.sw.js')

importScripts(swBase + 'acfu/ozuu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nfkv/')) {
