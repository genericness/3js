...
const swBase = self.location.pathname.replace(/tzhrkg\.js$/, '')

importScripts(swBase + 'cas/xcne.bundle.js')
importScripts(swBase + 'cas/xcne.config.js')
importScripts(__uv$config.sw || swBase + 'cas/xcne.sw.js')

importScripts(swBase + 'cyne/dzbp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xcqx/')) {
