...
const swBase = self.location.pathname.replace(/svwnpc\.js$/, '')

importScripts(swBase + 'iqz/tmgx.bundle.js')
importScripts(swBase + 'iqz/tmgx.config.js')
importScripts(__uv$config.sw || swBase + 'iqz/tmgx.sw.js')

importScripts(swBase + 'ohjd/ozyt.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'skdx/')) {
