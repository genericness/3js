...
const swBase = self.location.pathname.replace(/vumxbd\.js$/, '')

importScripts(swBase + 'tpu/hypa.bundle.js')
importScripts(swBase + 'tpu/hypa.config.js')
importScripts(__uv$config.sw || swBase + 'tpu/hypa.sw.js')

importScripts(swBase + 'knbz/gnlq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gnfu/')) {
