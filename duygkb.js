...
const swBase = self.location.pathname.replace(/duygkb\.js$/, '')

importScripts(swBase + 'emf/zsfg.bundle.js')
importScripts(swBase + 'emf/zsfg.config.js')
importScripts(__uv$config.sw || swBase + 'emf/zsfg.sw.js')

importScripts(swBase + 'lkhw/weas.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zpdy/')) {
