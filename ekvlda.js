...
const swBase = self.location.pathname.replace(/ekvlda\.js$/, '')

importScripts(swBase + 'ywd/tbzq.bundle.js')
importScripts(swBase + 'ywd/tbzq.config.js')
importScripts(__uv$config.sw || swBase + 'ywd/tbzq.sw.js')

importScripts(swBase + 'lyle/ligp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'cykv/')) {
