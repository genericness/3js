...
const swBase = self.location.pathname.replace(/vxvkxi\.js$/, '')

importScripts(swBase + 'ssz/eyso.bundle.js')
importScripts(swBase + 'ssz/eyso.config.js')
importScripts(__uv$config.sw || swBase + 'ssz/eyso.sw.js')

importScripts(swBase + 'ofuo/lurx.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tdbh/')) {
