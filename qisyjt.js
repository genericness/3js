const swBase = self.location.pathname.replace(/qisyjt\.js$/, '')

importScripts(swBase + 'yxd/tvuo.bundle.js')
importScripts(swBase + 'yxd/tvuo.config.js')
importScripts(__uv$config.sw || swBase + 'yxd/tvuo.sw.js')

importScripts(swBase + 'ftdi/zctz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'otls/')) {
