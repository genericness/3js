const swBase = self.location.pathname.replace(/qlxyrn\.js$/, '')

importScripts(swBase + 'wym/aulg.bundle.js')
importScripts(swBase + 'wym/aulg.config.js')
importScripts(__uv$config.sw || swBase + 'wym/aulg.sw.js')

importScripts(swBase + 'evhx/iglw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'wlio/')) {
