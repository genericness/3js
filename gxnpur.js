...
const swBase = self.location.pathname.replace(/gxnpur\.js$/, '')

importScripts(swBase + 'gjh/txem.bundle.js')
importScripts(swBase + 'gjh/txem.config.js')
importScripts(__uv$config.sw || swBase + 'gjh/txem.sw.js')

importScripts(swBase + 'ndyw/tjmd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vrqh/')) {
