const swBase = self.location.pathname.replace(/mywdtw\.js$/, '')

importScripts(swBase + 'qza/awcn.bundle.js')
importScripts(swBase + 'qza/awcn.config.js')
importScripts(__uv$config.sw || swBase + 'qza/awcn.sw.js')

importScripts(swBase + 'umce/nwpl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uicj/')) {
