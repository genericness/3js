...
const swBase = self.location.pathname.replace(/acwtvg\.js$/, '')

importScripts(swBase + 'tng/ehax.bundle.js')
importScripts(swBase + 'tng/ehax.config.js')
importScripts(__uv$config.sw || swBase + 'tng/ehax.sw.js')

importScripts(swBase + 'bmow/jfjc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'ttig/')) {
