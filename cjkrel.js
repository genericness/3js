...
const swBase = self.location.pathname.replace(/cjkrel\.js$/, '')

importScripts(swBase + 'sam/zsch.bundle.js')
importScripts(swBase + 'sam/zsch.config.js')
importScripts(__uv$config.sw || swBase + 'sam/zsch.sw.js')

importScripts(swBase + 'wotu/ryhh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'knok/')) {
