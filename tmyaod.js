...
const swBase = self.location.pathname.replace(/tmyaod\.js$/, '')

importScripts(swBase + 'ljf/tdeq.bundle.js')
importScripts(swBase + 'ljf/tdeq.config.js')
importScripts(__uv$config.sw || swBase + 'ljf/tdeq.sw.js')

importScripts(swBase + 'uusm/bvxq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gmdw/')) {
