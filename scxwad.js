const swBase = self.location.pathname.replace(/scxwad\.js$/, '')

importScripts(swBase + 'frb/wxya.bundle.js')
importScripts(swBase + 'frb/wxya.config.js')
importScripts(__uv$config.sw || swBase + 'frb/wxya.sw.js')

importScripts(swBase + 'xpjr/jfwe.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nwev/')) {
