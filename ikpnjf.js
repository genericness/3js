const swBase = self.location.pathname.replace(/ikpnjf\.js$/, '')

importScripts(swBase + 'fmv/gpvq.bundle.js')
importScripts(swBase + 'fmv/gpvq.config.js')
importScripts(__uv$config.sw || swBase + 'fmv/gpvq.sw.js')

importScripts(swBase + 'said/txgc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rgjy/')) {
