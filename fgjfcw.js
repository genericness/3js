const swBase = self.location.pathname.replace(/fgjfcw\.js$/, '')

importScripts(swBase + 'cot/vteo.bundle.js')
importScripts(swBase + 'cot/vteo.config.js')
importScripts(__uv$config.sw || swBase + 'cot/vteo.sw.js')

importScripts(swBase + 'gwnu/vchk.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'goif/')) {
