...
const swBase = self.location.pathname.replace(/lvakva\.js$/, '')

importScripts(swBase + 'lex/ttry.bundle.js')
importScripts(swBase + 'lex/ttry.config.js')
importScripts(__uv$config.sw || swBase + 'lex/ttry.sw.js')

importScripts(swBase + 'nhap/ooar.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'uwze/')) {
