...
const swBase = self.location.pathname.replace(/whtvmz\.js$/, '')

importScripts(swBase + 'dxc/ngoq.bundle.js')
importScripts(swBase + 'dxc/ngoq.config.js')
importScripts(__uv$config.sw || swBase + 'dxc/ngoq.sw.js')

importScripts(swBase + 'hxob/qflj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'tidr/')) {
