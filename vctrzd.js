...
const swBase = self.location.pathname.replace(/vctrzd\.js$/, '')

importScripts(swBase + 'ttf/omih.bundle.js')
importScripts(swBase + 'ttf/omih.config.js')
importScripts(__uv$config.sw || swBase + 'ttf/omih.sw.js')

importScripts(swBase + 'naer/eqvz.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'nnbu/')) {
