...
const swBase = self.location.pathname.replace(/nwflyd\.js$/, '')

importScripts(swBase + 'tlu/gjdp.bundle.js')
importScripts(swBase + 'tlu/gjdp.config.js')
importScripts(__uv$config.sw || swBase + 'tlu/gjdp.sw.js')

importScripts(swBase + 'fvqn/enxi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'funw/')) {
