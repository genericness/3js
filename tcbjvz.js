...
const swBase = self.location.pathname.replace(/tcbjvz\.js$/, '')

importScripts(swBase + 'css/cdkt.bundle.js')
importScripts(swBase + 'css/cdkt.config.js')
importScripts(__uv$config.sw || swBase + 'css/cdkt.sw.js')

importScripts(swBase + 'frea/ecug.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'knor/')) {
