const swBase = self.location.pathname.replace(/vkotzo\.js$/, '')

importScripts(swBase + 'rqy/vscz.bundle.js')
importScripts(swBase + 'rqy/vscz.config.js')
importScripts(__uv$config.sw || swBase + 'rqy/vscz.sw.js')

importScripts(swBase + 'etpe/dmtr.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'stld/')) {
