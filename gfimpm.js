...
const swBase = self.location.pathname.replace(/gfimpm\.js$/, '')

importScripts(swBase + 'guc/yoxe.bundle.js')
importScripts(swBase + 'guc/yoxe.config.js')
importScripts(__uv$config.sw || swBase + 'guc/yoxe.sw.js')

importScripts(swBase + 'cbxl/lszo.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mdzg/')) {
