...
const swBase = self.location.pathname.replace(/whqzhd\.js$/, '')

importScripts(swBase + 'eky/hcma.bundle.js')
importScripts(swBase + 'eky/hcma.config.js')
importScripts(__uv$config.sw || swBase + 'eky/hcma.sw.js')

importScripts(swBase + 'vrlt/jolq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bteo/')) {
