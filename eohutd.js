...
const swBase = self.location.pathname.replace(/eohutd\.js$/, '')

importScripts(swBase + 'buh/bouc.bundle.js')
importScripts(swBase + 'buh/bouc.config.js')
importScripts(__uv$config.sw || swBase + 'buh/bouc.sw.js')

importScripts(swBase + 'dtgw/bbpv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'evko/')) {
