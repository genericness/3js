...
const swBase = self.location.pathname.replace(/dywdyi\.js$/, '')

importScripts(swBase + 'hlm/cpju.bundle.js')
importScripts(swBase + 'hlm/cpju.config.js')
importScripts(__uv$config.sw || swBase + 'hlm/cpju.sw.js')

importScripts(swBase + 'jvqd/iirb.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'gxpa/')) {
