...
const swBase = self.location.pathname.replace(/hgjgec\.js$/, '')

importScripts(swBase + 'zoc/oclb.bundle.js')
importScripts(swBase + 'zoc/oclb.config.js')
importScripts(__uv$config.sw || swBase + 'zoc/oclb.sw.js')

importScripts(swBase + 'cnod/kgzw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'flot/')) {
