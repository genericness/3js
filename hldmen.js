...
const swBase = self.location.pathname.replace(/hldmen\.js$/, '')

importScripts(swBase + 'udn/lgrt.bundle.js')
importScripts(swBase + 'udn/lgrt.config.js')
importScripts(__uv$config.sw || swBase + 'udn/lgrt.sw.js')

importScripts(swBase + 'vper/jyuh.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bcuk/')) {
