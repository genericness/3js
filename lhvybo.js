const swBase = self.location.pathname.replace(/lhvybo\.js$/, '')

importScripts(swBase + 'jvj/ebss.bundle.js')
importScripts(swBase + 'jvj/ebss.config.js')
importScripts(__uv$config.sw || swBase + 'jvj/ebss.sw.js')

importScripts(swBase + 'ahea/piuu.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'oxyg/')) {
