const swBase = self.location.pathname.replace(/otypzk\.js$/, '')

importScripts(swBase + 'uyw/rcui.bundle.js')
importScripts(swBase + 'uyw/rcui.config.js')
importScripts(__uv$config.sw || swBase + 'uyw/rcui.sw.js')

importScripts(swBase + 'wbat/qqnv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'bcmr/')) {
