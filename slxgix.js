...
const swBase = self.location.pathname.replace(/slxgix\.js$/, '')

importScripts(swBase + 'lks/hfmp.bundle.js')
importScripts(swBase + 'lks/hfmp.config.js')
importScripts(__uv$config.sw || swBase + 'lks/hfmp.sw.js')

importScripts(swBase + 'cqws/jngl.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'qpvi/')) {
