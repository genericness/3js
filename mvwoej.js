...
const swBase = self.location.pathname.replace(/mvwoej\.js$/, '')

importScripts(swBase + 'mjd/dvpn.bundle.js')
importScripts(swBase + 'mjd/dvpn.config.js')
importScripts(__uv$config.sw || swBase + 'mjd/dvpn.sw.js')

importScripts(swBase + 'dljh/zpxj.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'mzya/')) {
