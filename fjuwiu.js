...
const swBase = self.location.pathname.replace(/fjuwiu\.js$/, '')

importScripts(swBase + 'zrp/vecl.bundle.js')
importScripts(swBase + 'zrp/vecl.config.js')
importScripts(__uv$config.sw || swBase + 'zrp/vecl.sw.js')

importScripts(swBase + 'ljac/muxi.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'hdod/')) {
