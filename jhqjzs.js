...
const swBase = self.location.pathname.replace(/jhqjzs\.js$/, '')

importScripts(swBase + 'zie/flnu.bundle.js')
importScripts(swBase + 'zie/flnu.config.js')
importScripts(__uv$config.sw || swBase + 'zie/flnu.sw.js')

importScripts(swBase + 'dsdi/lcfq.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zubu/')) {
