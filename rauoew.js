const swBase = self.location.pathname.replace(/rauoew\.js$/, '')

importScripts(swBase + 'pmo/knky.bundle.js')
importScripts(swBase + 'pmo/knky.config.js')
importScripts(__uv$config.sw || swBase + 'pmo/knky.sw.js')

importScripts(swBase + 'rtno/nwrw.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'zzps/')) {
