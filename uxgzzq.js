const swBase = self.location.pathname.replace(/uxgzzq\.js$/, '')

importScripts(swBase + 'gxe/xhpn.bundle.js')
importScripts(swBase + 'gxe/xhpn.config.js')
importScripts(__uv$config.sw || swBase + 'gxe/xhpn.sw.js')

importScripts(swBase + 'dlbl/kezn.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'odys/')) {
