const swBase = self.location.pathname.replace(/gwapgg\.js$/, '')

importScripts(swBase + 'jbv/anbb.bundle.js')
importScripts(swBase + 'jbv/anbb.config.js')
importScripts(__uv$config.sw || swBase + 'jbv/anbb.sw.js')

importScripts(swBase + 'vely/hfdf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'pncm/')) {
