...
const swBase = self.location.pathname.replace(/epcqgx\.js$/, '')

importScripts(swBase + 'mge/pppf.bundle.js')
importScripts(swBase + 'mge/pppf.config.js')
importScripts(__uv$config.sw || swBase + 'mge/pppf.sw.js')

importScripts(swBase + 'ibmz/qglv.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'xbgj/')) {
