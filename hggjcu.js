...
const swBase = self.location.pathname.replace(/hggjcu\.js$/, '')

importScripts(swBase + 'blo/ppoj.bundle.js')
importScripts(swBase + 'blo/ppoj.config.js')
importScripts(__uv$config.sw || swBase + 'blo/ppoj.sw.js')

importScripts(swBase + 'xphr/ywyd.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'poyo/')) {
