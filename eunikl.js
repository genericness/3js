...
const swBase = self.location.pathname.replace(/eunikl\.js$/, '')

importScripts(swBase + 'xzq/wubn.bundle.js')
importScripts(swBase + 'xzq/wubn.config.js')
importScripts(__uv$config.sw || swBase + 'xzq/wubn.sw.js')

importScripts(swBase + 'cmpy/uhcf.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'kvjy/')) {
