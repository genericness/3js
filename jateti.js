...
const swBase = self.location.pathname.replace(/jateti\.js$/, '')

importScripts(swBase + 'msy/ygxq.bundle.js')
importScripts(swBase + 'msy/ygxq.config.js')
importScripts(__uv$config.sw || swBase + 'msy/ygxq.sw.js')

importScripts(swBase + 'wpfx/iyhc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'aldk/')) {
