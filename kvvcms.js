const swBase = self.location.pathname.replace(/kvvcms\.js$/, '')

importScripts(swBase + 'abq/smai.bundle.js')
importScripts(swBase + 'abq/smai.config.js')
importScripts(__uv$config.sw || swBase + 'abq/smai.sw.js')

importScripts(swBase + 'ovtr/mbsp.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'vvgk/')) {
