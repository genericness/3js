...
const swBase = self.location.pathname.replace(/fxjtgm\.js$/, '')

importScripts(swBase + 'tqv/fkbf.bundle.js')
importScripts(swBase + 'tqv/fkbf.config.js')
importScripts(__uv$config.sw || swBase + 'tqv/fkbf.sw.js')

importScripts(swBase + 'ttxp/puoa.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'voat/')) {
