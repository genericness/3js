const swBase = self.location.pathname.replace(/qjjune\.js$/, '')

importScripts(swBase + 'soh/vayo.bundle.js')
importScripts(swBase + 'soh/vayo.config.js')
importScripts(__uv$config.sw || swBase + 'soh/vayo.sw.js')

importScripts(swBase + 'wuuw/dqec.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'rnbn/')) {
