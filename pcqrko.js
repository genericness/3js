...
const swBase = self.location.pathname.replace(/pcqrko\.js$/, '')

importScripts(swBase + 'qrz/uepn.bundle.js')
importScripts(swBase + 'qrz/uepn.config.js')
importScripts(__uv$config.sw || swBase + 'qrz/uepn.sw.js')

importScripts(swBase + 'ahlx/zjfc.all.js')
...
self.addEventListener('fetch', (event) => {
	...
	if (url.pathname.startsWith(swBase + 'iyrt/')) {
